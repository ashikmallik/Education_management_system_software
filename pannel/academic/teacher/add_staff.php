	...
	function contalt_valid()
	{
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading"><h2>Add Staff</h2></div>
                <div class="form">
                    <center>
                    <form name="frmcontent" action="add_staff_do.php" method="post" enctype="multipart/form-data">
                     <?php
                	$msg=$_GET['msg'];
                        ...
                        <td class="text_table">Staff Name</td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="spouse" id="spouse"></td>
                                 <td class="text_table">Staff ID</td>
