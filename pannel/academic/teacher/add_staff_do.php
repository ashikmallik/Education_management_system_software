 ...
 require_once '../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	$designation = clean_html($_POST['designation']);
		...
		$phone1 = strip_tags($_POST['phone']);
			...
			$branch="select * from `borno_mgt_staff_info` where `borno_school_id`='$schId' AND `borno_mgt_staf_phone`='$phone1'";
	...
	$bornoschBranch="INSERT INTO `borno_mgt_staff_info` (`borno_staff_serial_no`,`borno_school_id`, `borno_school_branch_id`, `borno_school_shift_id`, `borno_mgt_staf_desig`,`borno_mgt_staff_name`,`borno_staff_father_name`,`borno_staff_mother_name`, `borno_staff_spouse_name`,`borno_staff_id`,`borno_staff_dob`,`borno_staff_religion`,`borno_staff_gender`,`borno_staff_marital_status`,`borno_staff_blood_group`,`borno_staff_qualification`,`borno_staff_national_id`,`borno_staff_passport_no`, `borno_staff_email_id`,`borno_staff_first_join`,`borno_staff_join_in_school`,`borno_staff_mailing_address`,`borno_staff_permanent_address`,`borno_staff_org_type`, `borno_mgt_staf_phone`, `borno_mgt_staf_photo`)
											
															VALUES ('$serial1', '$schId','$addBranchf','$shiftId1','$designation1','$teacher1','$father1','$mother1','$spouse1','$teacherid1','$dob1','$religion1','$gender1','$meritalStatus1','$blgroup1','$qualification1','$nationId1','$passport1','$emailId1','$fjdate1','$jdits1', '$presAdd1', '$perAdd1', '$orgType1', '88$phone1', '$fnme')";
