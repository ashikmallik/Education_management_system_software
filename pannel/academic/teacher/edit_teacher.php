...
// 		function callpage()
// {
// 	 document.frmcontent.action="edit_teacher.php";
...
<option value="Assistant Professor"<?php if($shgtstudent['borno_teachers_designation']=='Assistant Professor') { echo "selected"; } ?>> Assistant Professor </option>
<option value="Lecturer"<?php if($shgtstudent['borno_teachers_designation']=='Lecturer') { echo "selected"; } ?>> Lecturer </option>
<option value="Demonstrator"<?php if($shgtstudent['borno_teachers_designation']=='Demonstrator') { echo "selected"; } ?>> Demonstrator </option>
     ...
     <?php
				...
				?>
      <option value=" <?php echo $showdata['borno_school_branch_id']; ?>" <?php if($shgtstudent['borno_school_branch_id']==$_REQUEST['branchId']) { echo "selected"; }  ?>> <?php echo $showdata['borno_school_branch_name']; ?></option>
      <?php } ?>
