    ...
    <td>
       ...
       <option value=""> Select Section</option>
        ...
        <?php
					...
					$gstsection="select * from borno_school_section where borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_branch_id='$gtfbranchId' AND borno_school_id='$schId'";
