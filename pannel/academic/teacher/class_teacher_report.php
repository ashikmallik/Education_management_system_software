        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2>Class Teacher Report</h2></div>
                <div class="form">
                    <center>
...
function callpage()
{
	 document.frmcontent.action="class_teacher_report.php";
...
<form name="frmcontent" action="download_class_teacher_report.php" method="post" enctype="multipart/form-data">
...
<tr>
    ...
    <td align="center"><strong>:</strong></td>
    <td><select name="session" id="session" onchange="callpage();">
      <option value=""> --Select-- </option>
      <?php
					
					$gtsess="select * from `borno_set_class_teacher` GROUP BY `borno_school_session`";
					$qgtsess=$mysqli->query($gtsess);
					while($shqgtsess=$qgtsess->fetch_assoc()){ $sl++;
				
				?>
      <option value=" <?php echo $shqgtsess['borno_school_session']; ?>" <?php if($shqgtsess['borno_school_session']==trim($_REQUEST['session'])) { echo "selected"; }  ?>> <?php echo $shqgtsess['borno_school_session']; ?></option>
      <?php } ?>
    </select></td>
  </tr>
  <tr> 
