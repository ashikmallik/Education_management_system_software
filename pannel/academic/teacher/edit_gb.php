...
<div class="wrapper">
    ...
    <div class="ot_main_content">
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                ...
                <div class="form">
                    <center>
                    <form name="frmcontent" action="update_gb.php" method="post" enctype="multipart/form-data">
                     <?php
                	$msg=$_GET['msg'];
					...
					$techId=$_GET['techId'];
			$techinfo="select * from borno_gb_info where borno_gb_info_id='$techId'";
    ...
    <td><input type="text" name="mgtType" id="mgtType" value="<?php echo $shtechinfo['borno_gb_type']; ?>"></td>
  </tr>   
                       <tr>
                                <td class="text_table">GB Name</td>
                                <td><input type="text" name="teacher" id="teacher" value="<?php echo $shtechinfo['borno_gb_name']; ?>"></td>
                            </tr>
                            <tr>
    <td class="text_table">Designation</td>
 
    <td><label for="stfdesig"></label>
      <input type="text" name="stfdesig" id="stfdesig" value="<?php echo $shtechinfo['borno_gb_desig']; ?>"/></td>
  </tr>
                             <tr>
                                <td class="text_table">Address</td>
                                <td><input type="text" name="address" id="address" value="<?php echo $shtechinfo['borno_gb_address']; ?>"></td>
                            </tr>
                            <tr>
                                <td class="text_table">Phone</td>
                                <td><input type="text" name="phone" id="phone" value="<?php echo $shtechinfo['borno_gb_phone']; ?>"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><center><input type="submit" name="" value="Update"></center>
                                 <input type="hidden" name="techId" id="techId" value="<?php echo $shtechinfo['borno_gb_info_id']; ?>">
                                </td>
                            </tr>
                        </table>
                    </form>
