        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2> Send Result SMS</h2></div>
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="send_result_sms.php" method="post" enctype="multipart/form-data">
                        <?php
			$msg=$_GET['msg'];
 ...
 // $shiftId=$_REQUEST['shiftId'];
  ...
  <tr>
    ...
    <select name="smstype" id="smstype" onchange="callpage();">
      <option value=""> Select </option>
      <option value="1" <?php if($_POST['smstype']==1) { echo "selected"; } ?>> Result with subject details </option>
      <option value="2" <?php if($_POST['smstype']==2) { echo "selected"; } ?>> Result with only GPA </option>
    </select></td>
  </tr>
  <?php
 ...
 */
  ...
  <td><strong>Select Group *</strong></td>
   ...
   <tr>
    <td>&nbsp;</td>
    <td align="center">&nbsp;</td>
    <td><input type="submit" name="button" id="button" value="Send SMS"></td>
  </tr>
