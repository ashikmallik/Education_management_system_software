...
function callpage()
{
 document.frmcontent.action="blunk_admit_card.php";
    ...
    <div class="ot_main_content">
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                ...
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="download_blunk_admit_card.php" method="post" enctype="multipart/form-data">
                        <?php
			$msg=$_GET['msg'];
...
?>                      
 <?php if($schId!=51) { ?>                  
    ...
    <td>&nbsp;</td>
    <td><a href="download_blunk_admit_card.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>" target="_blank">Show Admit</a></td>
 </tr> 
 <!-- <tr>


    <td>&nbsp;</td>
    <td><a href="download_admit_card2.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>" target="_blank">Show Admit</a></td>
 </tr> -->
 <?php } if($schId==51) { ?>
 <tr>
