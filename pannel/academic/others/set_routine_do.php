<?php
 ...
 require_once '../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	$getTechid1="select * from borno_school_class_routine where borno_school_teacher_id='$teacherid' AND borno_school_session='$stsess' AND borno_school_routine_day='$dayid' AND borno_school_routine_period='$firstp'";
	$qgetTechid1=$mysqli->query($getTechid1);
	$shgetTechid1=$qgetTechid1->fetch_assoc();
	
 if($shgetTechid1['borno_school_routine_period']==""){   
     
 $insroutineinfo1="INSERT INTO `borno_school_class_routine` (`borno_school_id`, `borno_school_branch_id`, `borno_school_shift_id`, `borno_school_teacher_id`, `borno_school_session`, `borno_school_routine_day`,`borno_school_routine_period`,`borno_school_class_id`,`borno_school_section_id`, `borno_school_subject_id`,`borno_school_routine_time`)
	...
	$getTechid2="select * from borno_school_class_routine where borno_school_teacher_id='$teacherid' AND borno_school_session='$stsess' AND borno_school_routine_day='$dayid' AND borno_school_routine_period='$secondp'";
	$qgetTechid2=$mysqli->query($getTechid2);
	$shgetTechid2=$qgetTechid2->fetch_assoc();
	
 if($shgetTechid2['borno_school_routine_period']==""){ 
     
 $insroutineinfo2="INSERT INTO `borno_school_class_routine` (`borno_school_id`, `borno_school_branch_id`, `borno_school_shift_id`, `borno_school_teacher_id`, `borno_school_session`, `borno_school_routine_day`,`borno_school_routine_period`,`borno_school_class_id`,`borno_school_section_id`, `borno_school_subject_id`,`borno_school_routine_time`)
    ...
    $getTechid3="select * from borno_school_class_routine where borno_school_teacher_id='$teacherid' AND borno_school_session='$stsess' AND borno_school_routine_day='$dayid' AND borno_school_routine_period='$thirdp'";
	$qgetTechid3=$mysqli->query($getTechid3);
	$shgetTechid3=$qgetTechid3->fetch_assoc();
	
 if($shgetTechid3['borno_school_routine_period']==""){ 
					
 $insroutineinfo3="INSERT INTO `borno_school_class_routine` (`borno_school_id`, `borno_school_branch_id`, `borno_school_shift_id`, `borno_school_teacher_id`, `borno_school_session`, `borno_school_routine_day`,`borno_school_routine_period`,`borno_school_class_id`,`borno_school_section_id`, `borno_school_subject_id`,`borno_school_routine_time`)
    ...
    $getTechid4="select * from borno_school_class_routine where borno_school_teacher_id='$teacherid' AND borno_school_session='$stsess' AND borno_school_routine_day='$dayid' AND borno_school_routine_period='$fourthp'";
	$qgetTechid4=$mysqli->query($getTechid4);
	$shgetTechid4=$qgetTechid4->fetch_assoc();
	
 if($shgetTechid4['borno_school_routine_period']==""){ 
     
 $insroutineinfo4="INSERT INTO `borno_school_class_routine` (`borno_school_id`, `borno_school_branch_id`, `borno_school_shift_id`, `borno_school_teacher_id`, `borno_school_session`, `borno_school_routine_day`,`borno_school_routine_period`,`borno_school_class_id`,`borno_school_section_id`, `borno_school_subject_id`,`borno_school_routine_time`)
     ...
     $getTechid5="select * from borno_school_class_routine where borno_school_teacher_id='$teacherid' AND borno_school_session='$stsess' AND borno_school_routine_day='$dayid' AND borno_school_routine_period='$fifthp'";
	$qgetTechid5=$mysqli->query($getTechid5);
	$shgetTechid5=$qgetTechid5->fetch_assoc();
	
 if($shgetTechid5['borno_school_routine_period']==""){ 
     
 $insroutineinfo5="INSERT INTO `borno_school_class_routine` (`borno_school_id`, `borno_school_branch_id`, `borno_school_shift_id`, `borno_school_teacher_id`, `borno_school_session`, `borno_school_routine_day`,`borno_school_routine_period`,`borno_school_class_id`,`borno_school_section_id`, `borno_school_subject_id`,`borno_school_routine_time`)
	 VALUES ('$schId','$branchId','$shiftId','$teacherid','$stsess', '$dayid','$fifthp','$studClass5','$studSection5','$sub5','$time5')";	 
      ...
      $getTechid6="select * from borno_school_class_routine where borno_school_teacher_id='$teacherid' AND borno_school_session='$stsess' AND borno_school_routine_day='$dayid' AND borno_school_routine_period='$sixthp'";
	$qgetTechid6=$mysqli->query($getTechid6);
	$shgetTechid6=$qgetTechid6->fetch_assoc();
	
 if($shgetTechid6['borno_school_routine_period']==""){ 
     
 $insroutineinfo6="INSERT INTO `borno_school_class_routine` (`borno_school_id`, `borno_school_branch_id`, `borno_school_shift_id`, `borno_school_teacher_id`, `borno_school_session`, `borno_school_routine_day`,`borno_school_routine_period`,`borno_school_class_id`,`borno_school_section_id`, `borno_school_subject_id`,`borno_school_routine_time`)
	 VALUES ('$schId','$branchId','$shiftId','$teacherid','$stsess', '$dayid','$sixthp','$studClass6','$studSection6','$sub6','$time6')";	 
      ...
      $getTechid7="select * from borno_school_class_routine where borno_school_teacher_id='$teacherid' AND borno_school_session='$stsess' AND borno_school_routine_day='$dayid' AND borno_school_routine_period='$seventhp'";
	$qgetTechid7=$mysqli->query($getTechid7);
	$shgetTechid7=$qgetTechid7->fetch_assoc();
	
 if($shgetTechid7['borno_school_routine_period']==""){ 
     
 $insroutineinfo7="INSERT INTO `borno_school_class_routine` (`borno_school_id`, `borno_school_branch_id`, `borno_school_shift_id`, `borno_school_teacher_id`, `borno_school_session`, `borno_school_routine_day`,`borno_school_routine_period`,`borno_school_class_id`,`borno_school_section_id`, `borno_school_subject_id`,`borno_school_routine_time`)
    ...
    $getTechid8="select * from borno_school_class_routine where borno_school_teacher_id='$teacherid' AND borno_school_session='$stsess' AND borno_school_routine_day='$dayid' AND borno_school_routine_period='$eighthp'";
