 ...
 // $shiftId=$_POST['shiftId'];
  ...
  <tr>
    ...
    <td><select name="group" id="group">
      ...
      <option value="Electrical" <?php if($shgtstudent['borno_school_stud_group']=='Electrical') { echo "selected";} ?>> Electrical </option>
      <option value="Computer" <?php if($shgtstudent['borno_school_stud_group']=='Computer') { echo "selected";} ?>> Computer </option>
     <option value="Civil" <?php if($shgtstudent['borno_school_stud_group']=='Civil') { echo "selected";} ?>> Civil </option>
      <option value="Building Maintaince" <?php if($shgtstudent['borno_school_stud_group']=='Building Maintaince') { echo "selected";} ?>> Building Maintaince </option>
            <option value="General Mechanix" <?php if($shgtstudent['borno_school_stud_group']=='General Mechanix') { echo "selected";} ?>> General Mechanix </option>
      </select></td>
  </tr>
  ...
  <tr>
    ...
    <td><select name="studClass" id="studClass" onchange="callpage();">
      ...
      <?php
					$gtfbranchId=$_REQUEST['branchId'];
					$getClassId="select * from borno_school_set_class where borno_school_id='$schId' AND borno_school_branch_id='$gtfbranchId' AND borno_school_class_id Between 1 and 2 ";
