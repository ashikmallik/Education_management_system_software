...
$gtresSubd="select * from borno_result_subject_details_voc where borno_school_id='$schoolId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$gttermId' AND borno_result_trade='$trade' AND borno_result_subject_id='$stusubjId'";
...
<table width="650" border="0" cellspacing="0" cellpadding="0" class="projectlist" align="center">
  ...
  <tr>
    ...
    <td><select name="selTerm" id="selTerm">
      <option value=""> Select </option>
      <?php
			$schexterm="select * from borno_result_add_term_voc where borno_school_id='$schoolId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess'";
  ...
  <tr>
    ...
    <select name="trade" id="trade" onchange="callpage();">
      <option value=""> Select </option>
<option value="Electrical" <?php if ($trade=='Electrical') { echo "selected";} ?>> Electrical </option>
<option value="Computer" <?php if($trade=='Computer') { echo "selected";} ?>> Computer </option>
<option value="Building Maintaince" <?php if($trade=='Building Maintaince') { echo "selected";} ?>> Building Maintaince </option>
<option value="General Mechanix" <?php if($trade=='General Mechanix') { echo "selected";} ?>> General Mechanix </option>
    </select></td>
  </tr>
  <tr>
    ...
    <td><select name="stusubjId" id="stusubjId" onchange="callpage();">
      ...
      <?php
			...
			$gsubjName="select * from borno_result_subject_voc where borno_result_subject_voc_id='$stusubjId'";
			$qgsubjName=$mysqli->query($gsubjName);
			$shgsubjName=$qgsubjName->fetch_assoc();
		?>
      <option value="<?php echo $shgsubjName['borno_result_subject_voc_id']; ?>" <?php if($shgsubjName['borno_result_subject_voc_id']==$stusubjId) { echo "selected"; } ?>> <?php echo $shgsubjName['borno_school_subject_name']; ?></option>
       </select></td>
  </tr>
</table>
