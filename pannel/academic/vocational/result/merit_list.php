 ...
 // $shiftId=$_REQUEST['shiftId'];
  ...
  <tr>
    ...
    <td>
	  ...
	  <?php
	  		$stsess=$_POST['stsess'];
			$schexterm="select * from borno_result_add_term_voc where borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
...
<tr>
    ...
    <td align="center"><strong>:</strong></td>
    <td>
    <select name="trade" id="trade" onchange="callpage();">
      <option value=""> Select </option>
<option value="Electrical" <?php if($_POST['trade']=='Electrical') { echo "selected";} ?>> Electrical </option>
<option value="Computer" <?php if($_POST['trade']=='Computer') { echo "selected";} ?>> Computer </option>
<option value="Building Maintaince" <?php if($_POST['trade']=='Building Maintaince') { echo "selected";} ?>> Building Maintaince </option>
<option value="General Mechanix" <?php if($_POST['trade']=='General Mechanix') { echo "selected";} ?>> General Mechanix </option>
    </select></td>
  </tr>
 <tr>
...
?>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_meritlist05_pdf.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $branchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&trade=<?php echo $trade; ?>" target="_blank">Merit List Section</a></td>
 </tr>
  <tr>
 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_meritlistshift05_pdf.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $branchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&trade=<?php echo $trade; ?>" target="_blank">Merit List Shift</a></td>
 </tr> 
  <tr>
 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_meritlistclass05_pdf.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $branchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&trade=<?php echo $trade; ?>" target="_blank">Merit List Class</a></td>
 </tr> 
