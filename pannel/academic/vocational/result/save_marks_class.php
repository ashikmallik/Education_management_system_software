...
$delborno="DELETE from borno_class9_10voc_temp_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_subject_nine_ten_id='$stusubjId' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$trade'";

$mysqli->query($delborno);		
...
//----------- Get Subject Details Mark ----------------------------------------------------------------------------------------------------------------------------
 ...
 $gtsdmrk="select * from borno_result_subject_details_voc where borno_school_id='$schId' AND borno_school_class_id=$studClass AND borno_school_session='$stsess' AND borno_result_trade='$trade' AND borno_result_term_id='$selTerm' AND borno_result_subject_id='$stusubjId'";
...
$delgpa="DELETE from borno_school_9_10voc_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$trade'";

$mysqli->query($delgpa);			

		//======================================== Height Mark ======================================================//
	
		$getheightmarkdel="delete  from  borno_height_mark_class9_10_voc where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_school_stud_group='$trade' AND borno_subject_nine_ten_id='$stusubjId' AND borno_result_term_id='$selTerm'";
