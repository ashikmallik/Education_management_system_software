...
function Header()
{
	...
	if($GLOBALS['s1l']==13)
	{
	$this->Cell(40,5,$GLOBALS['subname13'],1,0,'L');
	...
	{
	$this->Cell(40,5,$GLOBALS['subname13'],1,0,'L');
	$this->Cell(40,5,$GLOBALS['subname14'],1,0,'L');
	$this->Cell(15,5,Grand,1,0,'C');
	$this->Cell(10,5,GPA,1,0,'C');
	}
	if($GLOBALS['s1l']>=15)
	...
	$this->Cell(40,5,$GLOBALS['subname13'],1,0,'L');
	$this->Cell(40,5,$GLOBALS['subname14'],1,0,'L');
	$this->Cell(40,5,$GLOBALS['subname15'],1,0,'L');
	$this->Cell(15,5,Grand,1,0,'C');
	$this->Cell(10,5,GPA,1,0,'C');
	}
