...
<script language="javascript">
	...
	function callpage()
	{
	 document.frmcontent.action="download_csv.php";
...
<div class="wrapper">
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2>Download CSV</h2></div>
                <div class="form">
                    <center>
                    <form name="frmcontent" id="myform" action="download_csv_class.php" method="post" enctype="multipart/form-data">
  ...
  <tr>
  <td><strong>Select Trade *</strong></td>
    <td align="center"><strong>:</strong></td>
...
<option value="General Mechanix" <?php if($_POST['trade']=='General Mechanix') { echo "selected";} ?>> General Mechanix </option>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td><label>
                                  <input type="submit" name="Submit" value="Download" onClick="return contalt_valid()">
