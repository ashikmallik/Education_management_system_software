...
-->        </div>
 ...
 ?>
    ...
    <td><select name="stsess" id="stsess" onchange="callpage();">
  	...
  	<tr>
    <td class="text_table">Trade *</td>
    <td><select name="trade" id="trade" onchange="callpage();">
...
<option value="General Mechanix" <?php if($_POST['trade']=='General Mechanix') { echo "selected";} ?>> General Mechanix </option>
 ...
 <?php
					...
					$gstterm="select * from borno_result_add_term_voc where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' order by borno_result_term_id asc";
...
<option value=" <?php echo $shqgstterm['borno_result_term_id']; ?>" <?php if($shqgstterm['borno_result_term_id']==$_REQUEST['term']) { echo "selected"; }  ?>> <?php echo $shqgstterm['borno_result_term_name']; ?></option>
      <?php } ?>
				...
				?>
					...
					$term=$_REQUEST['term'];
					$gsubdetails="select * from borno_result_subject_details_voc where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_trade='$trade' AND borno_result_term_id='$term' order by borno_result_subject_details_voc_id asc";
					...
					$gsubject="select * from borno_result_subject_voc where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_subject_voc_id='$subjectname'";
          ...
          <input type="hidden" name="subdetailid[]" id="subdetailid[]" value="<?php echo $shqgsubdetails['borno_result_subject_details_voc_id']; ?>" /></td>
...
<option value="0"<?php if($shqgsubdetails['sub4th']=='0') { echo "selected"; } ?>> Main </option>
<option value="1"<?php if($shqgsubdetails['sub4th']=='1') { echo "selected"; } ?>> 4th Subject </option>
