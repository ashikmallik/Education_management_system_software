  ...
  <option value="2019"> 2019 </option>
      <option value="2020"> 2020 </option>
					...
					if($termId!=""){
						...
						$delterm="DELETE from borno_result_add_term_voc where borno_result_term_id='$termId'";
            ...
            $gtedtgrade="select * from borno_result_add_term_voc where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' order by borno_result_term_id asc";
			$s=0;
