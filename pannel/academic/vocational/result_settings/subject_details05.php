...
<option value=" <?php echo $shqgstterm['borno_result_term_id']; ?>" <?php if($shqgstterm['borno_result_term_id']==$_REQUEST['term']) { echo "selected"; }  ?>> <?php echo $shqgstterm['borno_result_term_name']; ?></option>
      <?php } ?>
 					...
 					$studClass=$_REQUEST['studClass'];
 					$stsess=$_REQUEST['stsess'];
					$gtype="select * from borno_result_number_type_voc where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess'";
				...
				?>
					...
					$gsubject="select * from borno_result_subject_voc where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess'";
          ...
          <input type="hidden" name="subid[]" id="subid[]" value="<?php echo $shqgsubject['borno_result_subject_voc_id']; ?>" /></td>
...
<option value="0"<?php if($shqgsubject['sub4th']=='0') { echo "selected"; } ?>> Main </option>
<option value="1"<?php if($shqgsubject['sub4th']=='1') { echo "selected"; } ?>> 4th Subject </option>
