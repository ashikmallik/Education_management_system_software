 ...
 require_once '../../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	if (!function_exists('clean_html')) {
		...
		$gpa71 = strip_tags($_POST['gpa7']);
			...
			$branch="select * from `borno_grading_chart_voc` where `borno_school_id`='$schId' AND `borno_school_class_id`='$studClass1' AND `borno_school_session`='$stsess1'";
...
echo	 $bornoschBranch="UPDATE `borno_grading_chart_voc` SET `marks_from1`='$mrkfrom11',`marks_to1`='$mrkto11', `letter_grade1`='$lg11', `grade_point1`='$gpa11',`marks_from2`='$mrkfrom21',`marks_to2`='$mrkto21', `letter_grade2`='$lg21', `grade_point2`='$gpa21',`marks_from3`='$mrkfrom31',`marks_to3`='$mrkto31', `letter_grade3`='$lg31', `grade_point3`='$gpa31',`marks_from4`='$mrkfrom41',`marks_to4`='$mrkto41', `letter_grade4`='$lg41', `grade_point4`='$gpa41',`marks_from5`='$mrkfrom51',`marks_to5`='$mrkto51', `letter_grade5`='$lg51', `grade_point5`='$gpa51',`marks_from6`='$mrkfrom61',`marks_to6`='$mrkto61', `letter_grade6`='$lg61', `grade_point6`='$gpa61',`marks_from7`='$mrkfrom71',`marks_to7`='$mrkto71', `letter_grade7`='$lg71', `grade_point7`='$gpa71' where `borno_school_id`='$schId' AND `borno_school_class_id`='$studClass1' AND `borno_school_session`='$stsess1'";
