    ...
    <td><select name="stsess" id="stsess">
      ...
      <option value="2020"> 2020 </option>
					...
					if($subId!=""){
						...
						$delterm="DELETE from borno_result_subject_voc where borno_result_subject_voc_id='$subId'";
            ...
            $gtedtgrade="select * from borno_result_subject_voc where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' order by borno_result_subject_voc_id asc";
			$s=0;
   ...
   ?>
                              <tr>
                                ...
                                <td align="center"><input name="termName[]" type="text" id="termName[]" size="30" value=" <?php echo $shgtedtgrade['borno_school_subject_name']; ?>">
                                 <input type="hidden" name="termtype[]" id="termtype[]" value="<?php echo $shgtedtgrade['borno_result_subject_voc_id']; ?>" />
                                ...
                                <option value="0"<?php if($shgtedtgrade['uncountable']=='0') { echo "selected"; } ?>> Main </option>
                                 <option value="1"<?php if($shgtedtgrade['uncountable']=='1') { echo "selected"; } ?>> Uncountable </option>
                                    ...
                                    <td align="center"><select name="add4sub[]" id="add4sub[]">
                                <option value="0"<?php if($shgtedtgrade['sub4th']=='0') { echo "selected"; } ?>> Main </option>
                                 <option value="1"<?php if($shgtedtgrade['sub4th']=='1') { echo "selected"; } ?>> 4th Subject </option>
                             ...
                             <?php } ?>
                               ...
                               <tr>
 <td colspan="6" align="center"><input type="submit" name="submit" id="submit" value="Update" onClick="return contalt_valid()">
