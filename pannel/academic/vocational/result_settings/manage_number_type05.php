        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2>Manage Number Type Play to Five</h2></div>
                <div class="form">
                    <center>
    ...
    <td><select name="stsess" id="stsess">
      ...
      <option value="2020"> 2020 </option>
					...
					if($typeId!=""){
						...
						$delterm="DELETE from borno_result_number_type_voc where borno_result_number_type_id='$typeId'";
            ...
            $gtedtgrade="select * from borno_result_number_type_voc where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess'";
