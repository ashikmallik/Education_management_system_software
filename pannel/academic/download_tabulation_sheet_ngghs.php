...
function Header()
{
	...
	if($GLOBALS['s1l']==1)
	{
	$this->Cell(40,5,$GLOBALS['subname1'],1,0,'L');
	}
	if($GLOBALS['s1l']==2)
	{
	$this->Cell(40,5,$GLOBALS['subname1'],1,0,'L');
	$this->Cell(40,5,$GLOBALS['subname2'],1,0,'L');	
	}
	if($GLOBALS['s1l']==3)
	{
	$this->Cell(40,5,$GLOBALS['subname1'],1,0,'L');
	$this->Cell(40,5,$GLOBALS['subname2'],1,0,'L');	
	$this->Cell(40,5,$GLOBALS['subname3'],1,0,'L');	
	}
	if($GLOBALS['s1l']==4)
	{
	$this->Cell(40,5,$GLOBALS['subname1'],1,0,'L');
	$this->Cell(40,5,$GLOBALS['subname2'],1,0,'L');	
	$this->Cell(40,5,$GLOBALS['subname3'],1,0,'L');	
	$this->Cell(40,5,$GLOBALS['subname4'],1,0,'L');	
	}
	if($GLOBALS['s1l']>=5)
	{
	$this->Cell(40,5,$GLOBALS['subname1'],1,0,'L');
	...
	$this->Cell(40,5,$GLOBALS['subname3'],1,0,'L');	
	$this->Cell(40,5,$GLOBALS['subname4'],1,0,'L');	
	$this->Cell(40,5,$GLOBALS['subname5'],1,0,'L');	
	}

    $this->SetFont('Arial','',10);
	$this->Cell(12,5,'G.Total',1,0,'C');
	...
	//$this->Cell(8,5,$GLOBALS['numbertype3'],1,0,'C');
