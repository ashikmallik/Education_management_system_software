...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="merit_summary.php";
...
?>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_merit_summary_pdf.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">Summary List</a></td>
 </tr>
