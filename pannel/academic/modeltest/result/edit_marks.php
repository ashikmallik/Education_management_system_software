   ...
   <tr>
    ...
    <td>
	  ...
	  <?php
			...
			$schexterm="select * from modeltest_add_term where borno_school_class_id='$studClass' AND borno_school_session='$clSess' AND borno_school_id='$schId'";
  ...
  <tr>
    ...
    <td><select name="stusubjId" id="stusubjId" onchange="callpage();">
      ...
      <?php }} 
	  		...
	  		{
			$gsubjName="select * from modeltest_result_subject where borno_school_class_id='$studClass' AND borno_school_session='$clSess' AND borno_school_id='$schId'";
			$qgsubjName=$mysqli->query($gsubjName);
			while($shgsubjName=$qgsubjName->fetch_assoc()){
		?>
      <option value="<?php echo $shgsubjName['modeltest_result_subject_id']; ?>" <?php if($shgsubjName['modeltest_result_subject_id']==$_REQUEST['stusubjId']) { echo "selected"; } ?>> <?php echo $shgsubjName['borno_school_subject_name']; ?></option>
      <?php }} ?>
    </select></td>
  </tr>
...
<table width="650" border="0" cellspacing="0" cellpadding="0" align="center" class="projectlist">
  <?php
	$assnty="select * from modeltest_assign_number_type where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$clSess'";
  ...
  $selTerm=$_POST['selTerm'];
  	...
  	if($studClass==1 OR $studClass==2)
	{
  $assnty1="select * from modeltest_result_nine_ten_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$clSess' AND borno_result_term_id='$selTerm' AND borin_subject_nine_ten_id='$stusubjId'";
	...
	elseif($studClass==3 OR $studClass==4 OR $studClass==5)
	{
  $assnty1="select * from modeltest_six_eight_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$clSess' AND borno_result_term_id='$selTerm' AND subject_id_six_eight='$stusubjId'";
	$qassnty1=$mysqli->query($assnty1);
	$shassnty1=$qassnty1->fetch_assoc();
	...
	{
  $assnty1="select * from modeltest_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$clSess' AND borno_result_term_id='$selTerm' AND borno_result_subject_id='$stusubjId'";
	$qassnty1=$mysqli->query($assnty1);
	$shassnty1=$qassnty1->fetch_assoc();
  ...
  <?php }} else
  {	
		$gtctmarg="select * from modeltest_class1_temp_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$gtfbranchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$clSess' AND borno_result_subject_id='$stusubjId' AND borno_result_term_id='$selTerm' group by borno_school_roll asc";
