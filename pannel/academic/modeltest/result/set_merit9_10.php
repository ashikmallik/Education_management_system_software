...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="set_merit9_10.php";
...
<form name="frmcontent" id="myform" action="set_merit910_do.php" method="post" enctype="multipart/form-data">
