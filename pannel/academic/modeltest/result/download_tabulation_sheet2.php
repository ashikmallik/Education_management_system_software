...
$sl=0;
	...
	if($sid6=="" AND $sid7=="" AND $sid8=="" AND $sid9=="" AND $sid10=="" AND $sid11==""AND $sid12==""AND $sid13==""AND $sid14==""AND $sid15==""){$subidend=$sid6;}
	elseif($sid7=="" AND $sid8=="" AND $sid9=="" AND $sid10=="" AND $sid11==""AND $sid12==""AND $sid13==""AND $sid14==""AND $sid15==""){$subidend=$sid6;}	
	...
	elseif($sid12==""AND $sid13==""AND $sid14==""AND $sid15==""){$subidend=$sid10;}	
	elseif($sid13==""AND $sid14==""AND $sid15==""){$subidend=$sid10;}	
	elseif($sid14==""AND $sid15==""){$subidend=$sid10;}
	elseif($sid15==""){$subidend=$sid10;}				
 $resultsub ="select * from modeltest_class9_10_temp_mark1 where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term'  AND borno_school_stud_group='$group' AND borno_subject_nine_ten_id between '$sid6' AND '$subidend' group by borno_subject_nine_ten_id asc";
...
$sl2=0;
 ...
 $resulttotal1 ="select * from modeltest_class9_10_temp_mark1 where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term'  AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND borno_subject_nine_ten_id='$subjectid'";
		       ...
		       if($subjectid1!="")
                {		
 $resulttotal ="select * from modeltest_class9_10_final_result where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term'  AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND borno_subject_nine_ten_id='$subjectid'";
...
$resultgrand ="select * from modeltest_school_9_10_merit where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111'";
