...
$gtschoolName="SELECT * FROM borno_school where borno_school_id=$schId";
 ...
 $subject ="select * from modeltest_class1_temp_mark1 where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' group by borno_result_subject_id asc";
$s1l=0;
					$qsubject=$mysqli->query($subject);
					while($rowqsubject=$qsubject->fetch_assoc()){ $s1l++;
					$subid=$rowqsubject['borno_result_subject_id'];
					
					$subjectname ="select * from modeltest_result_subject where borno_school_class_id='$studClass' AND borno_school_id='$schId' AND borno_school_session='$stsess' AND modeltest_result_subject_id='$subid'";
				...
				$subname=substr($rowqsubjectname['borno_school_subject_name'],0,20);
					...
					$numtype ="select * from modeltest_assign_number_type where borno_school_class_id='$studClass' AND borno_school_id='$schId' AND borno_school_session='$stsess'";
...
function Header()
{
	...
	if($GLOBALS['s1l']==6)
	{	
	$this->Cell(42,5,$GLOBALS['subname6'],1,0,'L');
	}
	if($GLOBALS['s1l']==7)
	{
	$this->Cell(42,5,$GLOBALS['subname6'],1,0,'L');
	$this->Cell(42,5,$GLOBALS['subname7'],1,0,'L');
	}
	if($GLOBALS['s1l']==8)
	{
	$this->Cell(42,5,$GLOBALS['subname6'],1,0,'L');
	$this->Cell(42,5,$GLOBALS['subname7'],1,0,'L');
	$this->Cell(42,5,$GLOBALS['subname8'],1,0,'L');	
	}
	if($GLOBALS['s1l']==9)
	{
	$this->Cell(42,5,$GLOBALS['subname6'],1,0,'L');
	$this->Cell(42,5,$GLOBALS['subname7'],1,0,'L');
	$this->Cell(42,5,$GLOBALS['subname8'],1,0,'L');	
	$this->Cell(42,5,$GLOBALS['subname9'],1,0,'L');
	}	
	if($GLOBALS['s1l']>=10)
	{
	$this->Cell(42,5,$GLOBALS['subname6'],1,0,'L');
	...
	$this->Cell(42,5,$GLOBALS['subname8'],1,0,'L');	
	$this->Cell(42,5,$GLOBALS['subname9'],1,0,'L');
	$this->Cell(42,5,$GLOBALS['subname10'],1,0,'L');
	}	
...
$result23 ="select * from modeltest_class1_temp_mark1 where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' group by borno_school_roll asc";
$sl=0;
...
$resulname ="select * from borno_student_info where borno_student_info_id='$gtstdid'";
	...
	if($subid6=="" AND $subid7=="" AND $subid8=="" AND $subid9=="" AND $subid10==""){$subidend=$subid6;}	
	elseif($subid7=="" AND $subid8=="" AND $subid9=="" AND $subid10==""){$subidend=$subid6;}
	elseif($subid8=="" AND $subid9=="" AND $subid10==""){$subidend=$subid7;}
	elseif($subid9=="" AND $subid10==""){$subidend=$subid8;}
	elseif($subid10==""){$subidend=$subid9;}
	elseif($subid11==""){$subidend=$subid10;}
	else{$subidend=$subid10;}			
 $resultsub ="select * from modeltest_class1_temp_mark1 where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND borno_result_subject_id!='$subid1' AND borno_result_subject_id!='$subid2' AND borno_result_subject_id!='$subid3' AND borno_result_subject_id!='$subid4' AND borno_result_subject_id!='$subid5'  AND borno_result_subject_id between '$subid6' AND '$subidend' order by borno_result_subject_id asc";
$sl2=0;
...
$resultgrand ="select * from modeltest_play_5_merit where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111'";
