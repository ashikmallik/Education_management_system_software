...
for($i=0; $i<count($stuName); $i++){
				...
				if($ntype1[$i]!="" OR $ntype2[$i]!="" OR $ntype3[$i]!="" OR $ntype4[$i]!="" OR $ntype5[$i]!="" OR $ntype6[$i]!=""){
...
for($i=0; $i<count($stuName); $i++){
 ...
 $term1="select * from modeltest_class6_8_temp_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND subject_id_six_eight='$stusubjId' AND borno_result_term_id='$selTerm' AND borno_student_info_id='$studId[$i]'";
	$qterm1=$mysqli->query($term1);
	$shqterm1=$qterm1->fetch_assoc();
	$gettermid=$shqterm1['borno_student_info_id'];
	if($gettermid=="")
...
for($i=0; $i<count($stuName); $i++){
	...
	$term1="select * from modeltest_class1_temp_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_subject_id='$stusubjId' AND borno_result_term_id='$selTerm' AND borno_student_info_id='$studId[$i]'";
	$qterm1=$mysqli->query($term1);
	$shqterm1=$qterm1->fetch_assoc();
	$gettermid=$shqterm1['borno_student_info_id'];
	if($gettermid=="")
...
{	
 $gtsdmrk="select * from modeltest_six_eight_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND subject_id_six_eight='$stusubjId'";
	...
	$gtsubjfm="select * from modeltest_set_subject_six_eight where subject_id_six_eight='$stusubjId'";
...
//========================English=========================
else if($stusubjId==3 OR $stusubjId==4)
{
  $insfmark="INSERT INTO `modeltest_class9_10_final_result` (`borno_school_id`, `borno_school_branch_id`, `borno_school_class_id`, `borno_school_shift_id`, `borno_school_section_id`, `borno_school_session`, `borno_subject_nine_ten_id`, `borno_result_term_id`, `borno_student_info_id`, `borno_school_roll`, `borno_school_student_name`, `temp_res_number_type1`, `temp_res_number_type1_conv`, `res_number_type2`, `res_number_type2_conv`, `res_number_type3`, `res_number_type3_conv`, `res_number_type4`, `res_number_type4_conv`, `res_number_type5`, `res_number_type5_conv`, `res_number_type6`, `res_number_type6_conv`, `res_total_mark`, `res_total_conv`,`mark_in_present`, `res_gpa`, `res_lg`,`pare`,`six_eight_4th_subject`,`uncountable`,`borno_school_stud_group`,`stu4thsub`,`heightsubjt1`,`heightsubjt2`)
...
if($studClass==1 OR $studClass==2)
{
$delgpa="DELETE from modeltest_school_9_10_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$group'";
...
elseif($studClass==3 OR $studClass==4 OR $studClass==5)
{
$delgpa="DELETE from modeltest_school_6_8_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm'";
...
{
$delgpa="DELETE from modeltest_play_5_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm'";
...
{		
		$getheightmarkdel="delete  from modeltest_height_mark_class6_8 where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND subject_id_six_eight='$stusubjId' AND borno_result_term_id='$selTerm'";
...
{		
		$getheightmarkdel="delete  from modeltest_maxnumber_class1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_subject_id='$stusubjId' AND borno_result_term_id='$selTerm'";
	$mysqli->query($getheightmarkdel);		
...
if($qinstm1) { header("location:marks_entry.php?msg=1&branchId=$branchId&studClass=$studClass&shiftId=$shiftId&section=$section&stsess=$stsess&selTerm=$selTerm");} else {  header('location:marks_entry.php?msg=2'); }
	}
