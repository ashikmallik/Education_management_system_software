...
for($i=0; $i<count($stuName); $i++){
	...
	$totalmark=$ntype1[$i]*$con1/100+$ntype2[$i]*$con2/100+$ntype3[$i]*$con3/100+$ntype4[$i]*$con4/100+$ntype5[$i]*$con5/100+$ntype6[$i]*$con6/100;
	 ...
	 $insfmark1="UPDATE `modeltest_class9_10_temp_mark1` SET `temp_res_number_type1`='$ntype1[$i]',
...
for($i=0; $i<count($stuName); $i++){
	...
	$totalmark=$ntype1[$i]*$con1/100+$ntype2[$i]*$con2/100+$ntype3[$i]*$con3/100+$ntype4[$i]*$con4/100+$ntype5[$i]*$con5/100+$ntype6[$i]*$con6/100;
	 ...
	 $insfmark1="UPDATE `modeltest_class6_8_temp_mark1` SET `temp_res_number_type1`='$ntype1[$i]',
			`temp_res_number_type2`='$ntype2[$i]',
			`temp_res_number_type3`='$ntype3[$i]',
			`temp_res_number_type4`='$ntype4[$i]',
			`temp_res_number_type5`='$ntype5[$i]',
...
$totalmark=$ntype1[$i]*$con1/100+$ntype2[$i]*$con2/100+$ntype3[$i]*$con3/100+$ntype4[$i]*$con4/100+$ntype5[$i]*$con5/100+$ntype6[$i]*$con6/100;				
	 ...
	 $insfmark1="UPDATE `modeltest_class1_temp_mark1` SET `temp_res_number_type1`='$ntype1[$i]',
			`temp_res_number_type2`='$ntype2[$i]',
			`temp_res_number_type3`='$ntype3[$i]',
			`temp_res_number_type4`='$ntype4[$i]',
			`temp_res_number_type5`='$ntype5[$i]',
...
if($quygeneralsubmark) { header("location:edit_marks.php?msg=1&branchId=$branchId&studClass=$studClass&shiftId=$shiftId&section=$section&stsess=$stsess&selTerm=$selTerm");} else {  header('location:edit_marks.php?msg=2'); }
	}
