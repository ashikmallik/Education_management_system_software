...
{		
 $gtgpa ="select * from modeltest_school_9_10_merit where borno_school_class_id='$studClass' AND borno_school_branch_id='$gtfbranchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$group'";
...
{		
$gtgpa ="select * from modeltest_school_6_8_merit where borno_school_class_id='$studClass' AND borno_school_branch_id='$gtfbranchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm'";
					$qgtgpa=$mysqli->query($gtgpa);
					$stqgtgpa=$qgtgpa->fetch_assoc();
					$gpa=$stqgtgpa['gpa'];	
}
...
{		
$gtgpa ="select * from modeltest_play_5_merit where borno_school_class_id='$studClass' AND borno_school_branch_id='$gtfbranchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm'";
					$qgtgpa=$mysqli->query($gtgpa);
					$stqgtgpa=$qgtgpa->fetch_assoc();
					$gpa=$stqgtgpa['gpa'];	
}
...
?>
 ...
 <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_avg_progress_report.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">Avg. Progress Report Two Term</a></td>
 </tr>
  <?php } ?>
 <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_avg2_progress_report.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">GPA Avg. Progress Report Two Term</a></td>
 </tr>
 <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
