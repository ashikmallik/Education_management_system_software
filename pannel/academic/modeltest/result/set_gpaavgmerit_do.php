...
$gtctmarg1="select * from borno_student_info where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_school_stud_group='$group1' Order by borno_student_info_id";
	...
	while($shgtctmarg=$qgtctmarg->fetch_assoc()){
	   ...
	   $gtFinalGPA=$gttotalgpa;
	   $gtFinalGPA1=$gttotalgpa3;
	...
	VALUES ('$schId', '$branchId1', '$studClass1', '$shiftId1', '$section1', '$stsess1', '$group1', '0', '$studinfoId', '$studRoll', '$studName', '$totalmark','$totalmark1', '$gtFinalGPA','$gtFinalGPA1', '$finallg', '', '', '', '', '', '', '', '')";
...
$gtctmarg1="select * from borno_student_info where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' Order by borno_student_info_id";
	...
	VALUES ('$schId', '$branchId1', '$studClass1', '$shiftId1', '$section1', '$stsess1', '0', '$studinfoId', '$studRoll', '$studName', '$totalmark', '$gtFinalGPA', '$finallg', '', '', '', '', '', '', '', '')";
