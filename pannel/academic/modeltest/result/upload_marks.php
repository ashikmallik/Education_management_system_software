...
<table width="650" border="0" cellspacing="0" cellpadding="0" class="projectlist" align="center">
  ...
  <tr>
    ...
    <td><select name="stusubjId" id="stusubjId" onchange="callpage();">
	  ...
	  {
			$studSetSub="SELECT * FROM `modeltest_set_subject_six_eight` where borno_school_id ='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$clSess'";
