    ...
    <div class="ot_main_content">
        <div class="admin_logout">
            <div class="admin_head">
                <h3>Model Test Panel [ <?php echo $shget_schoolName['borno_school_name']; ?> ] </h3>
            </div>
            <div class="log_out">
 ...
 // $shiftId=$_REQUEST['shiftId'];
  ...
  <tr>
    ...
    <td>
	  ...
	  <?php
	  		$stsess=$_POST['stsess'];
			$schexterm="select * from modeltest_add_term where borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
