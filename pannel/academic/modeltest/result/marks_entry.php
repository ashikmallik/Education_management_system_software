  ...
  <tr>
    ...
    <td><select name="stusubjId" id="stusubjId" onchange="callpage();">
	  ...
	  elseif($studClass==3 OR $studClass==4 OR $studClass==5)
	  		{
		echo	$gsubjName="select * from modeltest_set_subject_six_eight where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$clSess' order by subject_id_six_eight asc";
			$qgsubjName=$mysqli->query($gsubjName);
			while($shgsubjName=$qgsubjName->fetch_assoc()){
