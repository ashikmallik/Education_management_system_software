...
$numbertype ="select * from borno_result_number_type where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass'";
		...
		$pdf->Cell(58,5,$termname1,1,0,"C");
		$pdf->Cell(58,5,$termname2,1,0,"C");
		$pdf->Cell(58,5,$termname3,1,0,"C");
		$pdf->Cell(58,5,"Average Result",1,0,"C");
$pdf->Ln();	
		$pdf->Cell(39,5,"",0);	
		$pdf->Cell(9,5,"Mark",0,0,"C");
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(6,5,$type1,1,0,"C");
		$pdf->Cell(6,5,$type2,1,0,"C");
		$pdf->Cell(6,5,$type3,1,0,"C");
		$pdf->Cell(6,5,$type4,1,0,"C");
		$pdf->Cell(6,5,$type5,1,0,"C");
		$pdf->Cell(6,5,$type6,1,0,"C");
		$pdf->Cell(12,5,"Total",1,0,"C");
		$pdf->Cell(6,5,GP,1,0,"C");
		$pdf->Cell(4,5,G,1,0,"C");
		$pdf->Cell(6,5,$type1,1,0,"C");
		$pdf->Cell(6,5,$type2,1,0,"C");
		$pdf->Cell(6,5,$type3,1,0,"C");
		$pdf->Cell(6,5,$type4,1,0,"C");
...
$resultterm3 = "select * from borno_class6_8_temp_mark1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid3' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight='$stN'";


					$qresultterm3=$mysqli->query($resultterm3);
					$rowterm3=$qresultterm3->fetch_assoc();		
		$stN31=$rowterm3['temp_res_number_type1'];
		$stN32=$rowterm3['temp_res_number_type2'];
		$stN33=$rowterm3['temp_res_number_type3'];
		$stN34=$rowterm3['temp_res_number_type4'];
		$stN35=$rowterm3['temp_res_number_type5'];
		$stN36=$rowterm3['temp_res_number_type6'];
		$stName3=$rowterm3['total_mark'];
...
$subjectdetails ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid2' AND subject_id_six_eight='$stN'";
		...
		$pdf->Cell(7,10,$stNamef1,1,0,"C");
        $pdf->Cell(6,10,$stphone1,1,0,"C");
		$pdf->Cell(4,10,$stgp1,1,0,"C");
		}
		...
		$pdf->Cell(12,5,$stName1,1,0,"C");
		$pdf->Cell(6,5,$stphone1,1,0,"C");
		$pdf->Cell(4,5,$stgp1,1,0,"C");
}


		if($subtype1!=0)
		{		
		$pdf->Cell(6,5,$stN21,1,0,"C");
		}
		else
		{
		$pdf->Cell(6,5,'-',1,0,"C");
		...
		$pdf->Cell(7,10,$stNamef2,1,0,"C");
        $pdf->Cell(6,10,$stphone2,1,0,"C");
		$pdf->Cell(4,10,$stgp2,1,0,"C");
		}
		elseif($stN!=$fsstgtsubject)
		{
		$pdf->Cell(5,5,$stName2,1,0,"C");
		...
		$pdf->Cell(12,5,$stName2,1,0,"C");
		$pdf->Cell(6,5,$stphone2,1,0,"C");
		$pdf->Cell(4,5,$stgp2,1,0,"C");
}


		if($subtype1!=0)
		{		
		$pdf->Cell(6,5,$stN31,1,0,"C");
		}
		else
		{
		$pdf->Cell(6,5,'-',1,0,"C");
		...
		$gtsgpa ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid3' AND borno_school_roll='$gtstotal111' AND pare='1'";
					$qggtsgpa=$mysqli->query($gtsgpa);
					$stgqggtsgpa=$qggtsgpa->fetch_assoc();
		$stNamef3=$stgqggtsgpa['res_total_conv'];			
		$stphone3=$stgqggtsgpa['res_gpa'];
	    $stgp3=$stgqggtsgpa['res_lg'];
					
		$pdf->Cell(5,5,$stName3,1,0,"C");
		$pdf->Cell(7,10,$stNamef3,1,0,"C");
        $pdf->Cell(6,10,$stphone3,1,0,"C");
		$pdf->Cell(4,10,$stgp3,1,0,"C");
		}
		elseif($stN!=$fsstgtsubject)
		{
		$pdf->Cell(5,5,$stName3,1,0,"C");
		...
		$gtsgpa ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid3' AND borno_school_roll='$gtstotal111' AND pare='2'";
					$qggtsgpa=$mysqli->query($gtsgpa);
					$stgqggtsgpa=$qggtsgpa->fetch_assoc();
		...
		$pdf->Cell(12,5,$stName3,1,0,"C");
		$pdf->Cell(6,5,$stphone3,1,0,"C");
		$pdf->Cell(4,5,$stgp3,1,0,"C");
}
		...
		$pdf->Cell(7,10,$stNamef3,1,0,"C");
        $pdf->Cell(6,10,$stphone,1,0,"C");
		$pdf->Cell(4,10,$stgp,1,0,"C");
		$pdf->Cell(5,5,'',2,0,"C");
		}
		elseif($stN!=$fsstgtsubject)
		{
		...
		$pdf->Cell(6,5,$stphone,1,0,"C");
		$pdf->Cell(4,5,$stgp,1,0,"C");
}
					}
...
$fstlg1=$stggtstotalg1['finallg'];
		...
		$pdf->Cell(12,6,$fstotal,1,0,"C");
		$pdf->Cell(10,6,$fstotal1,1,0,"C");
...
$fstlg2=$stggtstotalg2['finallg'];
		...
		$pdf->Cell(36,6,'',1);
		$pdf->Cell(12,6,$fstotal2,1,0,"C");
		$pdf->Cell(10,6,$fstotal12,1,0,"C");

 $gtstotalg21 ="select * from borno_school_6_8_merit where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$termid3 AND borno_school_roll=$gtstotal111";
					$qgtstotalg21=$mysqli->query($gtstotalg21);
					$stggtstotalg21=$qgtstotalg21->fetch_assoc();
$pdf->SetFont('Arial','',12);
$fstotal21=$stggtstotalg21['grandtotal'];
$fstotal121=$stggtstotalg21['gpa'];
$fstlg21=$stggtstotalg21['finallg'];

		$pdf->Cell(36,6,'',1);
		$pdf->Cell(12,6,$fstotal21,1,0,"C");
		$pdf->Cell(10,6,$fstotal121,1,0,"C");
...
$fstlg3=$stggtstotalg3['finallg'];
		...
		$pdf->Cell(36,6,'',1);
		$pdf->Cell(12,6,$fstotal3,1,0,"C");
		$pdf->Cell(10,6,$fstotal13,1,0,"C");
...
$gtstotal13 ="select * from borno_school_6_8_merit where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$termid3 AND borno_school_roll=$gtstotal111";
					$qgtstotal13=$mysqli->query($gtstotal13);
					$stggtstotal13=$qgtstotal13->fetch_assoc();
$pdf->SetFont('Arial','',12);
$fmerit31=$stggtstotal13['merit_section'];
$fmerit32=$stggtstotal13['merit_shift'];
$fmerit33=$stggtstotal13['merit_class'];
...
$gtstotal1123t1 ="select * from borno_school_6_8_merit where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$termid3";
	                $qgtstotal1123t1=$mysqli->query($gtstotal1123t1);
					$totalstudent3=mysqli_num_rows($qgtstotal1123t1);
...
$gtstotalday2 ="select * from borno_school_schooling_day where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$termid3";
	                $qggtstotalday2=$mysqli->query($gtstotalday2);
					$stgqggtstotalday2=$qggtstotalday2->fetch_assoc();
					$schoolingday2=$stgqggtstotalday2['borno_school_schooling_day'];					
					$publish=$stgqggtstotalday2['borno_school_publish_date'];
...
$gtsattend3 ="select * from borno_school_attendence where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$termid3 AND borno_school_roll='$gtstotal111'";
	                $qggtsattend3=$mysqli->query($gtsattend3);
					$stgqqggtsattend3=$qggtsattend3->fetch_assoc();
					$presence3=$stgqqggtsattend3['borno_school_presence'];
					$absence3=$stgqqggtsattend3['borno_school_absence'];										
...
$pdf->Cell(25,5,$termname3,1,0,"L");
$pdf->Cell(20,5,$fstotal21,1,0,"C");	
$pdf->Cell(10,5,$fstotal121,1,0,"C");	
$pdf->Cell(12,5,$fstlg21,1,0,"C");
if($fstotal121==0)
{
$pdf->Cell(25,5,'Failed',1,0,"C");
}
...
$pdf->Cell(40,5,$fmerit31,1,0,"C");
$pdf->Cell(35,5,$fmerit32,1,0,"C");
$pdf->Cell(35,5,$fmerit33,1,0,"C");
$pdf->Cell(23,5,$totalstudent3,1,0,"C");
$pdf->Cell(23,5,$schoolingday2,1,0,"C");
$pdf->Cell(16,5,$presence3,1,0,"C");
$pdf->Cell(16,5,$absence3,1,0,"C");	
$pdf->Ln();	
...
$resultterm3 = "select * from borno_class1_temp_mark1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid3' AND borno_school_roll='$gtstotal111' AND borno_result_subject_id='$stN'";
...
$subjectdetails ="select * from borno_result_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid2' AND borno_result_subject_id='$stN'";
		...
		if($pare==1)
		{
		$gtsubjectid ="select * from borno_result_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid3' AND pare='1' order by borno_result_subject_id asc limit 0,1";
					$qgtsubjectid=$mysqli->query($gtsubjectid);
					$stqgtsubjectid=$qgtsubjectid->fetch_assoc();
					$fsstgtsubject=$stqgtsubjectid['borno_result_subject_id'];	
		if($stN==$fsstgtsubject)
		...
		elseif($pare==2)
		{
		$gtsubjectid ="select * from borno_result_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid3' AND pare='2' order by borno_result_subject_id asc limit 0,1";
					$qgtsubjectid=$mysqli->query($gtsubjectid);
					$stqgtsubjectid=$qgtsubjectid->fetch_assoc();
					$fsstgtsubject=$stqgtsubjectid['borno_result_subject_id'];	
		if($stN==$fsstgtsubject)
...
$gtstotal13 ="select * from borno_school_play_5_merit where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$termid3 AND borno_school_roll=$gtstotal111";
					$qgtstotal13=$mysqli->query($gtstotal13);
					$stggtstotal13=$qgtstotal13->fetch_assoc();
$pdf->SetFont('Arial','',12);
$fmerit31=$stggtstotal13['merit_section'];
...
$gtstotal1123t1 ="select * from borno_school_play_5_merit where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$termid3";
	                $qgtstotal1123t1=$mysqli->query($gtstotal1123t1);
					$totalstudent3=mysqli_num_rows($qgtstotal1123t1);
