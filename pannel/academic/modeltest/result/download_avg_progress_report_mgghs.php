...
$pdf->Cell(10,5,'',0,0,"L");
$pdf->Cell(210,5,"Progress Report of : $fstname",0,0,"L");
...
$pdf->SetFont('Arial','I',10);
$pdf->Cell(49,5,$termname2,0,0,"L");
$pdf->SetFont('Arial','',10);
$pdf->Cell(20,5,"Exam Year :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->Cell(40,5,$stsess,0,0,"L");
...
$numbertype ="select * from borno_result_number_type where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass'";
		...
		$pdf->Cell(74,5,$termname1,1,0,"C");
		$pdf->Cell(74,5,$termname2,1,0,"C");
		$pdf->Cell(74,5,"Average Result",1,0,"C");
$pdf->Ln();
        $pdf->Cell(10,5,'',0,0,"L");
		$pdf->Cell(39,5,"",0);	
...
$getsubuncoun="select * from borno_result_nine_ten_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$termid1' AND borin_subject_nine_ten_id='$stN' AND uncountable=1";
$qgetsubjcoun=$mysqli->query($getsubuncoun);
$shgetsubcount=$qgetsubjcoun->fetch_assoc();		
		$uncountable=$shgetsubcount['uncountable'];	
		
		if($uncountable!=""){goto lastline910;}
		$pdf->Ln();
...
$subjectdetails ="select * from borno_result_nine_ten_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid2' AND borin_subject_nine_ten_id='$stN'";
		...
		$pdf->SetFont('Arial','',6);			
		$pdf->Cell(5,5,$stName1,1,0,"C");
		$pdf->Cell(6,10,$stNamef1,1,0,"C");
		$pdf->SetFont('Arial','',9);
		...
		$pdf->SetFont('Arial','',6);			
		$pdf->Cell(5,5,$stName2,1,0,"C");
		$pdf->Cell(6,10,$stNamef2,1,0,"C");
		$pdf->SetFont('Arial','',9);
		...
		$pdf->SetFont('Arial','',6);			
		$pdf->Cell(5,5,$stName,1,0,"C");
		$pdf->Cell(6,10,$stNamef3,1,0,"C");
		$pdf->SetFont('Arial','',9);
...
$s11l=0;
 ...
 $resultun11 = "select * from borno_class9_10_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid2' AND borno_school_roll='$gtstotal111' AND uncountable=1 AND borno_subject_nine_ten_id=$stNun";

					$qresultun11=$mysqli->query($resultun11);
					$rowun11=$qresultun11->fetch_assoc();        
        
        $stNun11=$rowun11['temp_res_number_type1'];
		$stNun21=$rowun11['res_number_type2'];
		$stNun31=$rowun11['res_number_type3'];
		$stNun41=$rowun11['res_number_type4'];
		$stNun51=$rowun11['res_number_type5'];
		$stNun61=$rowun11['res_number_type6'];
        $sttotal1=$rowun11['res_total_conv'];
        $stgpa1=$rowun11['res_gpa'];
        $stlg1=$rowun11['res_lg'];
        
 $resultun111 = "select * from borno_class9_10_avg_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='0' AND borno_school_roll='$gtstotal111' AND uncountable=1 AND borno_subject_nine_ten_id=$stNun";

					$qresultun111=$mysqli->query($resultun111);
					$rowun111=$qresultun111->fetch_assoc();        
        
        $stNun111=$rowun111['temp_res_number_type1'];
		$stNun211=$rowun111['res_number_type2'];
		$stNun311=$rowun111['res_number_type3'];
		$stNun411=$rowun111['res_number_type4'];
		$stNun511=$rowun111['res_number_type5'];
		$stNun611=$rowun111['res_number_type6'];
        $sttotal11=$rowun111['res_total_conv'];
        $stgpa11=$rowun111['res_gpa'];
        $stlg11=$rowun111['res_lg'];
		...
		$gtsubjectun ="select * from borno_subject_nine_ten where borno_subject_nine_ten_id=$stNun";
					...
					$fsstgtsubjectun=substr($stgtsubjectun['borno_subject_nine_ten_name'],0,25);

$subjectdetailsun ="select * from borno_result_nine_ten_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid1' AND borin_subject_nine_ten_id='$stNun'";
		...
		$pdf->Cell(10,5,'',0,0,"L");
		$pdf->Cell(39,5,$fsstgtsubjectun,1);
		$pdf->Cell(9,5,$fsstgtsubject1un,1,0,"C");
		if($subtypeun1!=0)
		{		
		$pdf->Cell(8,5,$stNun1,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
        ...
        $pdf->Cell(11,5,$sttotal,1,0,"C");	
		$pdf->Cell(8,5,$stgpa,1,0,"C");
		$pdf->Cell(7,5,$stlg,1,0,"C");
		
		if($subtypeun1!=0)
		{		
		$pdf->Cell(8,5,$stNun11,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		$pdf->Cell(11,5,$sttotal1,1,0,"C");	
		$pdf->Cell(8,5,$stgpa1,1,0,"C");
		$pdf->Cell(7,5,$stlg1,1,0,"C");

        if($subtypeun1!=0)
		{		
		$pdf->Cell(8,5,$stNun111,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
        ...
        $pdf->Cell(11,5,$sttotal11,1,0,"C");	
		$pdf->Cell(8,5,$stgpa11,1,0,"C");
		$pdf->Cell(7,5,$stlg11,1,0,"C");
 $pdf->Ln();       
}
//================================Uncountable End========================
...
$pdf->Ln();
$pdf->Cell(10,5,'',0,0,"L");
$pdf->Cell(20,5,$termname1,1,0,"L");
$pdf->Cell(20,5,$fstotal,1,0,"C");	
$pdf->Cell(10,5,$fstotal1,1,0,"C");	
$pdf->Cell(12,5,$fstlg1,1,0,"C");
if($fstotal1==0)
{
$pdf->Cell(20,5,'Failed',1,0,"C");
}
else
{
 $pdf->Cell(20,5,'Passed',1,0,"C");   
}
...
$pdf->Cell(5,5,'',0);
$pdf->Cell(130,5,"Bahaviour",1,0,"C");
$pdf->Ln();
$pdf->Cell(10,5,'',0,0,"L");
...
$pdf->Cell(5,5,'',1);
$pdf->Cell(5,5,'',0);
$pdf->Cell(22,5,"Excellent",1);
$pdf->Cell(8,5,'',1);
$pdf->Cell(23,5,"Very Good",1);
$pdf->Cell(8,5,'',1);
...
$gtsattend11 ="select * from borno_school_assesment where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$termid2 AND borno_school_roll='$gtstotal111'";
	                $qggtsattend11=$mysqli->query($gtsattend11);
					$stgqqggtsattend11=$qggtsattend11->fetch_assoc();
					$regulation1=$stgqqggtsattend11['regulation'];
					$patritism1=$stgqqggtsattend11['patritism'];
					$honesty1=$stgqqggtsattend11['honesty'];
					$leadership1=$stgqqggtsattend11['leadership'];		
					$discipline1=$stgqqggtsattend11['discipline'];	
					$cooperation1=$stgqqggtsattend11['cooperation'];	
					$participation1=$stgqqggtsattend11['participation'];	
					$sympathy1=$stgqqggtsattend11['sympathy'];	
					$awareness1=$stgqqggtsattend11['awareness'];	
					$punctuality1=$stgqqggtsattend11['punctuality'];	
					$total_mark1=$stgqqggtsattend11['total_mark'];	
					$remarks1=$stgqqggtsattend11['remarks'];
$pdf->Cell(10,5,'',0,0,"L");
$pdf->Cell(14,5,"Exam",1,0,"C");
$pdf->Cell(20,5,"Regulation",1,0,"C");	
$pdf->Cell(20,5,"Patritism",1,0,"C");
$pdf->Cell(20,5,"Honesty",1,0,"C");
$pdf->Cell(20,5,"leadership",1,0,"C");
$pdf->Cell(20,5,"Discipline",1,0,"C");
$pdf->Cell(23,5,"Cooperation",1,0,"C");
$pdf->Cell(25,5,"Active Participation",1,0,"C");
$pdf->Cell(23,5,"Sympathy",1,0,"C");
$pdf->Cell(23,5,"Awareness",1,0,"C");
$pdf->Cell(23,5,"Punctuality",1,0,"C");
$pdf->Cell(10,5,"Total",1,0,"C");		
$pdf->Cell(29,5,"Remarks",1,0,"C");	
$pdf->Ln();	
$pdf->Cell(10,5,'',0,0,"L");
$pdf->Cell(14,5,$termname1,1,0,"C");
$pdf->Cell(20,5,$regulation,1,0,"C");
$pdf->Cell(20,5,$patritism,1,0,"C");
$pdf->Cell(20,5,$honesty,1,0,"C");
$pdf->Cell(20,5,$leadership,1,0,"C");
...
$pdf->Ln();	
$pdf->Cell(10,5,'',0,0,"L");
$pdf->Cell(14,5,$termname2,1,0,"C");
$pdf->Cell(20,5,$regulation1,1,0,"C");
$pdf->Cell(20,5,$patritism1,1,0,"C");
$pdf->Cell(20,5,$honesty1,1,0,"C");
$pdf->Cell(20,5,$leadership1,1,0,"C");
$pdf->Cell(20,5,$discipline1,1,0,"C");
$pdf->Cell(23,5,$cooperation1,1,0,"C");
$pdf->Cell(25,5,$participation1,1,0,"C");
$pdf->Cell(23,5,$sympathy1,1,0,"C");
$pdf->Cell(23,5,$awareness1,1,0,"C");
$pdf->Cell(23,5,$punctuality1,1,0,"C");
$pdf->Cell(10,5,$total_mark1,1,0,"C");
$pdf->Cell(29,5,$remarks1,1,0,"C");
$pdf->Ln();	
...
$gtstname ="select * from borno_student_info where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_school_roll='$gtstotal111'";
...
if($stNbangla!=""){
 ...
 $gtstotalban11 ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid2' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=18";
					$qgtstotalban11=$mysqli->query($gtstotalban11);
					$sqgtstotalban11=$qgtstotalban11->fetch_assoc(); 
		            $stNbangla11=$sqgtstotalban11['temp_res_number_type1'];
		            $stNbangla21=$sqgtstotalban11['res_number_type2'];
		            $stNbangla31=$sqgtstotalban11['res_number_type3'];
		            $stNbangla41=$sqgtstotalban11['res_number_type4'];
		            $stNbangla51=$sqgtstotalban11['res_number_type5'];
		            $stNbangla61=$sqgtstotalban11['res_number_type6'];
		            $stNbanglatotal1=$sqgtstotalban11['res_total_conv'];		
    				$stphoneban1=$sqgtstotalban11['res_gpa'];
					$stgpban1=$sqgtstotalban11['res_lg'];
				
 $gtstotalban111 ="select * from borno_class6_8_avg_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='0' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=18";
					$qgtstotalban111=$mysqli->query($gtstotalban111);
					$sqgtstotalban111=$qgtstotalban111->fetch_assoc();
		            $stNbangla111=$sqgtstotalban111['temp_res_number_type1'];
		            $stNbangla211=$sqgtstotalban111['res_number_type2'];
		            $stNbangla311=$sqgtstotalban111['res_number_type3'];
		            $stNbangla411=$sqgtstotalban111['res_number_type4'];
		            $stNbangla511=$sqgtstotalban111['res_number_type5'];
		            $stNbangla611=$sqgtstotalban111['res_number_type6'];
		            $stNbanglatotal11=$sqgtstotalban111['res_total_conv'];		
    				$stphoneban11=$sqgtstotalban111['res_gpa'];
					$stgpban11=$sqgtstotalban111['res_lg'];
...
$gtsubjectb ="select * from borno_subject_six_eight where subject_id_six_eight=$stNbangla";
		...
		$pdf->Cell(10,5,'',0,0,"L");
		$pdf->Cell(39,5,$fsstgtsubjectb,1);
 ...
 $fsstgtsubject1b=$stgtsubject1b['sub_six_eight_fullmark'];
        $pdf->Cell(9,5,$fsstgtsubject1b,1,0,"C");

$subjectdetailsb ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid1' AND subject_id_six_eight='$stNbangla'";
	   ...
	   $pdf->Cell(8,5,$stNbangla3,1,0,"C");
        ...
        $pdf->Cell(11,5,$stNbanglatotal,1,0,"C");	
		$pdf->Cell(8,5,$stphoneban,1,0,"C");
		$pdf->Cell(7,5,$stgpban,1,0,"C");
		
		if($subtypeb1!=0)
		{		
		 $pdf->Cell(8,5,$stNbangla11,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypeb2!=0)
		{		
		$pdf->Cell(8,5,$stNbangla21,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypeb3!=0)
		{		
	   $pdf->Cell(8,5,$stNbangla31,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypeb4!=0)
		{		
		$pdf->Cell(8,5,$stNbangla41,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypeb5!=0)
		{		
		$pdf->Cell(8,5,$stNbangla51,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypeb6!=0)
		{		
		$pdf->Cell(8,5,$stNbangla61,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
        ...
        $pdf->Cell(11,5,$stNbanglatotal1,1,0,"C");	
		$pdf->Cell(8,5,$stphoneban1,1,0,"C");
		$pdf->Cell(7,5,$stgpban1,1,0,"C");
		
		
		if($subtypeb1!=0)
		{		
		 $pdf->Cell(8,5,$stNbangla111,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypeb2!=0)
		{		
		$pdf->Cell(8,5,$stNbangla211,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypeb3!=0)
		{		
	   $pdf->Cell(8,5,$stNbangla311,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypeb4!=0)
		{		
		$pdf->Cell(8,5,$stNbangla411,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypeb5!=0)
		{		
		$pdf->Cell(8,5,$stNbangla511,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypeb6!=0)
		{		
		$pdf->Cell(8,5,$stNbangla611,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
        ...
        $pdf->Cell(11,5,$stNbanglatotal11,1,0,"C");	
		$pdf->Cell(8,5,$stphoneban11,1,0,"C");
		$pdf->Cell(7,5,$stgpban11,1,0,"C");
		$pdf->Ln();
}
...
if($stNenglish!=""){
 ...
 $gtstotaleng11 ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid2' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=19";
		            ...
		            $stNenglish21=$sqgtstotaleng11['res_number_type2'];
		            $stNenglish31=$sqgtstotaleng11['res_number_type3'];
		            $stNenglish41=$sqgtstotaleng11['res_number_type4'];
		            $stNenglish51=$sqgtstotaleng11['res_number_type5'];
		            $stNenglish61=$sqgtstotaleng11['res_number_type6'];
		            $stNenglishtotal1=$sqgtstotaleng11['res_total_conv'];		
    				$stphoneeng1=$sqgtstotaleng11['res_gpa'];
					$stgpeng1=$sqgtstotaleng11['res_lg'];

 $gtstotaleng111 ="select * from borno_class6_8_avg_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='0' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=19";
					$qgtstotaleng111=$mysqli->query($gtstotaleng111);
					$sqgtstotaleng111=$qgtstotaleng111->fetch_assoc();
		            $stNenglish111=$sqgtstotaleng111['temp_res_number_type1'];
		            $stNenglish211=$sqgtstotaleng111['res_number_type2'];
		            $stNenglish311=$sqgtstotaleng111['res_number_type3'];
		            $stNenglish411=$sqgtstotaleng111['res_number_type4'];
		            $stNenglish511=$sqgtstotaleng111['res_number_type5'];
		            $stNenglish611=$sqgtstotaleng111['res_number_type6'];
		            $stNenglishtotal11=$sqgtstotaleng111['res_total_conv'];		
    				$stphoneeng11=$sqgtstotaleng111['res_gpa'];
					$stgpeng11=$sqgtstotaleng111['res_lg'];
...
$gtsubjecte ="select * from borno_subject_six_eight where subject_id_six_eight=$stNenglish";
		...
		$pdf->Cell(10,5,'',0,0,"L");
		$pdf->Cell(39,5,$fsstgtsubjecte,1);
 ...
 $fsstgtsubject1e=$stgtsubject1e['sub_six_eight_fullmark'];
        $pdf->Cell(9,5,$fsstgtsubject1e,1,0,"C");

$subjectdetailse ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid1' AND subject_id_six_eight='$stNenglish'";
		...
		if($subtypee1!=0)
		{		
		$pdf->Cell(8,5,$stNenglish1,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee2!=0)
		{		
		$pdf->Cell(8,5,$stNenglish2,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee3!=0)
		{		
		$pdf->Cell(8,5,$stNenglish3,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
	    ...
	    if($subtypee4!=0)
		{		
		$pdf->Cell(8,5,$stNenglish4,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee5!=0)
		{		
		$pdf->Cell(8,5,$stNenglish5,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee6!=0)
		{		
		$pdf->Cell(8,5,$stNenglish6,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
        ...
        $pdf->Cell(11,5,$stNenglishtotal,1,0,"C");	
		$pdf->Cell(8,5,$stphoneeng,1,0,"C");
		$pdf->Cell(7,5,$stgpeng,1,0,"C");	

		if($subtypee1!=0)
		{		
		$pdf->Cell(8,5,$stNenglish11,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee2!=0)
		{		
		$pdf->Cell(8,5,$stNenglish21,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee3!=0)
		{		
		$pdf->Cell(8,5,$stNenglish31,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
	    ...
	    if($subtypee4!=0)
		{		
		$pdf->Cell(8,5,$stNenglish41,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee5!=0)
		{		
		$pdf->Cell(8,5,$stNenglish51,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee6!=0)
		{		
		$pdf->Cell(8,5,$stNenglish61,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
        ...
        $pdf->Cell(11,5,$stNenglishtotal1,1,0,"C");	
		$pdf->Cell(8,5,$stphoneeng1,1,0,"C");
		$pdf->Cell(7,5,$stgpeng1,1,0,"C");
		
		if($subtypee1!=0)
		{		
		$pdf->Cell(8,5,$stNenglish111,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee2!=0)
		{		
		$pdf->Cell(8,5,$stNenglish211,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee3!=0)
		{		
		$pdf->Cell(8,5,$stNenglish311,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
	    ...
	    if($subtypee4!=0)
		{		
		$pdf->Cell(8,5,$stNenglish411,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee5!=0)
		{		
		$pdf->Cell(8,5,$stNenglish511,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
		...
		if($subtypee6!=0)
		{		
		$pdf->Cell(8,5,$stNenglish611,1,0,"C");
		}
		else
		{
		$pdf->Cell(8,5,'-',1,0,"C");
        ...
        $pdf->Cell(11,5,$stNenglishtotal11,1,0,"C");	
		$pdf->Cell(8,5,$stphoneeng11,1,0,"C");
		$pdf->Cell(7,5,$stgpeng11,1,0,"C");		
    $pdf->Ln();
}
//=====================English End============================
$result = "select * from borno_class6_8_avg_temp_mark where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='0' AND borno_school_roll='$gtstotal111' AND uncountable=0 AND subject_id_six_eight!=18 AND subject_id_six_eight!=19 order by subject_id_six_eight asc";
$sl=0;
	...
	$getsubuncoun="select * from borno_result_six_eight_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$termid1' AND subject_id_six_eight='$stN' AND uncountable=1";
$qgetsubjcoun=$mysqli->query($getsubuncoun);
$shgetsubcount=$qgetsubjcoun->fetch_assoc();		
		$uncountable=$shgetsubcount['uncountable'];	
...
$subjectdetails ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid2' AND subject_id_six_eight='$stN'";
		...
		$gtsgpa ="select * from borno_class6_8_avg_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='0' AND borno_school_roll='$gtstotal111' AND pare='1'";
					$qggtsgpa=$mysqli->query($gtsgpa);
					$stgqggtsgpa=$qggtsgpa->fetch_assoc();
		$stNamef3=$stgqggtsgpa['res_total_conv'];			
		$stphone=$stgqggtsgpa['res_gpa'];
		...
		$gtsgpa ="select * from borno_class6_8_avg_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='0' AND borno_school_roll='$gtstotal111' AND pare='2'";
					$qggtsgpa=$mysqli->query($gtsgpa);
					$stgqggtsgpa=$qggtsgpa->fetch_assoc();
...
$s11l=0;
 ...
 $resultun11 = "select * from borno_class6_8_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid2' AND borno_school_roll='$gtstotal111' AND uncountable=1 AND subject_id_six_eight=$stNun";
 ...
 $resultun111 = "select * from borno_class6_8_avg_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='0' AND borno_school_roll='$gtstotal111' AND uncountable=1 AND subject_id_six_eight=$stNun";
		...
		$gtsubjectun ="select * from borno_subject_six_eight where subject_id_six_eight=$stNun";
					$qgtsubjectun=$mysqli->query($gtsubjectun);
					$stgtsubjectun=$qgtsubjectun->fetch_assoc();
					$fsstgtsubjectun=substr($stgtsubjectun['six_eight_subject_name'],0,25);
...
$subjectdetailsun ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid1' AND subject_id_six_eight='$stNun'";
					$qsubjectdetailsun=$mysqli->query($subjectdetailsun);
					$sqsubjectdetailsun=$qsubjectdetailsun->fetch_assoc();
...
$pdf->Cell(135,5,"Co-Educational Activities",1,0,"C");
$pdf->Cell(5,5,'',0);
$pdf->Cell(130,5,"Opinion about Result (Filled up by Class Teacher)",1,0,"C");
$pdf->Ln();
$pdf->Cell(10,5,'',0,0,"L");
$pdf->Cell(35,5,"Cultural Activities",1);
$pdf->Cell(5,5,'',1);
...
$sl=0;
	...
	$getsubuncoun="select * from borno_result_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$termid1' AND borno_result_subject_id='$stN' AND subject_type=1";
$qgetsubjcoun=$mysqli->query($getsubuncoun);
$shgetsubcount=$qgetsubjcoun->fetch_assoc();		
		$uncountable=$shgetsubcount['subject_type'];	
		
		if($uncountable!=""){goto lastline5;}
		$pdf->Ln();
		$stN1=$row['temp_res_number_type1'];
		$stN2=$row['temp_res_number_type2'];
		$stN3=$row['temp_res_number_type3'];
...
$s11l=0;
 ...
 $resultun11 = "select * from borno_class1_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid2' AND borno_school_roll='$gtstotal111' AND subst=1 AND borno_result_subject_id=$stNun";
 ...
 $resultun111 = "select * from borno_play_five_avg_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='0' AND borno_school_roll='$gtstotal111' AND subst=1 AND borno_result_subject_id=$stNun";
		...
		$gtsubjectun ="select * from borno_result_subject where borno_result_subject_id=$stNun";
					$qgtsubjectun=$mysqli->query($gtsubjectun);
					$stgtsubjectun=$qgtsubjectun->fetch_assoc();
					$fsstgtsubjectun=substr($stgtsubjectun['borno_school_subject_name'],0,25);
$fsstgtsubject1un=$stgtsubjectun['borno_school_subject_fullmark'];

$subjectdetailsun ="select * from borno_result_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid1' AND borno_result_subject_id='$stNun'";
					$qsubjectdetailsun=$mysqli->query($subjectdetailsun);
					$sqsubjectdetailsun=$qsubjectdetailsun->fetch_assoc();
