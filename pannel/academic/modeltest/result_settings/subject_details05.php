...
<option value=" <?php echo $shqgstterm['borno_result_term_id']; ?>" <?php if($shqgstterm['borno_result_term_id']==$_REQUEST['term']) { echo "selected"; }  ?>> <?php echo $shqgstterm['borno_result_term_name']; ?></option>
      <?php } ?>
				...
				?>
 					...
 					$studClass=$_REQUEST['studClass'];
 					$stsess=$_REQUEST['stsess'];
					$gsubject="select * from modeltest_result_subject where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' order by modeltest_result_subject_id Asc";
          ...
          <input type="hidden" name="subid[]" id="subid[]" value="<?php echo $shqgsubject['modeltest_result_subject_id']; ?>" /></td>
