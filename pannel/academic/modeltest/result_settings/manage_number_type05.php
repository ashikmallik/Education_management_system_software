    ...
    <td><select name="stsess" id="stsess" onchange="callpage();">
      ...
      <option value="2020" <?php if($_POST['stsess']==2020) { echo "selected"; } ?>> 2020 </option>
					...
					if($typeId!=""){
						...
						$delterm="DELETE from modeltest_assign_number_type where borno_result_number_type_id='$typeId'";
            ...
            $gtedtgrade="select * from modeltest_assign_number_type where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess'";
