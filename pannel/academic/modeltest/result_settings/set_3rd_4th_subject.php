  ...
  <tr>
    ...
    <td><select name="studClass" id="studClass" onchange="callpage();">
      ...
      <?php
					...
					$getClassId="select * from borno_school_set_class where borno_school_id='$schId' AND borno_school_class_id!=3 AND borno_school_class_id!=4 AND borno_school_class_id!=5 AND borno_school_class_id!=6 AND borno_school_class_id!=10 AND borno_school_class_id!=13 AND borno_school_class_id!=14 AND borno_school_class_id!=15 AND borno_school_class_id!=16 AND borno_school_class_id!=17 AND borno_school_class_id!=18 AND borno_school_class_id!=19 AND borno_school_class_id!=20 AND borno_school_class_id!=21";
  ...
  <tr>
    ...
    <td><select name="subject4th" id="subject4th" onchange="callpage();">
      ...
      <?php      $dept=$_POST['dept'];
		...
		?>
   <option value="<?php echo $shfourthsubj1['borno_subject_nine_ten_id']; ?>" <?php if($_POST['subject4th']==$shfourthsubj1['borno_subject_nine_ten_id']){ echo "selected"; }
...
<?php
			...
			$fourthsubj="select * from borno_subject_nine_ten where borno_subject_nine_ten_dept2=4";
				...
				$fourthsubj="select * from borno_subject_nine_ten where borno_subject_nine_ten_dept='$dept'";
				}
