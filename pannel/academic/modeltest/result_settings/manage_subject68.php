  ...
  <tr>
    ...
    <select name="stsess" id="stsess" onchange="callpage();">
      ...
      <option value="2020" <?php if($_POST['stsess']==2020) { echo "selected"; } ?>> 2020 </option>
            ...
            $gtedtgrade="select * from modeltest_set_subject_six_eight where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess'  order by subject_id_six_eight asc";
			$s=0;
