    ...
    <td><select name="stsess" id="stsess" onchange="callpage();">
      ...
      <option value="2020" <?php if($_POST['stsess']==2020) { echo "selected"; } ?>> 2020 </option>
					...
					if($termId!=""){
						...
						$delterm="DELETE from modeltest_add_term where borno_result_term_id='$termId'";
            ...
            $gtedtgrade="select * from modeltest_add_term where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' order by borno_result_term_id asc";
			$s=0;
