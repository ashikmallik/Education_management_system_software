...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="result_sms.php";
    ...
    <div class="ot_main_content">
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                ...
                <div class="form">
                <form name="frmcontent" action="result_sms_do.php" method="post" enctype="multipart/form-data">
                                        <?php
			$msg=$_GET['msg'];
			if($msg==1) { echo "Sent successful"; }
  ...
  <tr>
    ...
    <td>
      ...
      <?php } ?>  
                               ...
                               <tr>
                                <td colspan="3" align="center"><input type="submit" name="button" id="button" value="Send"></td>
                              </tr>
