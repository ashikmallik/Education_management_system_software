<?php
 ...
 require_once '../../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	if (!function_exists('clean_html')) {
		...
		$gsess="select * from modeltest_assign_number_type where borno_school_id='$schId' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1'";
	...
	if($gtermsess!="") { header('location:add_number_type05.php?msg=1'); } else {
											...
											$insmk="INSERT INTO `modeltest_assign_number_type` (`borno_school_id`,`borno_school_class_id`,`borno_school_session`,
								    	`borno_result_subject_id`,`borno_school_number_type1`, `borno_school_number_type2`,`borno_school_number_type3`,`borno_school_number_type4`,`borno_school_number_type5`,`borno_school_number_type6`)
											
											 VALUES ('$schId','$studClass1','$stsess1',0, '$termName11', '$termName21','$termName31','$termName41','$termName51','$termName61')";
