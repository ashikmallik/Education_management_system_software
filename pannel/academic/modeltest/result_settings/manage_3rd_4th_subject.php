 ...
 ?>
  ...
  <tr>
    ...
    <td><select name="dept" id="dept" onchange="callpage();">
	 ...
	 $gsess="select * from borno_student_info where borno_student_info_id=$gtstdid";
   ...
   ?>
    	<td align="center"><input name="sl[]" type="text" id="sl[]" size="2" value=" <?php echo  $sl; ?>"></td>
                                <td align="center"><input name="roll[]" type="text" id="roll[]" size="2" value=" <?php echo $shterm['borno_school_roll']; ?>">
                                ...
                                <td align="center"><input name="name[]" type="text" id="name[]" size="30" value=" <?php echo $shterm['borno_school_student_name']; ?>">
...
<select name="sub3rd[]" id="sub3rd[]">
				...
				?>
               <option value="<?php echo $sgetstudinfo['borno_subject_nine_ten_13sub']; ?>"<?php if($sgetstudinfo['borno_subject_nine_ten_13sub']==$shqgssub3rd['borno_subject_nine_ten_id']) { echo "selected"; }  ?>> <?php echo $shqgssub3rd['borno_subject_nine_ten_name']; ?> </option>
               <?php }  ?>   
             </select>
   <?php
		} elseif($dept==2){
   ...
   <?php
	 ...
	 ?>
				...
				?>
               <option value="<?php echo $sgetstudinfo['borno_subject_nine_ten_4thsub']; ?>"<?php if($sgetstudinfo['borno_subject_nine_ten_4thsub']==$shqgssub4th['borno_subject_nine_ten_id']) { echo "selected"; }  ?>> <?php echo $shqgssub4th['borno_subject_nine_ten_name']; ?> </option>
      <?php }  ?>   
      </select>
        <?php
		} elseif($dept==2){
      ...
      <td align="center"><a href="manage_3rd_4th_subject.php?stdstudId=<?php echo $shterm['borno_student_info_id']; ?>" onClick="return confirm ('Sure to Delete')">Delete</a></td>
  </tr>
  <?php }  ?>   
