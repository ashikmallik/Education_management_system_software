<?php
 ...
 require_once '../../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	if (!function_exists('clean_html')) {
		...
		$gsess="select * from modeltest_add_term where borno_school_id='$schId' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1'";
	...
	$ttmmrk;
					  ...
					  if($ttmmrk<100) { header('location:term_assign.php?msg=1'); }
									...
									for($i=0; $i<count($perc); $i++){
										...
										if($perc[$i]!=""){
	$insmk="INSERT INTO `modeltest_add_term` (`borno_school_id`,`borno_school_class_id`,`borno_school_session`, `borno_result_term_name`, `borno_result_term_percent`,`term_type`)
