    ...
    <td><select name="stsess" id="stsess" onchange="callpage();">
      ...
      <option value="2020" <?php if($_POST['stsess']==2020) { echo "selected"; } ?>> 2020 </option>
					...
					if($subId!=""){
						...
						$delterm="DELETE from modeltest_result_subject where modeltest_result_subject_id='$subId'";
            ...
            $gtedtgrade="select * from modeltest_result_subject where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' order by modeltest_result_subject_id asc";
			$s=0;
