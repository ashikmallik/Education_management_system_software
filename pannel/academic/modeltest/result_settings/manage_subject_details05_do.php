		...
		$con6= $_POST['con6'];
					  ...
					  if($term1==$term21)
					  {
									...
									for($i=0; $i<count($subid); $i++){
										...
										if($subid[$i]!=""){
											$insmk="UPDATE `modeltest_subject_details` SET `number_type1_marks`='$mark1[$i]',`number_type2_marks`='$mark2[$i]',`number_type3_marks`='$mark3[$i]',`number_type4_marks`='$mark4[$i]',`number_type5_marks`='$mark5[$i]',`number_type6_marks`='$mark6[$i]',`number_type1_pass`='$pass1[$i]',`number_type2_pass`='$pass2[$i]',`number_type3_pass`='$pass3[$i]',`number_type4_pass`='$pass4[$i]',`number_type5_pass`='$pass5[$i]',`number_type6_pass`='$pass6[$i]',`number_type1_conv`='$con1[$i]',`number_type2_conv`='$con2[$i]',`number_type3_conv`='$con3[$i]',`number_type4_conv`='$con4[$i]',`number_type5_conv`='$con5[$i]',`number_type6_conv`='$con6[$i]',`subject_type`='$subtype[$i]',`pare`='$pare[$i]' where  	modeltest_subject_details_id='$subdetailid[$i]'";
