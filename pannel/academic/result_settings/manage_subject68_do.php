 ...
 require_once '../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	$uncountable= $_POST['uncountable'];
									...
									for($i=0; $i<count($subid); $i++){
										...
										if($subid[$i]!=""){
										$insmk="Update `borno_set_subject_six_eight` SET `sub_six_eight_fullmark`='".trim($perc[$i])."',`six_eight_subject_pare`='$pare[$i]',`six_eight_4th_subject`='$sub4th[$i]',`uncountable`='$uncountable[$i]' where `borno_set_subject_six_eight_id`='$subid[$i]'";
