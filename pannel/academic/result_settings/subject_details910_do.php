...
$gsesssub="select * from borno_result_nine_ten_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1' AND borno_result_term_id='$term1' AND borin_subject_nine_ten_id='$subid[$i]'";
	...
	$pare=$shqgpare['borno_subject_nine_ten_pare'];
		...
		SELECT `borno_school_class_id`,`borno_school_subject_name` ,`borno_result_subject_details_nineTen_id`,`borno_school_id`,`borno_school_session`,`borno_nine_ten_subfullmark` FROM `borno_result_nine_ten_subject_details`,`borno_result_term_id` WHERE `borno_school_id` = '$schId' AND `borno_school_class_id` = '$studClass1' AND `borno_school_session` = '$stsess1'";
	...
	$onlineMarks="INSERT INTO `schl_subjs` (`sch_class_id`,`schl_subj_name`,`borno_school_subject_id`, `borno_school_id`,`borno_school_session`, `borno_school_subject_fullmark`,`borno_result_term_id`)
		SELECT `borno_school_class_id`,`borno_school_subject_name` ,`borno_result_subject_details_nineTen_id`,`borno_school_id`,`borno_school_session`,`borno_nine_ten_subfullmark` FROM `borno_result_nine_ten_subject_details`,`borno_result_term_id` WHERE `borno_school_id` = '$schId' AND `borno_school_class_id` = '$studClass1'";
						  }
