  ...
  <tr>
    ...
    <td><select name="studClass" id="studClass" onchange="callpage();">
      ...
      <?php
					...
					$getClassId="select * from borno_school_set_class where borno_school_id='$schId' AND borno_school_branch_id='$gtfbranchId' AND borno_school_class_id!=3 AND borno_school_class_id!=4 AND borno_school_class_id!=5 AND borno_school_class_id!=6 AND borno_school_class_id!=10 AND borno_school_class_id!=13 AND borno_school_class_id!=14 AND borno_school_class_id!=15 AND borno_school_class_id!=16 AND borno_school_class_id!=17 AND borno_school_class_id!=18 AND borno_school_class_id!=19 AND borno_school_class_id!=20 AND borno_school_class_id!=21";
