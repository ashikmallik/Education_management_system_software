  ...
  ?>
   <tr>
    ...
    <td  align="center"><a href="../../../support_file/<?php echo $shgtfeeshead['attached_file']; ?>"><?php echo $shgtfeeshead['attached_file']; ?></a></td>
     <td  align="center"><?php if($shgtfeeshead['status'] == 1){ ?><p class="approved">Solved</p><?php } else if($shgtfeeshead['status'] == 2){ ?><p class="rejected">Rejected</p><?php } else{ ?><p class="pending">Pending</p><?php } ?></td>
  </tr>
