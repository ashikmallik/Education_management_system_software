...
<body>
 ...
 <div class="row">
  		...
  		$gtfeeshead="SELECT * FROM `student_support_ticket` WHERE  `status` IN (0,2) ORDER BY `id` DESC";
		$sl=0;
  ...
  ?>
   <tr>
    ...
    <td  align="center"><a href="../../../support_file/<?php echo $shgtfeeshead['attached_file']; ?>"><?php echo $shgtfeeshead['attached_file']; ?></a></td>
     <td  align="center"><?php if($shgtfeeshead['status'] == 2){ ?><p class="rejected">Rejected</p><?php }else{ ?><p class="pending">Pending</p><?php } ?></td>
  </tr>
