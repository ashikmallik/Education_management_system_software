 ...
 <div class="row">
                            ...
                            <div class="fessPayment">
                                ...
                                <form name="frmcontent" action="download_attandance_report.php" method="post" enctype="multipart/form-data" id="myform">
                                  ...
                                  <div class="form-group row">
										...
										$getsession="SELECT `borno_school_session` FROM `borno_student_info` GROUP BY `borno_school_session`";
		                                $qgetsession=$mysqli->query($getsession);
		                                while($sqgetsession=$qgetsession->fetch_assoc()){
										
										 
                                    ?>
                                <option value=" <?php echo $sqgetsession['borno_school_session']; ?>" <?php if($sqgetsession['borno_school_session']==$_REQUEST['stsess']) { echo "selected"; }  ?>> <?php echo $sqgetsession['borno_school_session']; ?></option>
                                <?php } ?>
		...
		while($shgetClassId=$qgetClassId->fetch_assoc()){
                                ...
                                <?php } ?>
                                  ...
                                  <div class="form-group row">
                                              <label  class="col-sm-6 col-form-label">Shift</label>
                                              <div class="col-sm-6">
      ...
      <option value="">--Select Month--</option>
          ...
          <button ><input type="submit" name="button" id="button"  value="Print" formtarget="_blank"  onClick="return contalt_valid()"></button>
