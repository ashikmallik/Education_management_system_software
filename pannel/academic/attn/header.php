                <div class="header" style ="background: #f1f6f7;">
                    <div class="logo logo-dark">
                        <a href="">
                            <img src="../assets/images/logo.jpg" alt="Logo"  style="margin-top: 3%;width: 40%;">
                            <img class="logo-fold" src="../assets/images/logo.jpg" alt="Logo">
                        </a>
                    </div>
