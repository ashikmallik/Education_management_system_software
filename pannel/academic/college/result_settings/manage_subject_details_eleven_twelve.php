...
function callpage()
{
 document.frmcontent.action="manage_subject_details_eleven_twelve.php";
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2>Manage Subject Details Eleven to Twelve</h2></div>
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="manage_subject_details_eleven_twelve_do.php" method="post" enctype="multipart/form-data">
                        <?php
	$msg=$_GET['msg'];
...
<option value=" <?php echo $shqgstterm['borno_result_term_id']; ?>" <?php if($shqgstterm['borno_result_term_id']==$_REQUEST['term']) { echo "selected"; }  ?>> <?php echo $shqgstterm['borno_result_term_name']; ?></option>
      <?php } ?>
				...
				?>
					...
					$dept=$_REQUEST['dept'];
					$term=$_REQUEST['term'];
	$gsubject="select * from borno_result_eleven_twelve_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_stud_group='$dept' AND borno_school_session='$stsess' AND borno_result_term_id='$term' order by borno_subject_eleven_twelve_id";
					$qgsubject=$mysqli->query($gsubject);
					while($shqgsubject=$qgsubject->fetch_assoc()){$s++;
					
					$subjectname=$shqgsubject['borno_subject_eleven_twelve_id'];

					$gsubject1="select * from borno_subject_eleven_twelve where  borno_subject_eleven_twelve_id='$subjectname'";
					$qgsubject1=$mysqli->query($gsubject1);
					$shqgsubject1=$qgsubject1->fetch_assoc();
				?>
                              <tr>
          <td align="center"><input name="subname[]" type="text" id="subname[]" value="<?php echo $shqgsubject1['borno_subject_eleven_twelve_name']; ?>" size="15" readonly="readonly">
          <input type="hidden" name="subid[]" id="subid[]" value="<?php echo $shqgsubject['borno_subject_eleven_twelve_id']; ?>" />
          <input type="hidden" name="subdetailid[]" id="subdetailid[]" value="<?php echo $shqgsubject['borno_result_subject_details_eleven_twelve_id']; ?>" /></td>
         <td align="center"><input name="Full[]" type="text" id="Full[]" size="2" value="<?php echo $shqgsubject['borno_eleven_twelve_subfullmark']; ?>"></td>         
         <td align="center"><input name="mark1[]" type="text" id="mark1[]" size="2" value="<?php echo $shqgsubject['number_type1_marks']; ?>"></td>
         <td align="center"><input name="pass1[]" type="text" id="pass1[]" size="2" value="<?php echo $shqgsubject['number_type1_pass']; ?>"></td>
         <td align="center"><input name="con1[]" type="text" id="con1[]" size="2" value="<?php echo $shqgsubject['number_type1_conv']; ?>"></td>
         <td align="center"><input name="mark2[]" type="text" id="mark2[]" size="2" value="<?php echo $shqgsubject['number_type2_marks']; ?>"></td>
         <td align="center"><input name="pass2[]" type="text" id="pass2[]" size="2" value="<?php echo $shqgsubject['number_type2_pass']; ?>"></td>
         <td align="center"><input name="con2[]" type="text" id="con2[]" size="2" value="<?php echo $shqgsubject['number_type2_conv']; ?>"></td>         			         
         <td align="center"><input name="mark3[]" type="text" id="mark3[]" size="2" value="<?php echo $shqgsubject['number_type3_marks']; ?>"></td>
         <td align="center"><input name="pass3[]" type="text" id="pass3[]" size="2" value="<?php echo $shqgsubject['number_type3_pass']; ?>"></td>
         <td align="center"><input name="con3[]" type="text" id="con3[]" size="2" value="<?php echo $shqgsubject['number_type3_conv']; ?>"></td> 
         <td align="center"><input name="mark4[]" type="text" id="mark4[]" size="2" value="<?php echo $shqgsubject['number_type4_marks']; ?>"></td>
         <td align="center"><input name="pass4[]" type="text" id="pass4[]" size="2" value="<?php echo $shqgsubject['number_type4_pass']; ?>"></td>
         <td align="center"><input name="con4[]" type="text" id="con4[]" size="2" value="<?php echo $shqgsubject['number_type4_conv']; ?>"></td>		 					         		         <td align="center"><input name="mark5[]" type="text" id="mark5[]" size="2" value="<?php echo $shqgsubject['number_type5_marks']; ?>"></td>
         <td align="center"><input name="pass5[]" type="text" id="pass5[]" size="2" value="<?php echo $shqgsubject['number_type5_pass']; ?>"></td>
         <td align="center"><input name="con5[]" type="text" id="con5[]" size="2" value="<?php echo $shqgsubject['number_type5_conv']; ?>"></td> 
         <td align="center"><input name="mark6[]" type="text" id="mark6[]" size="2" value="<?php echo $shqgsubject['number_type6_marks']; ?>"></td>
         <td align="center"><input name="pass6[]" type="text" id="pass6[]" size="2" value="<?php echo $shqgsubject['number_type6_pass']; ?>"></td>
         <td align="center"><input name="con6[]" type="text" id="con6[]" size="2" value="<?php echo $shqgsubject['number_type6_conv']; ?>"></td>
                                   </tr>
                               <?php } ?>
                               <tr>
