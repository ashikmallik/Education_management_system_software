...
?>
    <td>&nbsp;</td>
    <td><a href="download_admit_card.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&dept=<?php echo $dept; ?>&sctermId=<?php echo $selTerm; ?>&styear=<?php echo $styear; ?>" target="_blank">Show Admit</a></td>
 </tr>       
                        </table>
