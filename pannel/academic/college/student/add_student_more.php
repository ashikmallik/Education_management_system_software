...
<div class="wrapper">
  ...
  <ul>
                ...
                <li><a href="add_student_more.php" class="active"><i class="fa fa-user" aria-hidden="true"></i>Add Student(more)</a></li>
...
<script language="javascript">
	...
	function callpage()
	{
	 document.frmcontent.action="add_student_more.php";
  ...
  <tr>
   <td class="text_table">Session *</td>
    <td><select name="stsess" id="stsess" onchange="callpage();">
      ...
      <option value="2019-20" <?php if($_REQUEST['stsess']=='2019-20') { echo "selected"; } ?>> 2019-20 </option>
      <option value="2020-21" <?php if($_REQUEST['stsess']=='2020-21') { echo "selected"; } ?>> 2020-21 </option>
  ...
  <td class="text_table">Status *</td>
    <td><select name="status" id="status">
     ...
     <td><select name="orgType" id="orgType" onchange="callpage();">
     <option value="">--Select one--</option>
      <option value="School" <?php if($_REQUEST['orgType']=='School') { echo "selected"; } ?>>School</option>
      <option value="College" <?php if($_REQUEST['orgType']=='College') { echo "selected"; } ?>>College</option>
      </select></td>
...
<td colspan="4"><center><input type="submit" name="" value="Process" onClick="return contalt_valid()"></center></td>
    ...
    <form name="frmcontent1" id="myform" action="add_student_more_do.php"method="post" enctype="multipart/form-data">                     
