...
$gtresSubd="select * from borno_result_eleven_twelve_subject_details where borno_school_id='$schoolId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$gttermId' AND borno_subject_eleven_twelve_id='$stusubjId'";
...
<table width="650" border="0" cellspacing="0" cellpadding="0" class="projectlist" align="center">
  ...
  <tr>
    ...
    <td><select name="stsess" id="stsess">
      ...
      <option value="2018-19" <?php if($stsess=="2018-19") { echo "selected"; } ?>> 2018-19 </option>
      <option value="2019-20" <?php if($stsess=="2019-20") { echo "selected"; } ?>> 2019-20 </option>
      <option value="2020-21" <?php if($stsess=="2020-21") { echo "selected"; } ?>> 2020-21 </option>
    </select></td>
  </tr>
  <tr>
    ...
    <td><select name="selTerm" id="selTerm">
      <option value=""> Select </option>
      <?php
			$schexterm="select * from borno_result_add_term where borno_school_id='$schoolId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess'";
  ...
  <tr>
    ...
    <td align="center"><strong>:</strong></td>
    <td><select name="styear" id="styear">
    <option value="2018" <?php if($styear==2018) { echo "selected"; } ?>> 2018 </option>
      <option value="2019" <?php if($styear==2019) { echo "selected"; } ?>> 2019 </option>
      <option value="2020" <?php if($styear==2020) { echo "selected"; } ?>> 2020 </option>
      <option value="2021" <?php if($styear==2021) { echo "selected"; } ?>> 2021 </option>
    </select></td>
  </tr>
    ...
    <td><select name="stusubjId" id="stusubjId" onchange="callpage();">
      ...
      <?php
			...
			$gsubjName="select * from borno_subject_eleven_twelve";
			$qgsubjName=$mysqli->query($gsubjName);
			while($shgsubjName=$qgsubjName->fetch_assoc()){
		?>
      <option value="<?php echo $shgsubjName['borno_subject_eleven_twelve_id']; ?>" <?php if($shgsubjName['borno_subject_eleven_twelve_id']==$stusubjId) { echo "selected"; } ?>> <?php echo $shgsubjName['borno_subject_eleven_twelve_name']; ?></option>
<?php }?>   </select></td>
  </tr>
</table>
