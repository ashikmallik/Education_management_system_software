...
$getsubjstatus="select * from borno_result_eleven_twelve_subject_details where borno_school_id='$schId' AND borno_school_class_id=$studClass AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$dept' AND  borno_subject_eleven_twelve_id='$stusubjId'";
...
$grade="select * from borno_grading_chart where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess'";
	...
	if($greadsystem=="")
	{
	header('location:edit_marks.php?msg=3');
	}
...
if($ntype1[$i]==""){$ntype1[$i]=0;}
else{$ntype1[$i]=$ntype1[$i];}

if($ntype2[$i]==""){$ntype2[$i]=0;}
else{$ntype2[$i]==$ntype2[$i];}

if($ntype3[$i]==""){$ntype3[$i]=0;}
else{$ntype3[$i]=$ntype3[$i];}

if($ntype4[$i]==""){$ntype4[$i]=0;}
else{$ntype4[$i]=$ntype4[$i];}

if($ntype5[$i]==""){$ntype5[$i]=0;}
else{$ntype5[$i]=$ntype5[$i];}

if($ntype6[$i]==""){$ntype6[$i]=0;}
else{$ntype6[$i]=$ntype6[$i];}

	$total=$ntype1[$i]*$con1/100+$ntype2[$i]*$con2/100+$ntype3[$i]*$con3/100+$ntype4[$i]*$con4/100+$ntype5[$i]*$con5/100+$ntype6[$i]*$con6/100;
	
 $insfmark1="UPDATE `borno_class11_12_temp_mark1` SET `temp_res_number_type1`=$ntype1[$i],
			...
			`stu4thsub`='$stu4th',
			`total_marks`='$total' where borno_class11_12_temp_mark1_id=$tempid[$i]";
...
//=========================================== /////////////////// Result Calculation=======///////////////////////////////////////////
$delbtbornores="DELETE from borno_class11_12_final_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_subject_eleven_twelve_id='$stusubjId' AND borno_school_stud_group='$dept' AND borno_result_term_id='$selTerm' AND borno_result_exam_year='$styear'";
$mysqli->query($delbtbornores);


$delbtbornores12="DELETE from borno_class11_12_test_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND pare='$subpare' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$dept' AND borno_result_exam_year='$styear'";
$mysqli->query($delbtbornores12);

$delgpa="DELETE from borno_school_11_12_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$dept' AND borno_result_exam_year='$styear'";
$mysqli->query($delgpa);

//----------- Get Subject Details Mark -------------------------------------------------------------------------------------------------

 $gtsdmrk="select * from borno_result_eleven_twelve_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$dept' AND borno_subject_eleven_twelve_id='$stusubjId'";
...
if($pare!=0)
{	
$gtsdmrk1="select * from borno_result_eleven_twelve_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$dept' AND borno_subject_eleven_twelve_id='$stusubjId' AND pare='$pare'";
		 ...
		 $gtsdmrk2="select * from borno_result_eleven_twelve_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$dept' AND borno_subject_eleven_twelve_id!='$stusubjId' AND pare='$pare'";
	...
	$gtsubjfmark=$gtsubjfmark1+$gtsubjfmark2;
			 ...
			 $gtsdmrk3="select * from borno_result_eleven_twelve_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$dept' AND pare='$pare' order by borno_subject_eleven_twelve_id desc limit 0,1";
...
//------------------- End Grading ----------------------------------------------
 ...
 $delpare1="delete from borno_class11_12_test_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND pare='$subpare' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$dept' AND borno_result_exam_year='$styear' AND borno_subject_eleven_twelve_id='$subjectidpare' AND borno_student_info_id='$studinfoId'";
    $mysqli->query($delpare1);	



			//------ Subject 1-----------------------
				$gtctmarg1="select * from borno_class11_12_temp_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_subject_eleven_twelve_id='$stusubjId' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$dept' AND borno_result_exam_year='$styear' AND borno_student_info_id='$studinfoId' AND subject_pare='$subpare'";
	...
	$shgtctmarg1=$qgtctmarg1->fetch_assoc();
	   ...
	   $gttotalmrk1=($numbty11+$numbty12+$numbty13+$numbty14+$numbty15+$numbty16);
		...
		$gtconvtotal1 =round($gtconvtotal1);
		$markinpers1=round(($gtconvtotal1*100)/$gtsubjfmark1);
...
//------ Subject 2-----------------------
	...
	$shgtctmarg2=$qgtctmarg2->fetch_assoc();
		...
		$gtconvtota21 =round($gtconvtota21);
		}
...
//------ get number type from query top -----------------------	
	...
	elseif($shgtctmarg1['temp_res_number_type1']!="" AND $shgtctmarg2['temp_res_number_type1']=="")
	{
       ...
       $gtconvtotal =round($gtconvtotal);
		
		$markinpers=round(($gtconvtotal*100)/$gtsubjfmark);
		
	echo $studRoll." ";	echo $gtsubjfmark." "; echo $gtconvtotal." "; echo $markinpers."<br>";
	}
	elseif($shgtctmarg1['temp_res_number_type1']=="" AND $shgtctmarg2['temp_res_number_type1']!="")
	{
		$numbty1=0+$numbty21;
	...
	// $gtsubjfmark;	
		...
		{
		$delpare1="delete from borno_class11_12_test_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND pare='$subpare' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$dept' AND borno_result_exam_year='$styear' AND borno_subject_eleven_twelve_id='$stusubjId' AND borno_student_info_id='$studinfoId'";
    $mysqli->query($delpare1);		
...
//----------------------------- Latter Grade ------------------------------------------------------------------
	...
	echo $studRoll." ";	echo $gtsubjfmark." "; echo $gtconvtotal." ";echo $finallg." "; echo $markinpers."<br>";
// ------------------------ Eng lg --------------------------------------------------------------		
if($subpare!=0)
{
...
$quygeneralsubmark=$mysqli->query($insfmark);
 ...
 $insfmark1="INSERT INTO `borno_class11_12_final_result` (`borno_school_id`, `borno_school_branch_id`, `borno_school_class_id`, `borno_school_shift_id`, `borno_school_section_id`, `borno_school_session`, `borno_subject_eleven_twelve_id`, `borno_result_term_id`, `borno_result_exam_year`,`borno_student_info_id`, `borno_school_roll`, `borno_school_student_name`, `temp_res_number_type1`, `temp_res_number_type1_conv`, `res_number_type2`, `res_number_type2_conv`, `res_number_type3`, `res_number_type3_conv`, `res_number_type4`, `res_number_type4_conv`, `res_number_type5`, `res_number_type5_conv`, `res_number_type6`, `res_number_type6_conv`, `res_total_mark`, `res_total_conv`,`mark_in_present`, `res_gpa`, `res_lg`,`pare`,`six_eight_4th_subject`,`uncountable`,`borno_school_stud_group`,`stu4thsub`)
		 ...
		 VALUES ('$schId', '$branchId', '$studClass', '$shiftId', '$section', '$stsess', '$stusubjId', '$selTerm','$styear', '$studinfoId', '$studRoll', '$studName', '$numbty1', '$convnumbty1', '$numbty2', '$convnumbty2', '$numbty3', '$convnumbty3', '$numbty4', '$convnumbty4', '$numbty5', '$convnumbty5', '$numbty6', '$convnumbty6', '$gttotalmrk', '$gtconvtotal','$markinpers', '$finalGpa', '$finallg','$subpare','0','0','$dept','$sub4th')";
...
if($quygeneralsubmark) { header("location:edit_marks.php?msg=1&branchId=$schsId&studClass=$studClass&shiftId=$shiftId&section=$section&stsess=$stsess&selTerm=$selTerm");} else {  header('location:edit_marks.php?msg=2'); }
	}
