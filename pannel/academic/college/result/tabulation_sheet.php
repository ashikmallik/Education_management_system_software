...
<table width="650" border="0" cellspacing="0" cellpadding="0" class="projectlist" align="center">
  <tr>
    ...
    <select name="stsess" id="stsess" onchange="callpage();">
      ...
      <option value="2023-24" <?php if($_POST['stsess']=='2023-24') { echo "selected"; } ?>> 2023-24 </option>
    </select></td>
  </tr>
  <tr>
...
<option value="2024" <?php if($_POST['styear']==2024) { echo "selected"; } ?> > 2024 </option>
...
?>
   ...
   <tr>
    ...
    <td><a href="download_tabulation_sheet.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear1=<?php echo $styear; ?>" target="_blank">Tabulation Sheet</a></td>
    <td>&nbsp;</td>
    <td><a href="download_tabulation_sheet1.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear1=<?php echo $styear; ?>" target="_blank">Tabulation Sheet-1</a></td>
 </tr>
 <tr>

  
    <td><a href="download_tabulation_sheet_blank.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear1=<?php echo $styear; ?>" target="_blank">Tabulation Sheet Blank</a></td>
    <td>&nbsp;</td>
    <td><a href="download_tabulation_sheet2.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear1=<?php echo $styear; ?>" target="_blank">Tabulation Sheet-2</a></td>
 </tr>
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_tabulation_sheet3.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear1=<?php echo $styear; ?>" target="_blank">Tabulation Sheet-3</a></td>
 </tr>
   <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_tabulation_sheet4.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear1=<?php echo $styear; ?>" target="_blank">Tabulation Sheet-4</a></td>
 </tr>
    <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_year_final_tabulation_sheet1.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear1=<?php echo $styear; ?>" target="_blank">Combiend Tabulation Sheet-1</a></td>
 </tr>
    <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_year_final_tabulation_sheet2.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear1=<?php echo $styear; ?>" target="_blank">Combiend Tabulation Sheet-2</a></td>
 </tr>
    <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_year_final_tabulation_sheet3.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear1=<?php echo $styear; ?>" target="_blank">Combiend Tabulation Sheet-3</a></td>
 </tr>
</table>
