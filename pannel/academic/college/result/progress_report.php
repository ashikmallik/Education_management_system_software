  ...
  <tr>
    ...
    <td><select name="roll1" id="roll1" onchange="callpage();">
        ...
        <?php
			...
			$group=$_POST['dept'];
            $styear=$_POST['styear'];
			$schexroll="select * from borno_class11_12_final_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_school_stud_group='$group' AND borno_result_exam_year='$styear' group by borno_school_roll asc";
...
$rollf=$_POST['roll1'];
$rollt=$_POST['roll2'];	
 $gtgpa ="select * from borno_school_11_12_merit where borno_school_class_id='$studClass' AND borno_school_branch_id='$gtfbranchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_school_stud_group='$group' AND borno_result_exam_year='$styear'";
...
?>
   <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_progress_report05.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear=<?php echo $styear; ?>&rollf=<?php echo $rollf; ?>&rollt=<?php echo $rollt; ?>" target="_blank">Progress Report</a></td>
 </tr>
 <?php ?>  
