...
?>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_meritlist05_pdf.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $branchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear=<?php echo $styear; ?>" target="_blank">Merit List Section</a></td>
 </tr>
  <tr>
 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_meritlistshift05_pdf.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $branchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear=<?php echo $styear; ?>" target="_blank">Merit List Shift</a></td>
 </tr> 
  <tr>
 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_meritlistclass05_pdf.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $branchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&styear=<?php echo $styear; ?>" target="_blank">Merit List Class</a></td>
 </tr> 
</table>
