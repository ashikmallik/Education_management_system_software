    ...
    <td><select name="stusubjId" id="stusubjId" onchange="callpage();">
      ...
      <?php
			...
			$group=$_POST['group'];
				...
				$gsubjName12="select * from borno_result_eleven_twelve_subject_details where  borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$clSess' AND  	borno_school_stud_group='$group' AND borno_result_term_id='$selTerm' order by borno_subject_eleven_twelve_id asc";
			$qgsubjName12=$mysqli->query($gsubjName12);
			while($shgsubjName12=$qgsubjName12->fetch_assoc()){
	        $getsubid=$shgsubjName12['borno_subject_eleven_twelve_id']; 
	        
			$gsubjName="select * from borno_subject_eleven_twelve where borno_subject_eleven_twelve_id=$getsubid";
...
<table width="650" border="0" cellspacing="0" cellpadding="0" align="center" class="projectlist">
  ...
  $assnty1="select * from borno_result_eleven_twelve_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$clSess' AND borno_school_stud_group='$group' AND borno_result_term_id='$selTerm' AND borno_subject_eleven_twelve_id='$stusubjId'";
