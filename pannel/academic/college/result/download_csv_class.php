...
// ================== Subject Name=================================
	if($group==1)
	{	
	$subjectSql = "SELECT * FROM `borno_subject_eleven_twelve` where 	borno_subject_eleven_twelve_dept=0 OR borno_subject_eleven_twelve_dept=0 ORDER BY `borno_subject_eleven_twelve_id` ASC";
	$subjectQuery = $mysqli->query($subjectSql);
	while($subject = $subjectQuery->fetch_assoc()) {
		if(!empty($subject['borno_subject_eleven_twelve_name'])){
			$subjectName = $subject['borno_subject_eleven_twelve_name'];
			$stusubjId = $subject['borno_subject_eleven_twelve_id'];
	...
	$gtnumberty6=$shassnty['borno_school_number_type6'];
         ...
         //=== Subject Details ===
	$bornosubjdet="SELECT * FROM  borno_result_eleven_twelve_subject_details where borno_school_id='$schoolId' AND borno_school_class_id='$studClass' AND   borno_school_session='$stsess' AND   borno_result_term_id='$selTerm' AND borno_subject_eleven_twelve_id='$stusubjId'";
