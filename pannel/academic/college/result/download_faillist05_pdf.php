...
//     $this->Cell(0,5,'Page '.$this->PageNo().'/{nb}',0,0,'R');
	...
	//$finalgtschoolsignature1 = "mmsc_principal.jpg";
	$finalgtschoolsignature2 = "mmsc_col_inc.jpg";
  
  //  $this->Image($finalgtschoolsignature1,158,275,35,7);
    $this->Image($finalgtschoolsignature2,90,275,30,7);
...
if($group==1)   
{
    $pdf->Cell(200,5,'Fail List in Science',0,5,"C");
$pdf->Cell(200,5,"Group : Science",0,5,"C");
}
elseif($group==2)   
{
    $pdf->Cell(200,5,'Fail List in Business Studies',0,5,"C");
$pdf->Cell(200,5,"Group : Business Studies",0,5,"C");
} 
elseif($group==3)   
{
    $pdf->Cell(200,5,'Fail List in Humanities',0,5,"C");
$pdf->Cell(200,5,"Group : Humanities",0,5,"C");
}  

$pdf->SetFont('Arial','',12); 
$pdf->Cell(200,5,"Branch : $fnsbranch Class : $fnsclass  Section : $fnssection Session : $stsess Term : $fnsterm",0,5,"L"); 
...
$data1="select * from borno_school_11_12_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND borno_result_exam_year='$styear' AND failno!=0";
