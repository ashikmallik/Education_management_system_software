...
//     if($GLOBALS['s1l']==6)
// 	{
// 	$this->Cell(46,5,$GLOBALS['subname6'],1,0,'L');
// 	}
// 	if($GLOBALS['s1l']==7)
// 	{
// 	$this->Cell(46,5,$GLOBALS['subname6'],1,0,'L');
// 	$this->Cell(46,5,$GLOBALS['subname7'],1,0,'L');
// 	}
// 	if($GLOBALS['s1l']==8)
// 	{
// 	$this->Cell(46,5,$GLOBALS['subname6'],1,0,'L');
// 	$this->Cell(46,5,$GLOBALS['subname7'],1,0,'L');
// 	$this->Cell(46,5,$GLOBALS['subname8'],1,0,'L');
// 	}	
// 	if($GLOBALS['s1l']==9)
// 	{
// 	$this->Cell(46,5,$GLOBALS['subname6'],1,0,'L');
// 	$this->Cell(46,5,$GLOBALS['subname7'],1,0,'L');
// 	$this->Cell(46,5,$GLOBALS['subname8'],1,0,'L');
// 	$this->Cell(46,5,$GLOBALS['subname9'],1,0,'L');
// 	}	
// 	if($GLOBALS['s1l']==10)
// 	{
	    //$this->Cell(46,5,"test",1,0,'L');
	$this->Cell(46,5,$GLOBALS['subname6'],1,0,'L');
	$this->Cell(46,5,$GLOBALS['subname7'],1,0,'L');
	$this->Cell(46,5,$GLOBALS['subname8'],1,0,'L');
	$this->Cell(46,5,$GLOBALS['subname9'],1,0,'L');
	$this->Cell(46,5,$GLOBALS['subname10'],1,0,'L');
	$this->Cell(46,5,$GLOBALS['subname11'],1,0,'L');
...
if($sid8=="" OR $sid9=="" OR $sid10=="" OR $sid11=="")
{
