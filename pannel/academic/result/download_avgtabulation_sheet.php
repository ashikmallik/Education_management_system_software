...
$fnsterm=substr($sqgtterm['borno_result_term_name'],0,7);
	...
	if($subid1=="" AND $subid2=="" AND $subid3=="" AND $subid4=="" AND $subid5==""){$subidend=$subid1;}	
	elseif($subid2=="" AND $subid3=="" AND $subid4=="" AND $subid5=="" ){$subidend=$subid1;}	
...
$pdf->Ln();
		...
		if($subid1=="" AND $subid2=="" AND $subid3=="" AND $subid4=="" AND $subid5==""){$subidend=$subid1;}	
	elseif($subid2=="" AND $subid3=="" AND $subid4=="" AND $subid5==""){$subidend=$subid1;}	
	elseif($subid3=="" AND $subid4=="" AND $subid5==""){$subidend=$subid2;}	
	elseif($subid4=="" AND $subid5==""){$subidend=$subid3;}	
	elseif($subid5==""){$subidend=$subid4;}	
	else{$subidend=$subid5;}				
