...
$gtctmarg1="select * from borno_class9_10_average_mark2 where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_school_stud_group='$group1' group by borno_student_info_id asc";  
 ...
 $gttotalmrk=($numbty1*$con1/100+$numbty2*$con2/100+$numbty3*$con3/100+$numbty4*$con4/100+$numbty5*$con5/100+$numbty6*$con6/100);
	...
	{	
	  	...
	  	$numbty1 = number_format($numbty1);
		$numbty2 = number_format($numbty2);
		$numbty3 = number_format($numbty3);
		$numbty4 = number_format($numbty4);
		$numbty5 = number_format($numbty5);
		$numbty6 = number_format($numbty6);
		
  if($getstusubjId==1 OR $getstusubjId==2 OR $getstusubjId==5 OR $getstusubjId==6 OR $getstusubjId==10 OR $getstusubjId==18 OR $getstusubjId==19 OR $getstusubjId==20 OR $getstusubjId==21 OR $getstusubjId==26 OR $getstusubjId==27 OR $getstusubjId==28 OR $getstusubjId==31)	
{
$ntypes1=$numbty1+$numbty2;
$ntypes1=$ntypes1*70/90;
$totaltmark=$ntypes1+$numbty3*$con3/100+$numbty4*$con4/100+$numbty5*$con5/100+$numbty6*$con6/100;
    
}

elseif($getstusubjId==11 OR $getstusubjId==12 OR $getstusubjId==14 OR $getstusubjId==15 OR $getstusubjId==16 OR $getstusubjId==17)
{
$ntypes1=$numbty1+$numbty2;
$ntypes1=$ntypes1*50/70;    
$totaltmark=$ntypes1+$numbty3*$con3/100+$numbty4*$con4/100+$numbty5*$con5/100+$numbty6*$con6/100;
    
}

elseif($getstusubjId==3 OR $getstusubjId==4)
{
$ntypes1=$numbty1+$numbty2;
$ntypes1=$ntypes1*100/120;      
$totaltmark=$ntypes1+$numbty3*$con3/100+$numbty4*$con4/100+$numbty5*$con5/100+$numbty6*$con6/100;
}
else{
$ntypes1=$numbty1+$numbty3;
$ntypes1=$ntypes1*25/45;
$totaltmark=$ntypes1+$numbty4*$con4/100+$numbty5*$con5/100+$numbty6*$con6/100;
}	
$totalmark=number_format($totaltmark);
  ...
  $insfmark1="INSERT INTO `borno_class9_10_average_mark1` (`borno_school_id`, `borno_school_branch_id`, `borno_school_class_id`, `borno_school_shift_id`, `borno_school_section_id`, `borno_school_session`, `borno_subject_nine_ten_id`, `borno_result_term_id`, `borno_student_info_id`, `borno_school_roll`, `borno_school_student_name`, `temp_res_number_type1`, `temp_res_number_type2`, `temp_res_number_type3`, `temp_res_number_type4`, `temp_res_number_type5`, `temp_res_number_type6`, `res_total_mark`, `subject_pare`, `borno_school_stud_group`, `stu4thsub`, `uncountable`)
		 ...
		 VALUES ('$schId', '$branchId1', '$studClass1', '$shiftId1', '$section1', '$stsess1', '$getstusubjId', '0', '$studinfoId', '$studRoll', '$studName', '$numbty1', '$numbty2', '$numbty3', '$numbty4', '$numbty5', '$numbty6', '$totalmark', '$pare', '$group1', '$stu4thsub', '$uncountable')";
...
$gtsdmrkpare="select * from borno_subject_six_eight where subject_id_six_eight='$getstusubjId'";
 ...
 $gtctmarg1="select * from borno_class6_8_average_mark where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' group by borno_student_info_id asc";  
...
if($getstusubjId==1 OR $getstusubjId==5 OR $getstusubjId==6 OR $getstusubjId==7 OR $getstusubjId==8)	
{
$ntypes1=$numbty1+$numbty2;
$ntypes1=$ntypes1*70/90;
$totaltmark=$ntypes1+$numbty3*$con3/100+$numbty4*$con4/100+$numbty5*$con5/100+$numbty6*$con6/100;
...
elseif($getstusubjId==3)
{
$ntypes1=$numbty1+$numbty2;
$ntypes1=$ntypes1*100/120;     
$totaltmark=$ntypes1+$numbty3*$con3/100+$numbty4*$con4/100+$numbty5*$con5/100+$numbty6*$con6/100;
}
elseif($getstusubjId==2)
{
$ntypes1=$numbty1+$numbty2;
$ntypes1=$ntypes1*30/50;     
$totaltmark=$ntypes1+$numbty3*$con3/100+$numbty4*$con4/100+$numbty5*$con5/100+$numbty6*$con6/100;
}
else{
$ntypes1=$numbty1+$numbty3;
...
$gttotalmrk=number_format($totaltmark);	    
...
$gtctmarg1="select * from borno_class1_average_mark where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' group by borno_student_info_id asc";  
...
$delpare1="delete from borno_class9_10_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1'  AND borno_school_stud_group='$group1' AND pare='1' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId'";
    $mysqli->query($delpare1);	
			...
			//------ Bangla-----------------------
				$gtctmarg1="select * from borno_class9_10_average_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1'  AND borno_school_stud_group='$group1' AND borno_subject_nine_ten_id='1' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId' AND subject_pare=1";
...
//------ Bangla-2-----------------------
				...
				$gtctmarg2="select * from borno_class9_10_average_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1'  AND borno_school_stud_group='$group1' AND borno_subject_nine_ten_id='2' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId' AND subject_pare=1";
...
$delpare1="delete from borno_class9_10_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1'  AND borno_school_stud_group='$group1' AND pare='2' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId'";
    $mysqli->query($delpare1);	
			...
			//------ Bangla-----------------------
				$gtctmarg1="select * from borno_class9_10_average_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1'  AND borno_school_stud_group='$group1' AND borno_subject_nine_ten_id='3' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId' AND subject_pare=2";
...
//------ Bangla-2-----------------------
				...
				$gtctmarg2="select * from borno_class9_10_average_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1'  AND borno_school_stud_group='$group1' AND borno_subject_nine_ten_id='4' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId' AND subject_pare=2";
...
$delpare1="delete from borno_class6_8_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND pare='2' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId'";
    $mysqli->query($delpare1);	
			...
			//------ Bangla-----------------------
				$gtctmarg1="select * from borno_class6_8_avg_temp_mark where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND subject_id_six_eight='3' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId' AND pare=2";
...
//------ Bangla-2-----------------------
				...
				$gtctmarg2="select * from borno_class6_8_avg_temp_mark where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND subject_id_six_eight='4' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId' AND pare=2";
...
if($quygeneralsubmark) { header("location:process_result_mainartek.php?msg=1&branchId=$branchId&studClass=$studClass&shiftId=$shiftId&section=$section&stsess=$stsess");} else { header('location:process_result_mainartek.php?msg=2');}
