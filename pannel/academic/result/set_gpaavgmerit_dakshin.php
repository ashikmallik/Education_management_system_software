...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	function callpage()
	{
	 document.frmcontent.action="set_gpaavgmerit_dakshin.php";
...
<form name="frmcontent" id="myform" action="set_gpaavgmerit_dakshin_do.php" method="post" enctype="multipart/form-data">
