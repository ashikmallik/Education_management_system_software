<?php require_once('result_top.php'); ?>
    ...
    <li><a href="assessment.php"><i class="fa fa-unlock-alt" aria-hidden="true"></i>Summative Assessment</a></li>
   ...
   <li><a href="marks_entry_mainartek.php"><i class="fa fa-cog" aria-hidden="true"></i> Marks Entry </a></li>
   <li><a href="edit_marks_mainartek.php"><i class="fa fa-cog" aria-hidden="true"></i> Edit Marks </a></li>
       <?php  } else { ?>   
  ...
  if($schId==69 or $schId==91 OR $schId==101){ ?>
     ...
     <li><a href="set_merit_ngghs.php"><i class="fa fa-cog" aria-hidden="true"></i> Set Merit Section</a></li>
   
   
   <li><a href="set_merit_shift_ngghs.php"><i class="fa fa-cog" aria-hidden="true"></i> Set Merit Shift</a></li>
   <li><a href="set_merit_class_ngghs.php"><i class="fa fa-cog" aria-hidden="true"></i> Set Merit Class</a></li> 
      <li><a href="set_fail_ngghs.php"><i class="fa fa-cog" aria-hidden="true"></i> Set Fail</a></li>
   ...
   <li><a href="set_merit_zinjira.php"><i class="fa fa-cog" aria-hidden="true"></i> Set Merit Section</a></li>
   <?php } else {?>
