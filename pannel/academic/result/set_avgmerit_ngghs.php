...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="set_avgmerit_ngghs.php";
...
<form name="frmcontent" id="myform" action="set_avgmerit_ngghs_do.php" method="post" enctype="multipart/form-data">
