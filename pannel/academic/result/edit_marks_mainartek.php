...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	function callpage()
	{
	 document.frmcontent.action="edit_marks_mainartek.php";
...
<form name="frmcontent" id="myform" action="save_marks_class_mainartek.php" method="post" enctype="multipart/form-data">
