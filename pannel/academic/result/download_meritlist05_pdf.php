...
//	$this->Cell(100,5,"Branch : ",0,0,'R');
	...
	$this->Cell(190,5,"Merit List in Section",0,0,'C');
	$this->Ln();
	...
	$this->Cell(190,5,"Group : Science",0,0,'C');
	$this->Ln(); 
	} 
	if($GLOBALS['group']==2)
	{
	$this->SetFont('Arial','',12);    
	$this->Cell(190,5,"Group : Business Studies",0,0,'C');
	$this->Ln(); 
	} 
	if($GLOBALS['group']==3)
	{
	$this->SetFont('Arial','',12);    
	$this->Cell(190,5,"Group : Humanities",0,0,'C');
	$this->Ln(); 
	} 
	}
	...
	$this->Ln();
		...
		$this->Cell(90,5,"Name",1);
		$this->Cell(30,5,"Grand Total",1,0,"C");
		$this->Cell(15,5,"GPA",1,0,"C");
		$this->Cell(35,5,"Merit Position",1,0,"C");
	$this->Ln();
...
{	
					$data="select * from borno_school_9_10_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND meritno_section!=0 order by meritno_section,borno_school_roll asc";
    	...
    	$data1="select * from borno_school_9_10_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND meritno_section!=0";
...
{	
					$data="select * from borno_school_6_8_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND meritno_section!=0 order by meritno_section,borno_school_roll asc";
					$qdata=$mysqli->query($data);
					while($showdata=$qdata->fetch_assoc()){ $sl++;
    	...
    	$data1="select * from borno_school_6_8_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND meritno_section!=0";
					$qdata1=$mysqli->query($data1);
					$meritno=mysqli_num_rows($qdata1); 
...
{	
    ...
    $data1="select * from borno_school_play_5_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND meritno_section!=0";
					$qdata1=$mysqli->query($data1);
					$meritno=mysqli_num_rows($qdata1); 
