...
function Header()
{
    ...
    $this->Image($finalSchoolLogo1,12,2,35,35);
...
function Footer()
{
    ...
    $this->Image($finalgtschoolsignature1,220,186,40,10);
	...
	$this->Cell(90,5,"Guardian's Signature",1,0,"C"); 
	$this->Cell(90,5,"Class Teacher's Signature",1,0,"C"); 
	$this->Cell(100,5,"Principal's Signature",1,0,"C"); 
			$this->Ln();
	 	$this->Cell(90,20,"",1,0,"C"); 
	$this->Cell(90,20,"",1,0,"C"); 
	...
	$this->Cell(100,1,"---------------------------------------",0,0,"C"); 
	$this->Ln();
	$this->Cell(90,5,"----------------------------",0,0,"C"); 
	$this->Cell(90,5,"-------------------------------------",0,0,"C"); 
    $this->SetFont('Arial','',10);	
	$this->Cell(100,5,"MD. IMAN UDDIN",0,0,"C"); 
	$this->Cell(1,4,"",0,0,"C");	
	$this->Ln();
	$this->SetFont('Arial','',9);	
	$this->Cell(90,5,"",0,0,"C"); 
	$this->Cell(90,5,"",0,0,"C"); 
	$this->Cell(100,5,"Acting Principal",0,0,"C"); 	
...
$pdf->Cell(220,2,"email : netragov.girlshschool@ymail.com",0,0,"C");
    ...
    $pdf->SetFont('Arial','',12); 
$pdf->Cell(220,2,"Uttarkhan, Dhaka-1230",0,0,"C");    
}
...
$congtsgpa ="select * from borno_class9_10_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid1' AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND borno_subject_nine_ten_id='$stN'";
					$conqggtsgpa=$mysqli->query($congtsgpa);
					$scontgqggtsgpa=$conqggtsgpa->fetch_assoc();
		$cqconv11=number_format($scontgqggtsgpa['res_number_type2']);
		$cqconv12=number_format($scontgqggtsgpa['res_number_type3']);
		if($stN==1 OR $stN==2){$cqconv11=number_format(($stN11+$stN12)*7/9);}
		elseif($stN==3 OR $stN==4){$cqconv11=number_format(($stN11+$stN12)*10/12);}
...
$congtsgpa1 ="select * from borno_class9_10_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid2' AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND borno_subject_nine_ten_id='$stN'";
					$conqggtsgpa1=$mysqli->query($congtsgpa1);
					$scontgqggtsgpa1=$conqggtsgpa1->fetch_assoc();
		$cqconv21=number_format($scontgqggtsgpa1['res_number_type2']);
		$cqconv22=number_format($scontgqggtsgpa1['res_number_type3']);
		if($stN==1 OR $stN==2){$cqconv21=number_format(($stN21+$stN22)*7/9);}
		elseif($stN==3 OR $stN==4){$cqconv21=number_format(($stN21+$stN22)*10/12);}
...
$congtsgpa11 ="select * from borno_class9_10_avg_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='0' AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND borno_subject_nine_ten_id='$stN'";
					$conqggtsgpa11=$mysqli->query($congtsgpa11);
					$scontgqggtsgpa11=$conqggtsgpa11->fetch_assoc();
		$cqconv31=number_format($scontgqggtsgpa11['res_number_type2']);
		$cqconv32=number_format($scontgqggtsgpa11['res_number_type3']);
		if($stN==1 OR $stN==2){$cqconv31=number_format(($stN1+$stN2)*7/9);}
		elseif($stN==3 OR $stN==4){$cqconv31=number_format(($stN1+$stN2)*10/12);}
...
$pdf->SetY(-75);
$pdf->Cell(178,4,'',0,0,"C");
$pdf->Cell(30,4,"Marks Range",1,0,"C");
$pdf->Cell(72,4,"Remarks of student behavior & values",1,0,"C");
$pdf->Ln();
$pdf->Cell(178,4,'',0,0,"C");
$pdf->Cell(30,4,"26-30",1,0,"C");
$pdf->Cell(72,4,"Best",1,0,"C");
$pdf->Ln();
$pdf->Cell(178,4,'',0,0,"C");
$pdf->Cell(30,4,"21-25",1,0,"C");
$pdf->Cell(72,4,"Better",1,0,"C");
$pdf->Ln();
$pdf->Cell(178,4,'',0,0,"C");
$pdf->Cell(30,4,"16-20",1,0,"C");
$pdf->Cell(72,4,"Good",1,0,"C");
$pdf->Ln();
$pdf->Cell(178,4,'',0,0,"C");
$pdf->Cell(30,4,"10-15",1,0,"C");
$pdf->Cell(72,4,"Need Progress",1,0,"C");
$pdf->Ln();
...
$congtsgpa ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid1' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight='$stN'";
					$conqggtsgpa=$mysqli->query($congtsgpa);
					$scontgqggtsgpa=$conqggtsgpa->fetch_assoc();
		$cqconv11=number_format($scontgqggtsgpa['res_number_type2']);
		$cqconv12=number_format($scontgqggtsgpa['res_number_type3']);
		if($stN==1){$cqconv11=number_format(($stN11+$stN12)*7/9);}
		elseif($stN==2){$cqconv11=number_format(($stN11+$stN12)*3/5);}
		elseif($stN==3){$cqconv11=number_format(($stN11+$stN12)*10/12);}
		elseif($stN==4){$cqconv11=number_format(($stN11+$stN12)*5/7);}
...
$congtsgpa1 ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid2' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight='$stN'";
					$conqggtsgpa1=$mysqli->query($congtsgpa1);
					$scontgqggtsgpa1=$conqggtsgpa1->fetch_assoc();
		$cqconv21=number_format($scontgqggtsgpa1['res_number_type2']);
		$cqconv22=number_format($scontgqggtsgpa1['res_number_type3']);
		if($stN==1){$cqconv21=number_format(($stN21+$stN22)*7/9);}
		elseif($stN==2){$cqconv21=number_format(($stN21+$stN22)*3/5);}
		elseif($stN==3){$cqconv21=number_format(($stN21+$stN22)*10/12);}
		elseif($stN==4){$cqconv21=number_format(($stN21+$stN22)*5/7);}
...
$congtsgpa2 ="select * from borno_class6_8_avg_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='0' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight='$stN'";
					$conqggtsgpa2=$mysqli->query($congtsgpa2);
					$scontgqggtsgpa2=$conqggtsgpa2->fetch_assoc();
		$cqconv31=number_format($scontgqggtsgpa2['res_number_type2']);
		$cqconv32=number_format($scontgqggtsgpa2['res_number_type3']);
		if($stN==1){$cqconv31=number_format(($stN1+$stN2)*7/9);}
		elseif($stN==2){$cqconv31=number_format(($stN1+$stN2)*3/5);}
		elseif($stN==3){$cqconv31=number_format(($stN1+$stN2)*10/12);}
		elseif($stN==4){$cqconv31=number_format(($stN1+$stN2)*5/7);}
