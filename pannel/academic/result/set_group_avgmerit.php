...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="set_group_avgmerit.php";
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2> Set Group Average Merit </h2></div>
                <div class="form">
...
<form name="frmcontent" id="myform" action="set_group_gpaavgmerit_do.php" method="post" enctype="multipart/form-data">
