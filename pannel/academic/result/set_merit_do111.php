    ...
    if($totalmark!=0)
{
	...
	VALUES ('$schId', '$branchId1', '$studClass1', '$shiftId1', '$section1', '$stsess1','$group1', '$selTerm1', '$studinfoId', '$studRoll', '$studName', '$totalmark', '$totalmark3', '$gtFinalGPA', '$gtFinalGPA1', '$finallg', '', '', '', '', '', '', '', '')";
...
$delhighmark="delete  from borno_height_mark_class9_10 where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_school_stud_group='$group1' AND borno_result_term_id='$selTerm1'";
	...
	$getheightmark="select * from borno_class9_10_temp_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_school_stud_group='$group1' AND borno_result_term_id='$selTerm1' AND borno_subject_nine_ten_id='$subjectid' order by total_marks desc limit 0,1";
			...
			$insgensubmaxnum="INSERT INTO `borno_height_mark_class9_10` ( `borno_school_id`, `borno_school_branch_id`, `borno_school_class_id`, `borno_school_shift_id`, `borno_school_section_id`, `borno_school_session`,`borno_subject_nine_ten_id`,`borno_result_term_id`,`borno_school_stud_group`, `getmaxmark`)
			
			 VALUES ('$schId', '$branchId1', '$studClass1', '$shiftId1', '$section1', '$stsess1',  '$subjectid','$selTerm1','$group1', '$gensubheightMark')";
    ...
    if($totalmark!=0)
{
	...
	VALUES ('$schId', '$branchId1', '$studClass1', '$shiftId1', '$section1', '$stsess1', '$selTerm1', '$studinfoId', '$studRoll', '$studName', '$totalmark', '$gtFinalGPA', '$finallg', '', '', '', '', '', '', '', '')";
