...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="set_merit_class_ngghs.php";
...
<form name="frmcontent" id="myform" action="set_merit_do_class_ngghs.php" method="post" enctype="multipart/form-data">
