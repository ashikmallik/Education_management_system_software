...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	function callpage()
	{
	 document.frmcontent.action="fail_list_ngghs.php";
...
?>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_faillist05_pdf_ngghs.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">Fail List</a></td>
 </tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_avgfaillist05_pdf_ngghs.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">Avg. Fail List</a></td>
 </tr>
   ...
   <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_avgfaillist05_shift_ngghs.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">Avg. Fail List Shift</a></td>
 </tr>
   ...
   <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_gpaavgfaillist05_pdf.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">GPA Avg. Fail List</a></td>
 </tr>
    <tr>

    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_groupavgfaillist05_pdf.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">Group Avg. Fail List</a></td>
 </tr>
</table>
