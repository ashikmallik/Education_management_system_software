...
//============================= Fail Subject =================================
	...
	elseif($totalfail1==1){$totalfail2="B-1";}	
	elseif($totalfail1==2){$totalfail2="B-2";}	
	elseif($totalfail1==3){$totalfail2="E-1";}	
	elseif($totalfail1==4){$totalfail2="E-2";}	
	else{ 
...
if($qins) { header("location:set_fail.php?msg=1&branchId=$branchId1&studClass=$studClass1&shiftId=$shiftId1&section=$section1&stsess=$stsess1&selTerm=$selTerm1");} else { header('location:set_fail.php?msg=2');}
