...
//==========================Delete Merit Table==============================
	$delinfo1="delete from borno_merit_no1 where empty='0'";
...
if($studClass1==1 OR $studClass1==2)
{
  $gtctmarg="select * from borno_school_9_10_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='$selTerm1' AND borno_school_stud_group='$group1' AND gpa!=0";
	...
	$styroll=$shgtctmarg['borno_school_roll'];
		
	
		
	
$insfmark="INSERT INTO `borno_merit_no1` (`gpa`, `grandtotal`,`rollno`, `meritno`)
		
		
		 VALUES ('$styGPA', '$studinfoId','$styroll', '0')";
...
$meritno2="select gpa from borno_merit_no1 group by gpa"; 
...
$insfmark2="INSERT INTO `borno_gpa` (`gpa`)
 ...
 $qins2=$mysqli->query($insfmark2);
	...
	$meritno5="select * from borno_merit_no1 where gpa='$styGPA1' order by grandtotal desc, rollno asc"; 
	...
	$rollno=$shqmeritno5['rollno']; 

	

  $insfmark1="UPDATE borno_merit_no1 SET meritno='$sl' where gpa='$styGPA1' AND grandtotal='$studin' AND rollno='$rollno'";
...
$meritno1="select * from borno_merit_no1 order by meritno"; 
    ...
    $mno=$sqqqmeritno1['meritno'];
	 ...
	 $rollno1=$sqqqmeritno1['rollno']; 

	

 $insfmark11="UPDATE borno_school_9_10_merit SET meritno_section='$mno' where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='$selTerm1' AND borno_school_stud_group='$group1' AND gpa='$styGPA11' AND grandtotal='$studin1' AND borno_school_roll='$rollno1'";
...
elseif($studClass1==3 OR $studClass1==4 OR $studClass1==5)
{
 $gtctmarg="select * from borno_school_6_8_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='$selTerm1' AND gpa!=0";
...
{
 $gtctmarg="select * from borno_school_play_5_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='$selTerm1' AND gpa!=0";
...
//  $insfmark1="UPDATE borno_merit_no1 SET meritno='$sl' where gpa='$styGPA1' AND grandtotal='$studin' AND rollno='$rollno'";
    ...
    $insfmark1="UPDATE borno_merit_no1 SET meritno='$sl' where gpa='$styGPA1' AND ABS(grandtotal-$studin)< .01 AND rollno='$rollno'";
...
// $insfmark11="UPDATE borno_school_play_5_merit SET meritno_section='$mno' where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='$selTerm1' AND gpa='$styGPA11' AND grandtotal='$studin1'";
 ...
 $insfmark11="UPDATE borno_school_play_5_merit SET meritno_section='$mno' where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='$selTerm1' AND gpa='$styGPA11' AND ABS(grandtotal-$studin1)< .01 AND borno_school_roll='$rollno1'";		
...
$insfmark="INSERT INTO `borno_merit_no1` (`gpa`, `grandtotal`, `meritno`)
...
$meritno2="select * from borno_merit_no1 group by gpa"; 
$qmeritno2=$mysqli->query($meritno2);
	while($sqmeritno2=$qmeritno2->fetch_assoc()){ 		
...
if($qins) { header("location:set_merit_zinjira.php?msg=1&branchId=$branchId1&studClass=$studClass1&shiftId=$shiftId1&section=$section1&stsess=$stsess1&selTerm=$selTerm1");} else { header('location:set_merit_zinjira.php?msg=2');}
