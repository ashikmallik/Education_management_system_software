...
{				
					$data="select * from borno_school_9_10_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_session='$stsess' AND borno_result_term_id='$term'  AND meritno_shift!=0 order by meritno_shift asc";
...
$fnssection=$sqgtsection['borno_school_section_name'];		
	...
	$data1="select * from borno_school_9_10_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_session='$stsess' AND borno_result_term_id='$term'  AND meritno_shift!=0";
