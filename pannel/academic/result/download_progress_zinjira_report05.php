...
function Header()
{
    ...
    $this->Image($finalSchoolLogo13,10,8,188,38);	
}
...
$pdf->Ln();
 ...
 $gtstotalban ="select * from borno_class1_temp_mark1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' order by borno_result_subject_id asc";
					$qgtstotalban=$mysqli->query($gtstotalban);
					while($sqgtstotalban=$qgtstotalban->fetch_assoc()){;		
		            $stNbangla=$sqgtstotalban['borno_result_subject_id'];
		            
		            if($stNbangla==1452 AND $stsess=2019){$stNbangla=1454;}
		            elseif($stNbangla==1454 AND $stsess=2019){$stNbangla=1452;}
		            
 $gtstotalban11 ="select * from borno_class1_temp_mark1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND borno_result_subject_id=$stNbangla";
					$qgtstotalban11=$mysqli->query($gtstotalban11);
					$sqgtstotalban11=$qgtstotalban11->fetch_assoc();  		            
		            $stNbangla1=$sqgtstotalban11['temp_res_number_type1'];
		            $stNbangla2=$sqgtstotalban11['temp_res_number_type2'];
		            $stNbangla3=$sqgtstotalban11['temp_res_number_type3'];
		            $stNbangla4=$sqgtstotalban11['temp_res_number_type4'];
		            $stNbangla5=$sqgtstotalban11['temp_res_number_type5'];
		            $stNbangla6=$sqgtstotalban11['temp_res_number_type6'];
		            $stNbanglatotal=$sqgtstotalban11['totalmark'];

 $gtstotalban1 ="select * from borno_class1_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND borno_result_subject_id=$stNbangla";
					$qgtstotalban1=$mysqli->query($gtstotalban1);
					$sqgtstotalban1=$qgtstotalban1->fetch_assoc();    
    				$stphoneban=$sqgtstotalban1['res_gpa'];
					$stgpban=$sqgtstotalban1['res_lg'];

 $gtstotalban1h ="select * from borno_maxnumber_class1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_result_subject_id=$stNbangla";
					$qgtstotalban1h=$mysqli->query($gtstotalban1h);
					$sqgtstotalban1h=$qgtstotalban1h->fetch_assoc();    
    				$stNamebanh=$sqgtstotalban1h['getmaxmark'];					
...
$pdf->Cell(92,6.5,'',0,0,"L");
$pdf->Cell(18,6.5,$stNbangla1,0,0,"C");	
$pdf->Cell(18,6.5,"-",0,0,"C");
$pdf->Cell(18,6.5,'',0,0,"L");
$pdf->Cell(17,6.5,$stNbanglatotal,0,0,"C");
$pdf->Cell(14,6.5,$stphoneban,0,0,"C");
$pdf->Cell(21,6.5,$stgpban,0,0,"C");
$pdf->Ln();
					}
