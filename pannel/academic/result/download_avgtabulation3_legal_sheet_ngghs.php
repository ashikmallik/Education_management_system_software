...
$fnsterm1=$sqgtterm['borno_result_term_name'];
...
function Header()
{
	...
	$this->Cell(45,5,$GLOBALS['fnsterm1'],0,0,'L');
...
$resultsub ="select * from borno_class1_temp_mark1 where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND borno_result_subject_id!='$subid1' AND borno_result_subject_id!='$subid2' AND borno_result_subject_id!='$subid3' AND borno_result_subject_id!='$subid4' AND borno_result_subject_id!='$subid5' AND borno_result_subject_id!='$subid6' order by borno_result_subject_id asc";
$sl2=0;
...
$resultsubavg ="select * from borno_class1_avgtemp_mark1 where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='0' AND borno_school_roll='$gtstotal111' AND borno_result_subject_id!='$subid1' AND borno_result_subject_id!='$subid2' AND borno_result_subject_id!='$subid3' AND borno_result_subject_id!='$subid4' AND borno_result_subject_id!='$subid5' AND borno_result_subject_id!='$subid6' order by borno_result_subject_id asc";
$sl2=0;
...
$resultgrandavg ="select * from borno_school_play_5_avg_merit where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='0' AND borno_school_roll='$gtstotal111'";
