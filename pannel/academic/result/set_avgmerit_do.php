...
$gtctmarg1="select * from  borno_class_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_school_stud_group='$group1' group by borno_student_info_id asc";
	...
	while($shgtctmarg1=$qgtctmarg1->fetch_assoc()){
		...
		$gtctmarg="select * from  borno_class_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_school_stud_group='$group1' AND borno_student_info_id='$studinfoId1' AND 4th_subject=0 AND uncountable=0 AND `subject_id` NOT IN (1,3)";
	...
	while($shgtctmarg=$qgtctmarg->fetch_assoc()){
		...
		//=============================================== 4th Subject ===================================
		$get4thsubmrk="select * from  borno_class_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_school_stud_group='$group1' AND borno_student_info_id='$studinfoId1' AND 4th_subject=1 AND uncountable=0";
		
		$qget4thsubmrk=$mysqli->query($get4thsubmrk);
		$shget4thsubmrk=$qget4thsubmrk->fetch_assoc();
		
		$gtforthsubMark=$shget4thsubmrk['grand_total'];
	...
	//============================================== End ===================================================	
		...
		$totalconvartmark[] = $shgtctmarg['grand_total'];
	...
	elseif($gtFinalGPA>=$gtgrtpoint7 AND $gtFinalGPA<$gtgrtpoint6){$finallg=$gtlettergrd7;}
 			...
 			// echo $totalmark." ";echo $totalsubject." ";echo $getmotsub." ";echo $totalgpa1." ";
 			// echo $finallg ."<br>";	
...
$gtctmarg1="select * from  borno_class_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' group by borno_student_info_id asc";
	...
	while($shgtctmarg1=$qgtctmarg1->fetch_assoc()){
		...
		$gtctmarg="select * from  borno_class_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId1' AND 4th_subject=0 AND uncountable=0 AND `subject_id` NOT IN (1,3)";
	...
	while($shgtctmarg=$qgtctmarg->fetch_assoc()){
		...
		//=============================================== 4th Subject ===================================
    	$get4thsubmrk="select * from  borno_class_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId1' AND 4th_subject=1 AND uncountable=0";
...
//======================================Merit Section========================================
	...
	$delinfo2="TRUNCATE TABLE `borno_gpa`";
