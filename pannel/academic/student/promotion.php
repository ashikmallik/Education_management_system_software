 ...
 ?>
  ...
  <?php
    ...
    <td><select name="studClass" id="studClass" onchange="callpage();">
     ...
     <?php
					$gstclass="select * from borno_school_set_class GROUP BY `borno_school_class_id` order by class_order asc";
    ...
    <?php
											...
											$shiftId=$_POST['shiftId'];
                                                ...
                                                $gstsection="select * from borno_school_section where borno_school_class_id='$studClass' AND borno_school_branch_id='$gtfbranchId'  AND borno_school_shift_id='$shiftId'";
    ...
    <td><select name="nstsess" id="nstsess">
      ...
      <option value="2025" <?php if($_POST['nstsess']=='2025') { echo "selected"; } ?>> 2025 </option>
			...
			$stsess=$_POST['stsess'];		
							 ...
							 $gtctmarg="select * from borno_student_info where  borno_school_branch_id='$gtfbranchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' order by borno_school_roll asc";
