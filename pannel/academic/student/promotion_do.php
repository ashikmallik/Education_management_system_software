...
$schId = 1;
	...
	if($newroll[$i]!=""){	
		...
		if($schId == 85){
            if($studClass==1 OR $studClass == 2){
               ...
               $gsess="select * from borno_student_info where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$nstudClass1' AND borno_school_shift_id='$nshiftId1' AND borno_school_section_id='$nsection1' AND borno_school_session='$nstsess1' AND borno_school_stud_group = '$ngroup' AND borno_school_roll='$newroll[$i]'";
            }
            else{
 ...
 $insmk="UPDATE `borno_student_info` SET `borno_school_class_id`='$nstudClass1',`borno_school_shift_id`='$nshiftId1',`borno_school_section_id`='$nsection1',`borno_school_session`='$nstsess1',`borno_school_roll`='$newroll[$i]' where `borno_student_info_id`='$stdid[$i]' AND borno_school_id='$schId' AND borno_school_branch_id='$branchId1'";
