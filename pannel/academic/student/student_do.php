...
//		$sturoll = clean_html($_POST['sturoll']);
	...
	if($smsbranch['borno_student_info_id']==$stuid1){
	    header("location:student_pannel.php?msg=4&branchId=$addBranchf&shiftId=$shiftId1&studClass=$studClass1&section=$section1");
	}
	else{
	 ...
	 $bornoschBranch="INSERT INTO `borno_student_info` (`borno_student_info_id`,`borno_school_id`, `borno_school_branch_id`, `borno_school_class_id`,`borno_school_shift_id`,`borno_school_section_id`,`borno_school_session`,`borno_school_student_name`,`borno_school_father_name`,`borno_school_gender`, `borno_school_mother_name`, `borno_school_address`, `borno_school_phone`, `borno_school_blood_group`, `borno_school_dob`, `borno_school_religion`, `borno_school_status`, `borno_school_org`, `borno_school_stud_group`, `borno_school_roll`, `borno_school_photo`,`borno_student_status`)
											
															VALUES ('$stuid1','$schId', '$addBranchf', '$studClass1', '$shiftId1', '$section1', '$stsess1','$stuName1','$stuFname1','$stuMname1','$gender1','$stuaddress1','$stuphone1','$blgroup1','$datepicker1','$religion1','$status1','School', '$group1','$sturoll1','$fnme','1')";
