...
;(function( $ ){
	...
	$.fn.nicelabel = function(options) {
		...
		var settings = $.extend({},{
			...
			checked_ico: 'assets/box/ico/tick-checked.png', 	//
			
			unchecked_ico: 'assets/box/ico/tick-unchecked.png', 	//

			//cus_checked_ico: 'assets/box/ico/tick-checked.png', 	//
			
			//cus_unchecked_ico: 'assets/box/ico/female.png', 	//
