...
<script language="javascript">
 ...
 <table width="330px" border="1" cellspacing="0" cellpadding="0" style="color:#000;" >
       <tr>
    <td class="" align=""><a href="download_summary.php?stsess=<?php echo $_POST['stsess']; ?>&schoolId=<?php echo $schId; ?>" target="_blank">Download Summary</a></td>
  </tr>
  <tr>
    <td class="" align=""><a href="download_branch_wise_summary.php?stsess=<?php echo $_POST['stsess']; ?>&branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>" target="_blank">Download Branch wise Summary</a></td>
  </tr>
  <tr>
    <td class="" align=""><a href="download_student_info.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download All Student</a></td>
  </tr>
  
    <tr>
    <td class="" align=""><a href="download_student_voter.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download Voter List</a></td>
  </tr>
    <tr>
    <td class="" align=""><a href="download_student_info_picture.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download All Student With Photo</a></td>
  </tr>
  <tr>
    <td class="" align=""><a href="download_student_info_details.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download All Student Details</a></td>
  </tr>
  <tr>
    <td class="" align=""><a href="download_student_info_id_card.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download Student Info For ID Card</a></td>
  </tr>
  <tr>
    <td class="" align=""><a href="download_student_info_id_card2.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download Student Info For ID Card(by shukriti)</a></td>
  </tr>
  
    <tr>
    <td class="" align=""><a href="download_student_id_card.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download ID Card Default</a></td>
  </tr>

  <tr>
    <td class="" align=""><a href="download_id_card.php?branchId=<?php echo $_POST['branchId']; ?>&roll=<?php echo $roll; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download ID Card Front</a></td>
  </tr>
    <td class="" align=""><a href="download_id_card_back.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download ID Card Back</a></td>
  </tr>
</table>
                   <br><br>
