...
if($quygeneralsubmark) { header("location:process_result.php?msg=1&branchId=$branchId&studClass=$studClass&shiftId=$shiftId&section=$section&stsess=$stsess");} else { header('location:process_result.php?msg=2');}
