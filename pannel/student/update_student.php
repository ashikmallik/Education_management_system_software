...
require_once('student_top.php');
 ...
 require_once '../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	if (!function_exists('clean_html')) {
		...
		$guardians_mobile_no = clean_html($_POST['guardians_mobile_no']);
		$guardians_mobile_no1 = strip_tags($_POST['guardians_mobile_no']);
	...
	$smsbranch=$rsQuery1->fetch_assoc();
		...
		if($smsbranch['borno_school_roll']==$sturoll1){
			header("location:manage_student.php?msg=3");
		...
		{
		    echo "$fnme";
		$bornoschBranch="UPDATE `borno_student_info` SET `borno_school_id`='$schId', `borno_school_branch_id`='$addBranchf', `borno_school_class_id`='$studClass1',`borno_school_shift_id`='$shiftId1',`borno_school_section_id`='$section1',`borno_school_session`='$stsess1',`borno_school_student_name`='$stuName1',`borno_school_father_name`='$stuFname1', `borno_school_mother_name`='$stuMname1', `borno_school_address`='$stuaddress1', `borno_school_phone`='88$stuphone1', `borno_school_blood_group`='$blgroup1', `borno_school_dob`='$datepicker1', `borno_school_religion`='$religion1', `borno_school_status`='$status1', `borno_school_student_id`='$stuid1', `borno_school_stud_group`='$group1', `borno_school_roll`='$sturoll1', `student_id_office`='$student_id_office1', `blood_group`='$blood_group1', `birth_reg_no`='$birth_reg_no1', `father_occupation`='$father_occupation1', `mother_occupation`='$mother_occupation1', `father_mobile_no`='$father_mobile_no1', `mother_mobile_no`='$mother_mobile_no1', `father_nid_no`='$father_nid_no1', `mother_nid_no`='$mother_nid_no1', `guardians_name`='$guardians_name1', `guardians_relationship`='$guardians_relationship1', `pre_village`='$pre_village1', `pre_post`='$pre_post1', `pre_upazilla`='$pre_upazilla1', `pre_district`='$pre_district1', `pre_division`='$pre_division1', `par_village`='$par_village1', `par_post`='$par_post1', `par_upazilla`='$par_upazilla1', `par_district`='$par_district1', `par_division`='$par_division1', `guardians_mobile_no`='$guardians_mobile_no1',`borno_school_photo`='$fnme' where `borno_student_info_id`='$studentId'";
					
		}
		else
		{
		$bornoschBranch="UPDATE `borno_student_info` SET `borno_school_id`='$schId', `borno_school_branch_id`='$addBranchf', `borno_school_class_id`='$studClass1',`borno_school_shift_id`='$shiftId1',`borno_school_section_id`='$section1',`borno_school_session`='$stsess1',`borno_school_student_name`='$stuName1',`borno_school_father_name`='$stuFname1', `borno_school_mother_name`='$stuMname1', `borno_school_address`='$stuaddress1', `borno_school_phone`='88$stuphone1', `borno_school_blood_group`='$blgroup1', `borno_school_dob`='$datepicker1', `borno_school_religion`='$religion1', `borno_school_status`='$status1', `borno_school_student_id`='$stuid1', `borno_school_stud_group`='$group1', `borno_school_roll`='$sturoll1', `student_id_office`='$student_id_office1', `blood_group`='$blood_group1', `birth_reg_no`='$birth_reg_no1', `father_occupation`='$father_occupation1', `mother_occupation`='$mother_occupation1', `father_mobile_no`='$father_mobile_no1',  `mother_mobile_no`='$mother_mobile_no1', `father_nid_no`='$father_nid_no1', `mother_nid_no`='$mother_nid_no1', `guardians_name`='$guardians_name1', `guardians_relationship`='$guardians_relationship1', `pre_village`='$pre_village1', `pre_post`='$pre_post1', `pre_upazilla`='$pre_upazilla1', `pre_district`='$pre_district1', `pre_division`='$pre_division1', `par_village`='$par_village1', `par_post`='$par_post1', `par_upazilla`='$par_upazilla1', `par_district`='$par_district1', `par_division`='$par_division1', `guardians_mobile_no`='$guardians_mobile_no1' where `borno_student_info_id`='$studentId'";
				...
				if($qbornoschBranch) { header("location:manage_student.php?msg=1&branchId=$addBranchf&studClass=$studClass1&shiftId=$shiftId1&section=$section1&stsess=$stsess1"); } else { header('location:manage_student.php?msg=2'); }				
