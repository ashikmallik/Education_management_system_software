...
<script language="javascript">
	function callpage()
	{
	 document.frmcontent.action="absent.php";
	 document.frmcontent.submit();
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading"><h2>Attandance Entry</h2></div>
                <div class="form">
		...
		?>
               ...
               <tr>    
                  ...
                  <td width="414" valign="top">
                        <center>
                   <form name="frmcontent" id="myform" action="absent_do.php" method="post" enctype="multipart/form-data">
