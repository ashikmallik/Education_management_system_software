...
<script language="javascript">
	function callpage()
	{
	 document.frmcontent.action="absent_sms.php";
	 document.frmcontent.submit();
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading"><h2>Attandance Entry With SMS</h2></div>
                <div class="form">
		...
		?>
               ...
               <tr>    
                  ...
                  <td width="414" valign="top">
                        <center>
                   <form name="frmcontent" id="myform" action="absent_sms_do.php" method="post" enctype="multipart/form-data">
...
<td colspan="2" align="center"  style="color:#0F0"> Search Option </td>
 ...
 // $shiftId=$_POST['shiftId'];
  ...
  <tr>
    ...
    <td width="231">Student Name</td>
        <td width="10" align="center">Roll No</td>
    <td width="120">Absent Entry</td>
...
$gtstudent="select * from borno_student_info where borno_school_id='$schId' AND borno_school_branch_id='$gtfbranchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session=$stsess order by borno_school_roll asc";
  ...
  <tr>
    ...
    <td align="center"><input class="chk" type="checkbox" name="stdid[]" id="stdid[]" value="<?php echo $shgtstudent['borno_student_info_id'];?>">
</td>
    </tr>
