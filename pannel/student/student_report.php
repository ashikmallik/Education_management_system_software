...
<script language="javascript">
 ...
 <table width="330px" border="1" cellspacing="0" cellpadding="0" style="color:#000;" >
  ...
  <tr>
    <td class="" align=""><a href="download_student_info_details2.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download All Student Details</a></td>
  </tr>
  <tr>
