...
if ($stroll<$maxroll1)
{
		...
		$eightDigit = $sqdata1['eight_digit_student_id'];
        if($stName=="")
        {
          $stroll=$stroll+1;
          goto firstline;
...
$data2="select * from borno_student_info where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_school_roll='$stroll1'";
        ...
        $eightDigit1 = $sqdata2['eight_digit_student_id'];
         if($stName1=="")
        {
          $stroll1=$stroll1+1;
          goto lastline;
		...
		if($schId == 33){
		  $pdf->Ln(5);  	
		   $pdf->Cell(58,5,"Student ID: $eightDigit",0);
    	...
    	$pdf->Cell(2,5,"",0,0,"C");
    if($schId == 33){
		   $pdf->Cell(58,5,"Student ID: $eightDigit1",0);	 
		}
		else{
    	$pdf->Cell(58,5,"Student ID: $stid1",0);	
		}
