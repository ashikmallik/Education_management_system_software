...
$stsess=trim($_GET['stsess']);
 ...
 "SELECT * FROM `borno_student_info` WHERE `borno_school_id`='$schId' AND `borno_school_class_id`='$studClass' AND `borno_school_shift_id`='$shiftId' AND `borno_school_section_id`='$section' AND `borno_school_session`='$stsess'";




$qry = $mysqli->query("SELECT * FROM `borno_student_info` WHERE `borno_school_id`='$schId' AND `borno_school_class_id`='$studClass' AND `borno_school_shift_id`='$shiftId' AND `borno_school_section_id`='$section' AND `borno_school_session`='$stsess' order by borno_school_roll asc");
...
$data.="StudentID".","."StudentName".","."FatherName".","."MotherName".","."ClassName".","."Shift".","."StdSection".","."StdSession".","."RollNo".","."ContactNo".","."DateofBirth".","."BloodGroup".",
"."Birth Reg.No".","."Religion"." ,"."Address"."\n";
...
{
  $data .= $row['borno_student_info_id'].",".$row['borno_school_student_name'].",".$row['borno_school_father_name'].",".$row['borno_school_mother_name'].",".$classInfo['borno_school_class_name'].",".$shiftInfo['borno_school_shift_name'].",".$sectionInfo['borno_school_section_name'].",".$row['borno_school_session'].",".$row['borno_school_roll'].",".substr($row['borno_school_phone'],2,11).",".$row['borno_school_dob'].",".$row['borno_school_blood_group'].",".$row['birth_reg_no'].",".$row['borno_school_religion'].",".$row['borno_school_address']."\n";    
}

}

header('Content-Type: application/csv');
header('Content-Disposition: attachement; filename="student_info.csv"');
echo $data; exit();
