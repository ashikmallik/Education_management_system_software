...
<script language="javascript">
 ...
 // $shiftId=$_POST['shiftId'];
  ...
  <tr>
    <td class="text_table" align="right"><a href="download_student_csv.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download CSV</a></td>
  </tr>
  
  <tr>
    <td class="text_table" align="right"><a href="download_student_class_csv.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download All Student Class Wise CSV</a></td>
  </tr>  
  
  <tr>
    <td class="text_table" align="right"><a href="download_all_student_csv.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download All Student CSV</a></td>
  </tr>  
