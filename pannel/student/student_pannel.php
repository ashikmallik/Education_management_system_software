...
<script language="javascript">
  ...
  <tr>
   ...
   <tr>
      ...
      <td class="text_table">Student Id office</td>
                                <td><input type="text" name="student_id_office" id="sturoll"></td>
                                 <td class="text_table">Blood Group</td>
		            <td><label for="timg"></label>
	                <input type="text" name="blood_group" id="timg"></td>
  </tr>
   <tr>
  
      <td class="text_table">birth reg no</td>
                                <td><input type="text" name="birth_reg_no" id="sturoll"></td>
                                 <td class="text_table">Father Occupation</td>
		            <td><label for="timg"></label>
	                <input type="text" name="father_occupation" id="timg"></td>
  </tr>
  <tr>
  
      <td class="text_table">Mother Occupation</td>
                                <td><input type="text" name="mother_occupation" id="sturoll"></td>
                                 <td class="text_table">Father Mobile No</td>
		            <td><label for="timg"></label>
	                <input type="text" name="father_mobile_no" id="timg"></td>
  </tr>
    <tr>
  
      <td class="text_table">Mother Mobile no</td>
                                <td><input type="text" name="mother_mobile_no" id="sturoll"></td>
                                 <td class="text_table">Father NID No</td>
		            <td><label for="timg"></label>
	                <input type="text" name="father_nid_no" id="timg"></td>
  </tr>
  <tr>
  
      <td class="text_table">Mother NID no</td>
                                <td><input type="text" name="mother_nid_no" id="sturoll"></td>
                                 <td class="text_table">Guardians name</td>
		            <td><label for="timg"></label>
	                <input type="text" name="guardians_name" id="timg"></td>
  </tr>
   <tr>
  
      <td class="text_table">Guardians Relationship</td>
                                <td><input type="text" name="guardians_relationship" id="sturoll"></td>
                                 <td class="text_table">Present Village</td>
		            <td><label for="timg"></label>
	                <input type="text" name="pre_village" id="timg"></td>
  </tr>
  <tr>
  ...
  <tr>
      ...
      <td class="text_table">Present Post</td>
                                <td><input type="text" name="pre_post" id="sturoll"></td>
                                 <td class="text_table">Present upazilla</td>
		            <td><label for="timg"></label>
	                <input type="text" name="pre_upazilla" id="timg"></td>
  </tr>
  <tr>
  
      <td class="text_table">Present district</td>
                                <td><input type="text" name="pre_district" id="sturoll"></td>
                                 <td class="text_table">Present Division</td>
		            <td><label for="timg"></label>
	                <input type="text" name="pre_division" id="timg"></td>
  </tr>
  <tr>
  
      <td class="text_table">Parmanent village</td>
                                <td><input type="text" name="par_village" id="sturoll"></td>
                                 <td class="text_table">Parmanent Post</td>
		            <td><label for="timg"></label>
	                <input type="text" name="par_post" id="timg"></td>
  </tr>
  <tr>
  
      <td class="text_table">Parmanent Upazilla</td>
                                <td><input type="text" name="par_upazilla" id="sturoll"></td>
                                 <td class="text_table">Parmanent district</td>
		            <td><label for="timg"></label>
	                <input type="text" name="par_district" id="timg"></td>
  </tr>
  <tr>
  
      <td class="text_table">Parmanent Division</td>
                                <td><input type="text" name="par_division" id="sturoll"></td>
                                <td class="text_table">Guardians Mobile No</td>
		            <td><label for="timg"></label>
	                <input type="text" name="guardians_mobile_no" id="timg"></td>
