...
$txt=$sqgtschoolName['borno_school_name_bangla'];
//$txt1='utf8_general_ci:$txt';
//$txt=iconv('utf-8','c1252',$txt);
...
$txt="লালবাগ সরকারি মডেল হাই স্কুল";
...
//    $this->Image('logo.png',10,6,30);
    ...
    // Line break
    $this->Ln();
    $this->SetFont('nikosh','',30);
    $this->Cell(200,$GLOBALS['txt'],0,1,'C');
    $this->Ln();
    $this->SetFont('nikosh','',14);
