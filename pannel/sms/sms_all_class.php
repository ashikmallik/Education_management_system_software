...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script language="javascript">
		function callpage()
		{
		 document.frmart.action="sms_all_class.php";
    ...
    <option value="">--Select--</option>
      <?php
	  		...
	  		$studClass=$_POST['studClass'];
					...
					$data1="select borno_school_session from borno_student_info where borno_school_id='$schId' and borno_school_class_id='$studClass'  group by borno_school_session asc";
      ...
      <?php } ?>
                ...
                <form name="myForm" action="sms_all_class_do.php" method="post" enctype="multipart/form-data">
						...
						<tbody>
							<tr>
								...
								<td>
                                     ...
                                     <textarea name="message" cols="45" rows="3" id="message" onKeyDown="textCounter(document.myForm.message,document.myForm.remLen1,310)" onKeyUp="textCounter(document.myForm.message,document.myForm.remLen1,310)"></textarea>

                <br>

<input readonly type="text" name="remLen1" size="3" maxlength="3" value="310">
						...
						<tbody>
							<tr>
								...
								<td>
                                     ...
                                     <textarea name="message" cols="45" rows="3" id="message" onKeyDown="textCounter(document.myForm.message,document.myForm.remLen1,245)" onKeyUp="textCounter(document.myForm.message,document.myForm.remLen1,245)"></textarea>

                <br>

<input readonly type="text" name="remLen1" size="3" maxlength="3" value="245">
