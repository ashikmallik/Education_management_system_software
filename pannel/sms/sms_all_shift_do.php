...
*/
	...
	$smstime=date('H:I:s');
		...
		$store= "INSERT INTO `bornosky_sms` (`borno_school_id`, `borno_school_class_id`, `borno_school_date`, `message`, `borno_school_branch_id`, `borno_school_session`, `time`,`borno_school_shift_id` ,`status` ,`send_status`) VALUES ('$schId', '', '$smsdate', '$message1', '$branchid', '$stsess', '$smstime', '$shiftid', 'All Shift sms', '0')";
			
			   $rsQuery2 = $mysqli->query($store);
	
	   $gtTotalstudent="select * from borno_student_info where borno_school_id='$schId' AND borno_school_branch_id='$branchid' AND borno_school_shift_id='$shiftid'AND borno_school_session='$stsess' AND borno_student_status = 1 order by borno_school_roll asc";
	...
	$gtmax="select COUNT(borno_school_roll) as max from borno_student_info where borno_school_id='$schId' AND borno_school_branch_id='$branchid' AND borno_school_shift_id='$shiftid' AND borno_school_session='$stsess' AND borno_student_status = 1 order by borno_school_roll asc";
	...
	$gtstudent="select * from borno_student_info where borno_school_id='$schId' AND borno_school_branch_id='$branchid' AND borno_school_shift_id='$shiftid'AND borno_school_session='$stsess' AND borno_student_status = 1 order by borno_school_roll asc";
...
// 	}		
	...
	//	-------------API---Close-------------------//
		...
		$bornosentSMS="INSERT INTO `borno_sent_sms` (`borno_school_id`,`borno_school_branch_id`,`borno_school_class_id`,`borno_school_shift_id`,`borno_school_section_id`,`borno_school_session`,`borno_school_roll`,`borno_school_student_name`, `borno_sent_sms_phone`,`borno_sms_status`,`borno_sms_type`, `borno_sent_sms_message`,`borno_sms_date`,`borno_sms_time`,`borno_count_sms`) 
				VALUES ('$schId','$branchid','$classid','$shiftid','$section','$stsess','$roll','$name', '$To','Shift wise','$smsType', '$message1','$smsdate','$smstime','$count')";
				$rsQuery = $mysqli->query($bornosentSMS);	
		
		
	}		  
		 // if($rsQuery2) { header("location:success_message.php?msg=1"); } else { header("location:success_message.php?msg=2"); }		
		}
	}
