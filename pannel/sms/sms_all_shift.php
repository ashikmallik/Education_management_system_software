...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script language="javascript">
		function callpage()
		{
		 document.frmart.action="sms_all_shift.php";
...
<div class="main">
	<div class="left_fixed">
		<div class="logo_top">
		  <a href="index.php"><img src="images/indiv/sms.jpg" height="80px" width="120px"></a>
			<a href=""><img src="images/sms/in06.jpg" height="80px" width="120px"></a>
		</div>
    ...
    <option value="">--Select--</option>
      <?php
					...
					$data1="select borno_school_session from borno_student_info where borno_school_id='$schId'  and borno_school_shift_id='$shiftId'  group by borno_school_session asc";
      ...
      <?php } ?>
                ...
                <form name="myForm" action="sms_all_shift_do.php" method="post" enctype="multipart/form-data">
