...
<head>
    ...
    <script language="javascript">
		function callpage()
		{
		 document.frmart.action="teacher_sms.php";
	...
	<div class="left_fixed">
		<div class="logo_top">
		  <a href="index.php"><img src="images/indiv/sms.jpg" height="80px" width="120px"></a>
			<a href="teacher_sms.php"><img src="../../images/sms/in11.jpg" height="80px" width="120px"></a>
		</div>
	...
	<div class="main_content_ind">
		<div class="sm_main_part">
            ...
            <?php } ?>
                ...
                <form name="myForm" action="teacher_sms_do.php" method="post" enctype="multipart/form-data">
...
$gtshiftId=$_POST['shiftId'];

 $gtstudent="select * from borno_teacher_info where borno_school_id='$schId' AND borno_school_branch_id='$gtfbranchId' AND borno_school_shift_id='$gtshiftId'  order by borno_teacher_info_id asc";
	...
	while($shroll=$qgtstudent->fetch_assoc()){ $sl++;
			   ...
			   ?>
					    ...
					    <tr>
					      <th><input class="chk" type="checkbox" name="stPhone[]" id="stPhone[]" value="<?php echo $shroll['borno_teacher_phone'];?>"></th>
					    
					      <td><?php echo $shroll['borno_teacher_name'];?></td>
					      <td><?php echo $shroll['borno_teacher_phone'];?></td>
