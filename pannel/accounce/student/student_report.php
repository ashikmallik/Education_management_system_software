...
<!--
    <tr>
    <td class="text_table" align="right"><a href="download_student_info_details1.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">TEST</a></td>
  </tr>
-->
</table>
                   <br><br>
