...
-->        </div>
 ...
 <option value="2018" <?php if($_POST['nstsess']==2018) { echo "selected"; } ?>> 2018 </option>
      <option value="2019" <?php if($_POST['nstsess']==2019) { echo "selected"; } ?>> 2019 </option>
      <option value="2020" <?php if($_POST['nstsess']==2020) { echo "selected"; } ?>> 2020 </option>
    </select></td>
