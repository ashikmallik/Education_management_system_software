...
<script language="javascript">
	 ...
	 document.frmcontent.submit();
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading"><h2>Due History</h2></div>
  ...
  <tr>
    <td class="text_table" align="center"><a href="download_due_list.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download Due History-1</a></td>
  </tr>
  <tr>
    <td class="text_table" align="center"><a href="download_due_list_2.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download Due History-2</a></td>
  </tr>
