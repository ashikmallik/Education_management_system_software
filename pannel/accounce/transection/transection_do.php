...
if($qinstm1) { 
  ...
  //================ Count Total SMS ==================================
    ...
    header("location:transection.php?branchId=$addBranchf&studClass=$studClass1&shiftId=$shiftId1&section=$section1&stsess=$stsess1&msg1=$memono&msg=1"); } 

else  {   header("location:transection.php?msg=2"); }
