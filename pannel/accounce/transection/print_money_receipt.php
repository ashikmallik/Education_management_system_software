...
<script language="javascript">
	...
	function callpage()
	{
	 document.frmcontent.action="print_money_receipt.php";
    ...
    <div class="ot_main_content">
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                ...
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="	
download_memo_half.php" method="post" enctype="multipart/form-data" target="_blank">
                        <?php
			$msg=$_GET['msg'];
