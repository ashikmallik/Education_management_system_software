...
<script language="javascript">
	...
	function callpage()
	{
	 document.frmcontent.action="delete_money_receipt.php";
    ...
    <div class="ot_main_content">
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                ...
                <div class="form">
                    <center>
        <form name="frmcontent" action="show_money_receipt.php" method="post" enctype="multipart/form-data">
                        <?php
			$msg=$_GET['msg'];
			if($msg==1) { echo "Delete Success"; }
			else if($msg==2) { echo "Failed"; }
            else if($msg==3) { echo "Memo Not Found"; }
            else if($msg==4) { echo "Delete Not Possible"; }
 ?>
   ...
   <tr>
<td colspan="2" align="center"><input type="submit" name="button" id="button" value="Show"></td>
  </tr>
