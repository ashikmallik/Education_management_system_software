...
if($qinstm1) { header("location:increase_student_balance.php?branchId=$addBranchf&studClass=$studClass1&shiftId=$shiftId1&section=$section1&stsess=$stsess1&msg=1"); } 

else  {   header("location:increase_student_balance.php?msg=2"); }
