...
<script language="javascript">
	...
	function callpage()
	{
	 document.frmcontent.action="increase_student_balance.php";
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2>Increase Student Balance</h2></div>
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="increase_student_balance_do.php" method="post" enctype="multipart/form-data">
                        <?php
			$msg=$_GET['msg'];
