...
// 	}
// 	else{
// 	    $gtheadid="SELECT * FROM `fees_head` WHERE `class_id` ='$studClass' AND `branch_id`='$branchid' AND `student_group` = '$group' AND `fiscal_year_id` = '$fiscalid' AND `head_type` NOT IN ('Monthly')";
// 	    //echo "test";
// 	}
