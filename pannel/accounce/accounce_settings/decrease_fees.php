...
<script language="javascript">
	...
	function callpage()
	{
	 document.frmcontent.action="decrease_fees.php";
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2>Decrease Fees</h2></div>
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="decrease_fees_do.php" method="post" enctype="multipart/form-data">
                        <?php
			$msg=$_GET['msg'];
 ...
 ?>
    ...
    <option value="">--Select--</option>
      ...
      <?php		
		...
		$gtctmarg="select * from borno_school_fees where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND  	borno_school_class_id='$studClass' AND borno_school_session='$stsess'  order by borno_school_fees_id asc";  
