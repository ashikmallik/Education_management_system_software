...
if($qinstm1) { header("location:decrease_fees.php?branchId=$addBranchf&studClass=$studClass1&stsess=$stsess1&msg=1"); } 

else  {   header("location:decrease_fees.php?msg=2"); }
