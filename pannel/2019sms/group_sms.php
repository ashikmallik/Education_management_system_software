...
<head>
    ...
    <script language="javascript">
		function callpage()
		{
		 document.frmart.action="group_sms.php";
	...
	<div class="left_fixed">
		<div class="logo_top">
		  <a href="index.php"><img src="images/indiv/sms.jpg" height="80px" width="120px"></a>
			<a href=""><img src="../../images/sms/g03.jpg" height="80px" width="120px"></a>
		</div>
	...
	<div class="main_content_ind">
		<div class="sm_main_part">
			<div class="in_form">
				<form name="frmart" action="#" method="post" enctype="multipart/form-data">
					<center>
						<table>
							...
							<tr>
                               ...
                               <select name="group" id="group">
								  ...
								  <?php
                                    ...
                                    ?>
								  <option value=" <?php echo $showdata['borno_school_group_id']; ?>" <?php if($showdata['borno_school_group_id']==$_POST['group']) { echo "selected"; }  ?>> <?php echo $showdata['borno_school_group_Name']; ?>
							...
							<tr>
							  <td>Message Type: &nbsp;</td>
							  <td><select name="msgType" id="msgType" onchange="callpage();">
                ...
                <form name="myForm" action="group_sms_do.php" method="post" enctype="multipart/form-data">
...
<input readonly type="text" name="remLen1" size="3" maxlength="3" value="<?php echo $shextlimit['english_limit']; ?>">
 ...
 $gtstudent="select * from borno_school_group_number where borno_school_id='$schId' AND borno_school_group_id='$group'  order by borno_school_group_number_id asc";
	...
	while($shroll=$qgtstudent->fetch_assoc()){ $sl++;
			   ...
			   ?>
					    ...
					    <tr>
					      <th><input class="chk" type="checkbox" name="stPhone[]" id="stPhone[]" value="<?php echo $shroll['borno_school_group_us_number'];?>"></th>
					      <td><?php echo $shroll['borno_school_group_us_name'];?></td>
					      <td><?php echo $shroll['borno_school_group_us_number'];?></td>
                            </tr>
