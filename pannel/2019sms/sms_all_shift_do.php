...
*/
	...
	$smstime=date('H:I:s');
	   ...
	   $gtTotalstudent="select * from borno_student_info where borno_school_id='$schId' AND borno_school_branch_id='$branchid' AND borno_school_shift_id='$shiftid'AND borno_school_session='$stsess' order by borno_school_roll asc";
	...
	$gtstudent="select * from borno_student_info where borno_school_id='$schId' AND borno_school_branch_id='$branchid' AND borno_school_shift_id='$shiftid'AND borno_school_session='$stsess' order by borno_school_roll asc";
	...
	if(!empty($response)) {
	  echo $response;
		...
		$bornosentSMS="INSERT INTO `borno_sent_sms` (`borno_school_id`,`borno_student_info_id`,`borno_school_branch_id`,`borno_school_class_id`,`borno_school_shift_id`,`borno_school_section_id`,`borno_school_session`,`borno_school_roll`,`borno_school_student_name`, `borno_sent_sms_phone`,`borno_sms_status`,`borno_sms_type`, `borno_sent_sms_message`,`borno_sms_date`,`borno_sms_time`,`total_sms_count`,`bangla_message`) 
				VALUES ('$schId','$stdinfoId','$branchid','$classid','$shiftid','$section','$stsess','$roll','$name', '$To','Shift wise','$smsType', '$message1','$smsdate','$smstime','$totcountSMS1','$message1')";
