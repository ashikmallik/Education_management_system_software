...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script language="javascript">
		function callpage()
		{
		 document.frmart.action="absent.php";
...
<div class="main">
	<div class="left_fixed">
		<div class="logo_top">
		  <a href="index.php"><img src="images/indiv/sms.jpg" height="80px" width="120px"></a>
			<a href=""><img src="images/sms/in04.jpg" height="80px" width="120px"></a>
		</div>
	...
	<div class="main_content_ind">
        ...
        <option value="2019" <?php if($_POST['stsess']==2019) { echo "selected"; } ?>> 2019 </option>
          <option value="2020" <?php if($_POST['stsess']==2020) { echo "selected"; } ?>> 2020 </option>                                    <option value="2018-19" <?php if($_POST['stsess']=="2018-19") { echo "selected"; } ?>> 2018-19 </option>
                ...
                <form name="myForm" action="absent_do.php" method="post" enctype="multipart/form-data">
					...
					$sms="select * from `defalt_msg` where `schlog_id`='$schId' AND `msg_type`='1'";
                        ...
                        ?>
							<tr>
							  <td>SMS Header </td>
							  <td><label for=""></label>
						      <input name="header" type="text" id="header" value="<?php echo $smsfound['msg_head'];?>" readonly="readonly" /></td>
							  <td></td>
						  </tr>
							<tr>
                               ...
                               <td><label for=""></label>
                                 <textarea name="message" readonly="readonly" id="message"><?php echo $smsfound['msg_details'];?></textarea>
							...
							<tr>
						      ...
						      <input name="footer" type="text" id="footer" value="<?php echo $smsfound['shortname'];?>" readonly="readonly"/></td>
							  <td></td>
						  </tr>
						</tbody>
					</table>
						...
						<tbody>
							<tr>
								...
								<td>
                                     ...
                                     <textarea name="message" cols="45" rows="3" readonly="readonly" id="message" onKeyDown="textCounter(document.myForm.message,document.myForm.remLen1,70)" onKeyUp="textCounter(document.myForm.message,document.myForm.remLen1,70)">
