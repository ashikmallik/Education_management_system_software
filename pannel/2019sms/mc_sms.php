...
<head>
    ...
    <script language="javascript">
		function callpage()
		{
		 document.frmart.action="mc_sms.php";
	...
	<div class="left_fixed">
		<div class="logo_top">
		  <a href="index.php"><img src="images/indiv/sms.jpg" height="80px" width="120px"></a>
			<a href=""><img src="../../images/sms/in14.jpg" height="80px" width="120px"></a>
		</div>
	...
	<div class="main_content_ind">
		<div class="sm_main_part">
			<div class="in_form">
                ...
                <br><br>				
                <form name="myForm" action="mc_sms_do.php" method="post" enctype="multipart/form-data">
...
<input readonly type="text" name="remLen1" size="3" maxlength="3" value="<?php echo $shextlimit['english_limit']; ?>">
 ...
 $gtstudent="select * from borno_gb_info where borno_school_id='$schId' order by borno_gb_info_id asc";
	...
	while($shroll=$qgtstudent->fetch_assoc()){ $sl++;
			   ...
			   ?>
					    ...
					    <tr>
					      <th><input class="chk" type="checkbox" name="stPhone[]" id="stPhone[]" value="<?php echo $shroll['borno_gb_phone'];?>"></th>
					    
					      <td><?php echo $shroll['borno_gb_name'];?></td>
                          <td><?php echo $shroll['borno_gb_desig'];?></td>
					      <td><?php echo $shroll['borno_gb_phone'];?></td>
