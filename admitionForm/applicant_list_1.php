...
<body>
	...
	function callpage()
	{
	 document.frmcontent.action="applicant_list_1.php";
...
<form name="frmcontent" method="post" enctype="multipart/form-data">
                                    ...
                                    <table id="data-table" class="table table-striped">
                                        <thead class="tableHead">
                                          <tr>
                                            ...
                                            <th scope="col" style="text-align: center;">SSC Roll</th>
                                          <th scope="col" style="text-align: center;">Student Phone</th>
                                          <th scope="col" style="text-align: center;">Father Phone</th>
    ...
    <?php
	  ...
	  if(!empty($group)){
  		$gtstudent="SELECT * FROM `admition_form1` WHERE `group` = '$group' GROUP BY `ssc_roll` ORDER BY `id` ASC";
		$sl=0;
  ...
  ?>
   <tr>
    ...
    <td  align="center"><?php echo $shqgtstudent['std_phone']; ?></td>
    <td  align="center"><?php echo $shqgtstudent['fmobile']; ?></td>
    ...
    <a href="print_app_form_1.php?sid=<?php echo $shqgtstudent['student_id']; ?>" target="_blank">Details View</a>
    </td>
  </tr>
