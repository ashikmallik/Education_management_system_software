...
$chekpaymnet="SELECT * FROM `Rocket_payment` WHERE `student_id` ='$sid' AND `result_code` = 00"; 
...
$cheksl ="SELECT * FROM `admition_form` WHERE `ssc_roll`='$sid'";
