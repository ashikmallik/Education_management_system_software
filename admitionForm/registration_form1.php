...
<body>
    <script language="javascript">
    	function callpage()
	{
	 document.frmcontent.action="registration_form1.php";
...
<div class="modal-content">
		      	...
		      	<div class="modal-body">
		        	<form action="registration_store1.php" method="post" enctype="multipart/form-data" name="frmcontent">
...
//echo $group;
                                ...
                                ?>              
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                              <label  class="col-sm-3 col-form-label">SSS Board</label>
                                              <div class="col-sm-8">
                                      ...
                                      <?php }
                                        ...
                                        ?> 
                                         ...
                                         <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                              <label  class="col-sm-3 col-form-label">Bath Reg. No.</label>
                                              <div class="col-sm-8">
                                                  <input type="text" id="bath_reg_no" name="bath_reg_no"  class="form-control"size="27" placeholder="input Bath Reg. No." required >
                                              </div>
                                            </div>
