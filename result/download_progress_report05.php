...
$gtschoolsignature=$sqgtschoolName['signature'];
	...
	$finalgtschoolsignature="../pannel/academic/teacher/signature/$gtschoolsignature";
	
	} else {
		$finalgtschoolsignature="../pannel/academic/teacher/signature/nophoto.jpg";
		}
...
//	$finalgtschoolsignature1=$GLOBALS['finalgtschoolsignature'];
    ...
    $this->Image($finalgtschoolsignature1,158,273,35,10);
...
// 	$this->Ln();
	...
	$this->Cell(70,3,"Mohammad Mahfuzur Rahman Khan",0,0,"C"); 
	$this->Ln();
	$this->Cell(60,5,"",0,0,"C"); 
	$this->Cell(70,5,"In-Charge(College)",0,0,"C"); 
	$this->Cell(70,5,$GLOBALS['fnshead'],0,0,"C");
