...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../pannel/academic/assets/css/style.css">
    <link rel="stylesheet" type="text/css" href="../../pannel/academic/assets/css/font-awesome.css">
    <!-- Meta tag -->
    <meta charset="utf-8">
...
<div class="wrapper">
    <div class="side_main_menu">
        ...
        <div class="fixed_logo">
            <a href=""><img src="../../pannel/academic/assets/images/logo.jpg" class="img-fluid"></a>
        </div>
    </div><!-- side bar end -->
    ...
    <div class="ot_main_content">
        <div class="admin_logout">
            <div class="admin_head">
               <h3>Fees Report [<?php echo $shget_schoolName['borno_school_name']; ?>]</h3>
            </div>
            <div class="log_out">
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2>Collection Report of Student </h2></div>
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="download_collection_receipt_csv.php" method="post" enctype="multipart/form-data" target="_blank">
                        <?php
			$msg=$_GET['msg'];
 ...
 ?>
    ...
    <td><input type="text" name="datepicker1" id="datepicker1" value="<?php echo $cdate; ?>"></td>
  </tr>                                   
                            
                            
        
   <tr>
<td colspan="2" align="center"><input type="submit" name="button" id="button" value="Download" onClick="return contalt_valid()"></td>
  </tr>
