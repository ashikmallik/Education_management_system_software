...
$this->Ln();
$this->Cell(280,5,"Due History-1",0,0,"C");
$this->Ln();
...
$memo1 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid1 AND borno_school_sub_fund_id=$subfundid1";
		$qmemo1=$mysqli->query($memo1);
		$shgmemo1=$qmemo1->fetch_assoc();
		$fees1=$shgmemo1['borno_school_fee'];  
if($fees1!="0"){$pdf->Cell(10,5,$fees1,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo2 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid2 AND borno_school_sub_fund_id=$subfundid2";
		$qmemo2=$mysqli->query($memo2);
		$shgmemo2=$qmemo2->fetch_assoc();
		$fees2=$shgmemo2['borno_school_fee'];  
if($fees2!="0"){$pdf->Cell(10,5,$fees2,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo3 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid3 AND borno_school_sub_fund_id=$subfundid3";
		$qmemo3=$mysqli->query($memo3);
		$shgmemo3=$qmemo3->fetch_assoc();
		$fees3=$shgmemo3['borno_school_fee'];  
if($fees3!="0"){$pdf->Cell(10,5,$fees3,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo4 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid4 AND borno_school_sub_fund_id=$subfundid4";
		$qmemo4=$mysqli->query($memo4);
		$shgmemo4=$qmemo4->fetch_assoc();
		$fees4=$shgmemo4['borno_school_fee'];  
if($fees4!="0"){$pdf->Cell(10,5,$fees4,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo5 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid5 AND borno_school_sub_fund_id=$subfundid5";
		$qmemo5=$mysqli->query($memo5);
		$shgmemo5=$qmemo5->fetch_assoc();
		$fees5=$shgmemo5['borno_school_fee'];  
if($fees5!="0"){$pdf->Cell(10,5,$fees5,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo6 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid6 AND borno_school_sub_fund_id=$subfundid6";
		$qmemo6=$mysqli->query($memo6);
		$shgmemo6=$qmemo6->fetch_assoc();
		$fees6=$shgmemo6['borno_school_fee'];  
if($fees6!="0"){$pdf->Cell(10,5,$fees6,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo7 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid7 AND borno_school_sub_fund_id=$subfundid7";
		$qmemo7=$mysqli->query($memo7);
		$shgmemo7=$qmemo7->fetch_assoc();
		$fees7=$shgmemo7['borno_school_fee'];  
if($fees7!="0"){$pdf->Cell(10,5,$fees7,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo8 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid8 AND borno_school_sub_fund_id=$subfundid8";
		$qmemo8=$mysqli->query($memo8);
		$shgmemo8=$qmemo8->fetch_assoc();
		$fees8=$shgmemo8['borno_school_fee'];  
if($fees8!="0"){$pdf->Cell(10,5,$fees8,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo9 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid9 AND borno_school_sub_fund_id=$subfundid9";
		$qmemo9=$mysqli->query($memo9);
		$shgmemo9=$qmemo9->fetch_assoc();
		$fees9=$shgmemo9['borno_school_fee'];  
if($fees9!="0"){$pdf->Cell(10,5,$fees9,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo10 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid10 AND borno_school_sub_fund_id=$subfundid10";
		$qmemo10=$mysqli->query($memo10);
		$shgmemo10=$qmemo10->fetch_assoc();
		$fees10=$shgmemo10['borno_school_fee'];  
if($fees10!="0"){$pdf->Cell(10,5,$fees10,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo11 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid11 AND borno_school_sub_fund_id=$subfundid11";
		$qmemo11=$mysqli->query($memo11);
		$shgmemo11=$qmemo11->fetch_assoc();
		$fees11=$shgmemo11['borno_school_fee'];  
if($fees11!="0"){$pdf->Cell(10,5,$fees11,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo12 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid12 AND borno_school_sub_fund_id=$subfundid12";
		$qmemo12=$mysqli->query($memo12);
		$shgmemo12=$qmemo12->fetch_assoc();
		$fees12=$shgmemo12['borno_school_fee'];  
if($fees12!="0"){$pdf->Cell(10,5,$fees12,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo13 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid13 AND borno_school_sub_fund_id=$subfundid13";
		$qmemo13=$mysqli->query($memo13);
		$shgmemo13=$qmemo13->fetch_assoc();
		$fees13=$shgmemo13['borno_school_fee'];  
if($fees13!="0"){$pdf->Cell(10,5,$fees13,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo14 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid14 AND borno_school_sub_fund_id=$subfundid14";
		$qmemo14=$mysqli->query($memo14);
		$shgmemo14=$qmemo14->fetch_assoc();
		$fees14=$shgmemo14['borno_school_fee'];  
if($fees14!="0"){$pdf->Cell(10,5,$fees14,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo15 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid15 AND borno_school_sub_fund_id=$subfundid15";
		$qmemo15=$mysqli->query($memo15);
		$shgmemo15=$qmemo15->fetch_assoc();
		$fees15=$shgmemo15['borno_school_fee'];  
if($fees15!="0"){$pdf->Cell(10,5,$fees15,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo16 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid16 AND borno_school_sub_fund_id=$subfundid16";
		$qmemo16=$mysqli->query($memo16);
		$shgmemo16=$qmemo16->fetch_assoc();
		$fees16=$shgmemo16['borno_school_fee'];  
if($fees16!="0"){$pdf->Cell(10,5,$fees16,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo17 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid17 AND borno_school_sub_fund_id=$subfundid17";
		$qmemo17=$mysqli->query($memo17);
		$shgmemo17=$qmemo17->fetch_assoc();
		$fees17=$shgmemo17['borno_school_fee'];  
if($fees17!="0"){$pdf->Cell(10,5,$fees17,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo18 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid18 AND borno_school_sub_fund_id=$subfundid18";
		$qmemo18=$mysqli->query($memo18);
		$shgmemo18=$qmemo18->fetch_assoc();
		$fees18=$shgmemo18['borno_school_fee'];  
if($fees18!="0"){$pdf->Cell(10,5,$fees18,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$memo19 ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' AND borno_school_fund_id=$fundid19 AND borno_school_sub_fund_id=$subfundid19";
		$qmemo19=$mysqli->query($memo19);
		$shgmemo19=$qmemo19->fetch_assoc();
		$fees19=$shgmemo19['borno_school_fee'];  
if($fees19!="0"){$pdf->Cell(10,5,$fees19,1,0,"C");}
else{$pdf->Cell(10,5,'',1,0,"C");}

$amount=0;
$total = array();
$totalamount ="select * from borno_school_balance where borno_student_info_id='$studentid' AND borno_school_session='$stsess' order by borno_school_fund_id,borno_school_sub_fund_id asc";
...
$memo191 ="select SUM(borno_school_fee) As total from borno_school_balance where borno_school_session='$stsess' AND borno_school_section_id='$section'";
