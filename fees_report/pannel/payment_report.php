...
<script language="javascript">
 ...
 // $shiftId=$_POST['shiftId'];
  ...
  <tr align="center">
    <td class="text_table" align="center"><a href="download_payment_list.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download Payment History-1</a></td>
  </tr>

  <tr align="center">
    <td class="text_table" align="center"><a href="download_payment_list_2.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&studClass=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&section=<?php echo $section; ?>&stsess=<?php echo $stsess; ?>" target="_blank">Download Payment History-2</a></td>
  </tr>
