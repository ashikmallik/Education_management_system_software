...
<script language="javascript">
	...
	function callpage()
	{
	 document.frmcontent.action="income_expence_report.php";
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2>Income Expence Report</h2></div>
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="download_income_expence_report.php" method="post" enctype="multipart/form-data" target="_blank">
                        <?php
			$msg=$_GET['msg'];
