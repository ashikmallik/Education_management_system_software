...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="process_result_mainartek.php";
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2> Process Average Result </h2></div>
                <div class="form">
...
<form name="frmcontent" id="myform" action="process_result_mainartek_do.php" method="post" enctype="multipart/form-data">
