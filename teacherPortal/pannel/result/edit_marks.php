...
<table width="650" border="0" cellspacing="0" cellpadding="0" class="projectlist" align="center">
    ...
    <td><select name="section" id="section" onchange="callpage();">
      ...
      <?php
					...
					$gstsection="select * from borno_school_section where borno_school_class_id='$studClass' AND borno_school_branch_id='$gtfbranchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId'";
					    ...
					    $gstsection="select * from borno_school_section where borno_school_section_id IN (SELECT borno_school_section_id FROM `borno_set_class_teacher` WHERE `borno_school_teacher_id`='$teacherid' AND borno_school_shift_id='$shiftId') ";
					}
  ...
  <td><strong>Select Group *</strong></td>
    <td align="center"><strong>:</strong></td>
     <td><select name="group" id="group" onchange="callpage();">
      ...
      <option value="2" <?php if($_REQUEST['group']==2) { echo "selected"; } ?>> Business </option>
  ...
  <tr>
    ...
    <td><select name="roll1" id="roll1" onchange="callpage();">
	  ...
	  ?>
        <option value="<?php echo $shschexroll['borno_school_roll']; ?>" <?php if($shschexroll['borno_school_roll']==$_REQUEST['roll1']) { echo "selected"; } ?>><?php echo $shschexroll['borno_school_roll']; ?></option>
  ...
  <tr>
    ...
    <td><select name="roll2" id="roll2" onchange="callpage();">
        ...
        <?php
			...
			while($shschexroll=$qschexroll->fetch_assoc()){
	  ?>
        <option value="<?php echo $shschexroll['borno_school_roll']; ?>" <?php if($shschexroll['borno_school_roll']==$_REQUEST['roll2']) { echo "selected"; } ?>><?php echo $shschexroll['borno_school_roll']; ?></option>
...
$stusubjId=$_POST['stusubjId'];
  ...
  <tr>
	...
	<option value="1" <?php if($shgtctmarg['attendence_status']==1) { echo "selected"; } ?>>Present</option>
	<option value="0"<?php if($shgtctmarg['attendence_status']==0) { echo "selected"; } ?>>Absent</option>

</select>
    </td>        
    <td align="center">
        <?php if($shgtctmarg['temp_res_number_type1'] == 0){ ?>
                    <input name="ntype1[]" type="text" id="ntype1[]" size="1"  tabindex=<?php echo $sal; ?>>
        <?php } else{ ?>
    ...
    <td align="center">
                      ...
                      <?php if($shgtctmarg['temp_res_number_type2'] == 0){ ?>
                    <input name="ntype2[]" type="text" id="ntype2[]" size="1"  tabindex=<?php echo $sal+250; ?>>
        <?php } else{ ?>
    ...
    <td align="center">
                      ...
                      <?php if($shgtctmarg['temp_res_number_type3'] == 0){ ?>
                    <input name="ntype3[]" type="text" id="ntype3[]" size="1"  tabindex=<?php echo $sal+500; ?>>
        <?php } else{ ?>
    ...
    <td align="center">
                      ...
                      <?php if($shgtctmarg['temp_res_number_type4'] == 0){ ?>
                    <input name="ntype4[]" type="text" id="ntype4[]" size="1"  tabindex=<?php echo $sal+750; ?>>
        <?php } else{ ?>
  ...
  <tr>
    ...
    <td align="center">
        <?php if($shgtctmarg['temp_res_number_type1'] == 0){ ?>
                    <input name="ntype1[]" type="text" id="ntype1[]" size="1"  tabindex=<?php echo $sl; ?>>
        <?php } else{ ?>
    ...
    <td align="center">
                      ...
                      <?php if($shgtctmarg['temp_res_number_type2'] == 0){ ?>
                    <input name="ntype2[]" type="text" id="ntype2[]" size="1"  tabindex=<?php echo $sl+250; ?>>
        <?php } else{ ?>
    ...
    <td align="center">
                      ...
                      <?php if($shgtctmarg['temp_res_number_type3'] == 0){ ?>
                    <input name="ntype3[]" type="text" id="ntype3[]" size="1"  tabindex=<?php echo $sl+500; ?>>
        <?php } else{ ?>
    ...
    <td align="center">
                      ...
                      <?php if($shgtctmarg['temp_res_number_type4'] == 0){ ?>
                    <input name="ntype4[]" type="text" id="ntype4[]" size="1"  tabindex=<?php echo $sl+750; ?>>
        <?php } else{ ?>
  ...
  <tr>
    ...
    <td align="center">
        <?php if($shgtctmarg['temp_res_number_type1'] == 0){ ?>
                    <input name="ntype1[]" type="text" id="ntype1[]" size="1"  tabindex=<?php echo $sbl; ?>>
        <?php } else{ ?>
    ...
    <td align="center">
                      ...
                      <?php if($shgtctmarg['temp_res_number_type2'] == 0){ ?>
                    <input name="ntype2[]" type="text" id="ntype2[]" size="1"  tabindex=<?php echo $sbl+250; ?>>
        <?php } else{ ?>
    ...
    <td align="center">
                      ...
                      <?php if($shgtctmarg['temp_res_number_type3'] == 0){ ?>
                    <input name="ntype3[]" type="text" id="ntype3[]" size="1"  tabindex=<?php echo $sbl+500; ?>>
        <?php } else{ ?>
    ...
    <td align="center">
                      ...
                      <?php if($shgtctmarg['temp_res_number_type4'] == 0){ ?>
                    <input name="ntype4[]" type="text" id="ntype4[]" size="1"  tabindex=<?php echo $sbl+750; ?>>
        <?php } else{ ?>
