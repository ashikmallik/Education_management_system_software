...
function Header()
{
	...
	$finalSchoolLogo1="logo_for_result.jpg";
...
function Footer()
{
    ...
    $this->Image($finalgtschoolsignature1,240,185,30,10);
    
    $branchId1 = $GLOBALS['branchId']; 
    $shiftId1 = $GLOBALS['shiftId'];
    $studClass1 = $GLOBALS['studClass'];
    $section = $GLOBALS['section'];
    if($branchId1 == 1){
        if($section == 65 OR $section == 66 OR $section == 69 OR $section == 70 OR $section == 74 OR $section == 83 OR $section == 84  OR $section == 79 OR $section == 88 OR $section == 89 OR $section == 94 OR $section == 98 OR $section == 99 OR $section == 109 OR $section == 110 OR $section == 117 OR $section == 122 OR $section == 130 OR $section == 135 OR $section == 143 OR $section == 149 OR $section == 157 OR $section == 164 OR $section == 173){
            $assit_head = "hilaliMEv.jpg";
        }
        
        else{
        if($studClass1 == 13 OR $studClass1 == 14 OR $studClass1 == 15 OR $studClass1 == 6 OR $studClass1 == 10){
    if($shiftId1 == 2){
            
            $assit_head = "lubnamp.jpg";
        }
        else{
            $assit_head = "romesdp.jpg";
        }
        }
        else{
        if($shiftId1 == 2){
            
            $assit_head = "sig_ah_motijheel_model_morning.jpg";
        }
        else{
            $assit_head = "sig_ah_motijheel_model_day.jpg";
        }
        } 
        }
    }
        ...
        if($shiftId1 == 2){
            $assit_head = "sig_ah_basabo_motijheel_model.jpg";
        }
        else{
            $assit_head = "IMG-20220910-WA0001.jpg";
        }
        
        }
    }
    
    $this->Image($assit_head,150,185,30,10);
	...
	$this->Ln();
	$this->Cell(50,5,"Guardian's Signature",0,0,"C"); 
	$this->Cell(10,1,"",0,0,"C");
 if( $schId!=94)

{ 
$this->Cell(50,5,"Class Teacher's Signature",0,0,"C");
$this->Cell(15,1,"",0,0,"C");
  ...
  $this->Cell(90,5,"Class In-charge  Signature",0,0,"C");  
    ...
    $this->Cell(70,5,"Assistant Headmaster's Signature",0,0,"C");
$this->Cell(10,1,"",0,0,"C");
	    	$this->Cell(35,5,$GLOBALS['fnshead'],0,0,"R");
	$this->Cell(35,5," Signature",0,0,"L"); 
...
$pdf->Cell(220,5,"Student Name : $fstname",0,0,"L");
...
$pdf->SetFont('Arial','I',10);
$pdf->Cell(41,7,$gtstotal111,0,0,"L");
}
else{
...
$pdf->SetFont('Arial','',10);
$pdf->Cell(20,5,"Exam Type :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->Cell(58,5,$fnsterm,0,0,"L");
...
$pdf->Ln();
$pdf->SetFont('Arial','',10);
$numbertype ="select * from borno_result_number_type where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$term'";
		...
		$pdf->Cell(19,5,$type1,1,0,"C");
		$pdf->Cell(19,5,$type2,1,0,"C");
		$pdf->Cell(19,5,$type3,1,0,"C");
		$pdf->Cell(19,5,$type4,1,0,"C");
		$pdf->Cell(19,5,"CQ Conv",1,0,"C");
		$pdf->Cell(19,5,"MCQ Conv",1,0,"C");
		$pdf->Cell(19,5,"Prac Conv",1,0,"C");
...
if($uncountable!=""){goto lastline2;}
		...
		$stN5=round($row['temp_res_number_type1_covn']);
		$stN6=round($row['temp_res_number_type2_covn']);
		$stN7=round($row['temp_res_number_type3_covn']);
if($schId == 1){
...
$pdf->SetFont('Arial','',10);
		...
		$pdf->Cell(203,5,"GrandTotal / GPA With 4th Subject",1);
...
$pdf->Ln();
$pdf->Cell(203,5,"GrandTotal / GPA Without 4th Subject",1);
if( $schId == 1){
...
$pdf->Cell(283,5,"4th Subject Name : $fsstgtsubject4th",1);
}
else
{
				
$pdf->Cell(283,5,"4th Subject Name : ",1);
}
$pdf->Ln();	
...
$pdf->SetFont('Arial','I',10);
$pdf->Cell(60,5,$fnsterm,0,0,"L");
$pdf->SetFont('Arial','',10);
$pdf->Cell(20,5,"Exam Year :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->Cell(39,5,$stsess,0,0,"L");
...
$pdf->Ln();
 $gtstotalban ="select * from borno_class6_8_temp_mark1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=18";
		            ...
		            $stNbangla5=round($sqgtstotalban['temp_res_number_type1_covn']);
		            $stNbangla6=round($sqgtstotalban['temp_res_number_type2_covn']);
		            $stNbangla7=$sqgtstotalban['temp_res_number_type7_conv'];
...
$gtsubjectb ="select * from borno_subject_six_eight where subject_id_six_eight=$stNbangla";
 ...
 $gtsubject1b ="select * from borno_set_subject_six_eight where borno_school_class_id=$studClass AND borno_school_id=$schId AND borno_school_session=$stsess AND subject_id_six_eight=$stNbangla AND borno_result_term_id='$term'";
...
$subjectdetailsb ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$term' AND subject_id_six_eight='$stNbangla'";
        ...
        if($subtypeb1!=0)
		{		
		 $pdf->Cell(19,5,$stNbangla1,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		if($subtypeb2!=0)
		{		
		$pdf->Cell(19,5,$stNbangla2,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		if($subtypeb3!=0)
		{		
	   $pdf->Cell(19,5,$stNbangla3,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		if($schId==134){
		    if($subtypeb4!=0)
		{		
		$pdf->Cell(19,5,$stNbangla4,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		if($stNbangla5!=0)
		{		
		$pdf->Cell(19,5,$stNbangla5,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		if($stNbangla6!=0)
		{		
		$pdf->Cell(19,5,$stNbangla6,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
				...
				if($stNbangla7!=0)
		{		
		$pdf->Cell(19,5,$stNbangla7,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		$pdf->Cell(25,5,$stNamebanh,1,0,"C");	
		if( $schId == 1){
		    		$pdf->Cell(15,5,'',1,0,"C");
		$pdf->Cell(15,5,'',1,0,"C");	
		}
...
$pdf->Ln();    
 ...
 $gtstotaleng ="select * from borno_class6_8_temp_mark1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=19";
		            ...
		            $stNenglish5=round($sqgtstotaleng['temp_res_number_type1_covn']);
		            $stNenglish6=round($sqgtstotaleng['temp_res_number_type2_covn']);
		            $stNenglish7=$sqgtstotaleng['temp_res_number_type7_covn'];
...
$gtsubjecte ="select * from borno_subject_six_eight where subject_id_six_eight=$stNenglish";
 ...
 $gtsubject1e ="select * from borno_set_subject_six_eight where borno_school_class_id=$studClass AND borno_school_id=$schId AND borno_school_session=$stsess AND subject_id_six_eight=$stNenglish AND borno_result_term_id='$term'";
...
$subjectdetailse ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$term' AND subject_id_six_eight='$stNenglish'";
		...
		if($subtypee1!=0)
		{		
		$pdf->Cell(19,5,$stNenglish1,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		if($subtypee2!=0)
		{		
		$pdf->Cell(19,5,$stNenglish2,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		if($subtypee3!=0)
		{		
		$pdf->Cell(19,5,$stNenglish3,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		if($subtypee4!=0)
		{		
		$pdf->Cell(19,5,$stNenglish4,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		if($stNenglish5!=0)
		{		
		$pdf->Cell(19,5,$stNenglish5,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		if($stNenglish6!=0)
		{		
		$pdf->Cell(19,5,$stNenglish6,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
				...
				if($stNenglish7!=0)
		{		
		$pdf->Cell(19,5,$stNenglish7,1,0,"C");
		}
		else
		{
		$pdf->Cell(19,5,'-',1,0,"C");
		...
		$pdf->Cell(25,5,$stNameengh,1,0,"C");
				if( $schId == 1){
		    		$pdf->Cell(15,5,'',1,0,"C");
		$pdf->Cell(15,5,'',1,0,"C");	
		}
...
$shgetsubcount=$qgetsubjcoun->fetch_assoc();		
		...
		$stN3=$row['temp_res_number_type3'];
		$stN4=$row['temp_res_number_type4'];
		if($term==53 OR $term==54 OR $term==55){
		$stN5=0;
		$stN6=0;
		$stN7=0; 
		}
		...
		$stN5=round($row['temp_res_number_type1_covn']);
		$stN6=round($row['temp_res_number_type2_covn']);
		$stN7=round($row['temp_res_number_type7_covn']);
...
$gtsubject1 ="select * from borno_set_subject_six_eight where borno_school_class_id=$studClass AND borno_school_id=$schId AND borno_school_session=$stsess AND subject_id_six_eight=$stN AND borno_result_term_id='$term'";
...
$pdf->SetFont('Arial','',12);
		...
		$pdf->Cell(203,6,"GrandTotal / GPA",1);
...
$s11l=0;
					...
					while($rowun12=$qresultun12->fetch_assoc()) { $s11l++;
...
$pdf->Cell(21,5,"Exam Type :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->Cell(55,5,$fnsterm,0,0,"L");
$pdf->SetFont('Arial','',10);
$pdf->Cell(20,5,"Exam Year :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->Cell(44,5,$stsess,0,0,"L");
...
$numbertype ="select * from borno_result_number_type where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$term'";
		...
		$pdf->Cell(23,5,"Total Mark",1,0,"C");
		$pdf->Cell(24,5,"Highest Mark",1,0,"C");
		$pdf->Cell(15,5,'GP',1,0,"C");
		$pdf->Cell(15,5,'LG',1,0,"C");
 ...
 $result = "select * from borno_class1_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' order by borno_result_subject_id asc";
$sl=0;
...
// 		$stN7=$row['temp_res_number_type6'];
...
//	echo $stN1." ";echo $stN2."<br>";
		
	
		$gtsubject ="select * from borno_result_subject where borno_school_class_id=$studClass AND borno_school_id=$schId AND borno_school_session=$stsess AND borno_result_subject_id=$stN AND borno_result_term_id='$term'";
					$qgtsubject=$mysqli->query($gtsubject);
					$stgtsubject=$qgtsubject->fetch_assoc();
...
$gtsubject1 ="select * from borno_result_subject where borno_school_class_id=$studClass AND borno_school_id=$schId AND borno_school_session=$stsess AND borno_result_subject_id=$stN AND borno_result_term_id='$term'";
					$qgtsubject1=$mysqli->query($gtsubject1);
					$stgtsubject1=$qgtsubject1->fetch_assoc();
...
$result22 = "select * from borno_maxnumber_class1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_result_subject_id=$stN";
		...
		$pdf->Cell(11.5,5,$stName,1,0,"C");
		$pdf->Cell(11.5,10,$stName1,1,0,"C");
        $pdf->Cell(24,5,$fssthigh,1,0,"C");
		$pdf->Cell(15,10,$stphone,1,0,"C");
		$pdf->Cell(15,10,$stgp,1,0,"C");
		$pdf->Cell(15,5,'',2,0,"C");
			$pdf->Ln();
		...
		$pdf->Cell(23,5,$stName,1,0,"C");
        $pdf->Cell(24,5,$fssthigh,1,0,"C");
        // if($studClass == 13 OR $studClass == 14 OR $studClass == 15 OR $studClass == 6){
            		$pdf->Cell(15,5,'',1,0,"C");
		$pdf->Cell(15,5,'',1,0,"C");
      //  }
//         else{
...
$subjectdetailsun ="select * from borno_result_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$term' AND borno_result_subject_id='$stNun'";
	...
	//	$pdf->Cell(15,5,$convertun,1,0,"C");
        ...
        $pdf->Cell(23,5,$sttotal,1,0,"C");	
		$pdf->Cell(24,5,$fssthighun,1,0,"C");
	        if($schId == 1){
		$pdf->Cell(15,5,'',1,0,"C");
		$pdf->Cell(15,5,'',1,0,"C");
        }
