...
<table width="650" border="0" cellspacing="0" cellpadding="0" class="projectlist" align="center">
  ...
  <tr>
    ...
    <td><select name="stsess" id="stsess">
      <option value="2021" <?php if($stsess==2021) { echo "selected"; } ?>> 2021 </option>
            <option value="2022" <?php if($stsess==2022) { echo "selected"; } ?>> 2022 </option>
      <option value="2023" <?php if($stsess==2023) { echo "selected"; } ?>> 2023 </option>
    </select></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><select name="stusubjId" id="stusubjId" onchange="callpage();">
      ...
      <?php }}   else
	  {
			$gsubjName="select * from borno_result_subject where borno_school_class_id='$studClass' AND borno_school_id='$schoolId' AND borno_school_session='$stsess'";
			$qgsubjName=$mysqli->query($gsubjName);
			while($shgsubjName=$qgsubjName->fetch_assoc()){
		?>
      <option value="<?php echo $shgsubjName['borno_result_subject_id']; ?>" <?php if($shgsubjName['borno_result_subject_id']==$stusubjId) { echo "selected"; } ?>> <?php echo $shgsubjName['borno_school_subject_name']; ?></option>
      <?php }}  ?>    </select></td>
  </tr>
</table>
