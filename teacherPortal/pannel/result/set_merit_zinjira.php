...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="set_merit_zinjira.php";
...
<form name="frmcontent" id="myform" action="set_merit_zinjira_do.php" method="post" enctype="multipart/form-data">
