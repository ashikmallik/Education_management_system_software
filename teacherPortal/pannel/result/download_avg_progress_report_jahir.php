...
function Header()
{
    ...
    // Line break
    //$this->Ln(20);
	$finalSchoolheader=$GLOBALS['finalLogo'];	
	$finalSchoolLogo1=$GLOBALS['finalSchoolLogo'];
 
    $this->Image($finalSchoolheader,8,1,220,31);
    $this->Image($finalSchoolLogo1,15,5,25,25);
...
$pdf->Cell(60,4,"Grading System",1,0,"C",1);
...
$pdf->SetFont('Arial','',7); 
$pdf->setFillColor(250,200,0); 
$pdf->Cell(28,4,"Range",1,0,"C",1);
$pdf->Cell(12,4,"Grade",1,0,"C",1);
$pdf->Cell(20,4,"Grade Point",1,0,"C",1);
$pdf->Ln();

if ($schId==69){

$pdf->SetFont('Arial','',12); 
$pdf->Cell(220,2,"email : netragov.girlshschool@ymail.com",0,0,"C");
}
elseif($schId==81){
    $pdf->SetFont('Arial','',12);
...
$pdf->SetFont('Arial','',12);     
$pdf->Cell(220,2,"Bhairab, Kishoreganj",0,0,"C");    
}
...
$pdf->Image("$stphotofina", 198, 3, 24, 24); 
		$pdf->SetFont('Arial','',7);  
...
$pdf->Ln();
$pdf->SetFont('Arial','',12);
$pdf->Cell(219,14,"",1,0,"L");
$pdf->Cell(1,2,"",0,0,"L");

$pdf->Ln();
$pdf->SetFont('Arial','',12);
		        $pdf->setTextColor(0,150,300);
$pdf->Cell(40,1,"Progress Report of :",0,0,"L");
$pdf->setTextColor(0,0,0);
$pdf->Cell(179,1,"$fstname",0,0,"L");
$pdf->Cell(1,2,"",0,0,"L");
		$pdf->SetFont('Arial','',7);  
...
$pdf->setTextColor(0,0,0);
$pdf->Cell(40,5,$gtstdid,0,0,"L");
$pdf->SetFont('Arial','',10);
$pdf->setTextColor(0,150,300);
$pdf->Cell(10,5,"Roll :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->setTextColor(0,0,0);
$pdf->Cell(30,5,$gtstotal111,0,0,"L");
$pdf->SetFont('Arial','',10);
$pdf->setTextColor(0,150,300);
...
$pdf->SetFont('Arial','',10);
$pdf->setTextColor(0,150,300);
$pdf->Cell(12,5,"Shift  :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->setTextColor(0,0,0);
$pdf->Cell(38,5,$fnsshift,0,0,"L");
...
$pdf->SetFont('Arial','I',10);
$pdf->setTextColor(0,0,0);
$pdf->Cell(71,5,$fnssection,0,0,"L");
$pdf->SetFont('Arial','',10);
$pdf->setTextColor(0,150,300);
...
$pdf->SetFont('Arial','',10);
$pdf->setTextColor(0,150,300);
$pdf->Cell(21,5,"Exam Year :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->setTextColor(0,0,0);
$pdf->Cell(38,5,$stsess,0,0,"L");
...
$numbertype ="select * from borno_result_number_type where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass'";
        ...
        $pdf->setFillColor(150,250,0); 
		$pdf->Cell(39,10,"Subject Name",1,0,"L",1);
		$pdf->Cell(9,5,"Full",1,0,"C",1);
		$pdf->Cell(77,5,$termname1,1,0,"C",1);
		$pdf->Cell(77,5,$termname2,1,0,"C",1);
		$pdf->Cell(78,5,"Average Result",1,0,"C",1);
$pdf->Ln();	
		$pdf->Cell(39,5,"",0);	
		$pdf->Cell(9,5,"Mark",0,0,"C",1);
		$pdf->Cell(8,5,$type1,1,0,"C",1);
		$pdf->Cell(8,5,$type2,1,0,"C",1);
		$pdf->Cell(8,5,$type3,1,0,"C",1);
		$pdf->Cell(8,5,$type4,1,0,"C",1);
		$pdf->Cell(8,5,$type5,1,0,"C",1);
		$pdf->Cell(8,5,$type6,1,0,"C",1);
		$pdf->Cell(14,5,"Total",1,0,"C",1);
		$pdf->Cell(8,5,'GP',1,0,"C",1);
		$pdf->Cell(7,5,'LG',1,0,"C",1);
		$pdf->Cell(8,5,$type1,1,0,"C",1);
		$pdf->Cell(8,5,$type2,1,0,"C",1);
		$pdf->Cell(8,5,$type3,1,0,"C",1);
		$pdf->Cell(8,5,$type4,1,0,"C",1);
...
$getsubjstatus1="select * from borno_result_nine_ten_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$termid2' AND borin_subject_nine_ten_id='$stN' AND uncountable=1";
...
$resultterm1 = "select * from borno_class9_10_temp_mark1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid1' AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND borno_subject_nine_ten_id='$stN'";
 ...
 $resultterm2 = "select * from borno_class9_10_temp_mark1 where borno_school_class_id='$studClass' AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid2' AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND borno_subject_nine_ten_id='$stN'";
		...
		$gtsubject ="select * from borno_subject_nine_ten where borno_subject_nine_ten_id=$stN";
		 ...
		 $pdf->setFillColor(0,200,300); 
		$pdf->Cell(39,5,$fsstgtsubject,1,0,"L",1);
...
$subjectdetails ="select * from borno_result_nine_ten_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid2' AND borin_subject_nine_ten_id='$stN'";
		...
		$pdf->Cell(6,5,$stName1,1,0,"C",1);
		$pdf->Cell(8,10,$stNamef1,1,0,"C",1);
		...
		$pdf->Cell(6,5,$stName2,1,0,"C",1);
		$pdf->Cell(8,10,$stNamef2,1,0,"C",1);
		$pdf->Cell(8,10,$stphone2,1,0,"C");
		$pdf->Cell(7,10,$stgp2,1,0,"C");
		}
		elseif($stN!=$fsstgtsubject)
		...
		$pdf->Cell(7,5,$stName,1,0,"C",1);
		$pdf->Cell(8,10,$stNamef3,1,0,"C",1);
		...
		$pdf->Cell(7,5,$stName,1,0,"C",1);
		$pdf->Cell(8,10,$stNamef4,1,0,"C",1);
		$pdf->Cell(8,10,$stphone,1,0,"C");
		$pdf->Cell(7,10,$stgp,1,0,"C");
		$pdf->Cell(5,5,'',2,0,"C");
		}
...
$pdf->SetFont('Arial','',12);
		...
		$pdf->Cell(48,6,"GrandTotal / GPA",1,0,"L",1);
		$pdf->Cell(48,6,"",1,0,"L",1);
...
$fstlg1=$stggtstotalg1['finallg'];
		...
		$pdf->Cell(14,6,$fstotal,1,0,"C",1);
		$pdf->Cell(15,6,$fstotal1,1,0,"C",1);
...
$fstlg2=$stggtstotalg2['finallg'];
		...
		$pdf->Cell(48,6,'',1,0,"L",1);
		$pdf->Cell(14,6,$fstotal2,1,0,"C",1);
		$pdf->Cell(15,6,$fstotal12,1,0,"C",1);
...
$fstlg3=$stggtstotalg3['finallg'];
		...
		$pdf->Cell(48,6,'',1,0,"L",1);
		$pdf->Cell(15,6,$fstotal3,1,0,"C",1);
		$pdf->Cell(15,6,$fstotal13,1,0,"C",1);
	
$pdf->Ln();
$pdf->Cell(200,1,'',0,5,"C"); 
$pdf->SetFont('Arial','',9);

 $getsubjstatus1 = "select * from borno_result_nine_ten_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$termid2' AND uncountable=1 order by borin_subject_nine_ten_id asc";
$sl=0;

					$qgetsubjstatus1=$mysqli->query($getsubjstatus1);
					while($shgetsubjstatus1=$qgetsubjstatus1->fetch_assoc()) { $sl++;

				$stN=$shgetsubjstatus1['borin_subject_nine_ten_id'];

$result = "select * from borno_class9_10_average_mark1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='0' AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND borno_subject_nine_ten_id='$stN'";
...
$pdf->Cell(200,1,'',0,5,"C"); 
$pdf->SetFont('Arial','',9);
$pdf->setFillColor(0,250,200); 
$pdf->Cell(25,5,'Exam Name',1,0,"L",1);
$pdf->Cell(20,5,'Grand Total',1,0,"C",1);	
$pdf->Cell(10,5,'GPA',1,0,"C",1);	
$pdf->Cell(12,5,'Grade',1,0,"C",1);
$pdf->Cell(25,5,'Result Status',1,0,"C",1);
$pdf->Cell(40,5,"Merit Position in Section",1,0,"C",1);
$pdf->Cell(35,5,"Merit Position in Shift",1,0,"C",1);
$pdf->Cell(35,5,"Merit Position in Class",1,0,"C",1);
$pdf->Cell(23,5,'Total Student',1,0,"C",1);
$pdf->Cell(23,5,'Working Days',1,0,"C",1);
$pdf->Cell(16,5,'Presence',1,0,"C",1);
$pdf->Cell(16,5,'Absence',1,0,"C",1);	
$pdf->Ln();
...
$pdf->Ln();	
$pdf->setFillColor(50,300,0); 
$pdf->Cell(135,5,"Co-Educational Activities",1,0,"C",1);
$pdf->Cell(5,5,'',0);
$pdf->Cell(140,5,"Opinion about Result (Filled up by Class Teacher)",1,0,"C",1);
$pdf->Ln();	
$pdf->setFillColor(150,200,0);
$pdf->Cell(35,5,"Cultural Activities",1,0,"L",1);
$pdf->Cell(5,5,'',1);
$pdf->Cell(10,5,"BNCC",1,0,"L",1);
$pdf->Cell(5,5,'',1);
$pdf->Cell(15,5,"Debate",1,0,"L",1);
$pdf->Cell(5,5,'',1);
$pdf->Cell(15,5,"Scout",1,0,"L",1);
$pdf->Cell(5,5,'',1);
$pdf->Cell(15,5,"Sports",1,0,"L",1);
$pdf->Cell(5,5,'',1);
$pdf->Cell(15,5,"Others",1,0,"L",1);
$pdf->Cell(5,5,'',1);
$pdf->Cell(5,5,'',0);
...
$pdf->Ln();	
$pdf->setFillColor(50,300,0); 
$pdf->Cell(135,5,"Bahaviour",1,0,"C",1);
$pdf->Ln();	
$pdf->setFillColor(150,200,0);
$pdf->Cell(25,5,"Excellent",1,0,"L",1);
$pdf->Cell(8,5,'',1);
$pdf->Cell(25,5,"Very Good",1,0,"L",1);
$pdf->Cell(8,5,'',1);
$pdf->Cell(20,5,"Good",1,0,"L",1);
$pdf->Cell(8,5,'',1);
$pdf->Cell(33,5,"Need To Improve",1,0,"L",1);
$pdf->Cell(8,5,'',1);
$pdf->Ln();	
...
$resultterm1 = "select * from borno_class6_8_temp_mark1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid1' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight='$stN'";
 ...
 $resultterm2 = "select * from borno_class6_8_temp_mark1 where borno_school_class_id='$studClass' AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$termid2' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight='$stN'";
		...
		$gtsubject ="select * from borno_subject_six_eight where subject_id_six_eight=$stN";
		        ...
		        $pdf->setFillColor(0,200,300); 
		$pdf->Cell(39,5,$fsstgtsubject,1,0,"C",1);
...
$getsubuncoun = "select * from borno_result_six_eight_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$termid1' AND uncountable=1 order by subject_id_six_eight asc";
$sl=0;

					$qgetsubjcoun=$mysqli->query($getsubuncoun);
					while($shgetsubcount=$qgetsubjcoun->fetch_assoc()) { $sl++;

	//foreach($row as $column)
		
		$stroll=$s1;
		$stN=$shgetsubcount['subject_id_six_eight'];
