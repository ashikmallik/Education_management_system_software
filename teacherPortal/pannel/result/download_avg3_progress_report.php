...
$subjectdetails ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid3' AND subject_id_six_eight='$stN'";
...
$pdf->Ln();
 $gtstotalg4 ="select * from borno_school_68_avg_merit where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=0 AND borno_school_roll=$gtstotal111";
					$qgtstotalg4=$mysqli->query($gtstotalg4);
					$stggtstotalg4=$qgtstotalg4->fetch_assoc();
$pdf->SetFont('Arial','',12);
$fstotal4=$stggtstotalg4['grandtotal'];
$fstotal14=$stggtstotalg4['gpa'];
$fstlg4=$stggtstotalg4['finallg'];
...
$pdf->Cell(20,5,$fstotal4,1,0,"C");	
$pdf->Cell(10,5,$fstotal14,1,0,"C");	
$pdf->Cell(12,5,$fstlg4,1,0,"C");
if($fstotal12==0)
{
$pdf->Cell(25,5,'Failed',1,0,"C");
}
...
$subjectdetails ="select * from borno_result_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$termid3' AND borno_result_subject_id='$stN'";
					$qsubjectdetails=$mysqli->query($subjectdetails);
					$sqsubjectdetails=$qsubjectdetails->fetch_assoc();
...
$fstlg2=$stggtstotalg2['finallg'];
 ...
 $gtstotalg3 ="select * from borno_school_play_5_merit where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$termid3 AND borno_school_roll=$gtstotal111";
					$qgtstotalg3=$mysqli->query($gtstotalg3);
					$stggtstotalg3=$qgtstotalg3->fetch_assoc();
$pdf->SetFont('Arial','',12);
$fstotal3=$stggtstotalg3['grandtotal'];
...
$pdf->Ln();
 ...
 $gtstotalg4 ="select * from borno_school_play_5_avg_merit where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=0 AND borno_school_roll=$gtstotal111";
					$qgtstotalg4=$mysqli->query($gtstotalg4);
					$stggtstotalg4=$qgtstotalg4->fetch_assoc();
$pdf->SetFont('Arial','',12);
$fstotal4=$stggtstotalg4['grandtotal'];
