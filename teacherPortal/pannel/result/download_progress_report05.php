...
function Footer()
{
    ...
    if($branchId1 == 1){
        if($section == 65 OR $section == 66 OR $section == 73 OR $section == 74 OR $section == 81 OR $section == 83 OR $section == 84  OR $section == 93 OR $section == 94 OR $section == 102 OR $section == 103 OR $section == 114 OR $section == 115 OR $section == 128 OR $section == 129 OR $section == 142 OR $section == 143 OR $section == 156 OR $section == 157 OR $section == 164 OR $section == 173){
...
$subjectdetailsun ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$term' AND subject_id_six_eight='$stNun'";
		...
		$pdf->Cell(19,5,$fsstgtsubject1un,1,0,"C");
		if($subtypeun1!=0)
		{		
...
// 		$stN7=$row['temp_res_number_type6'];
		...
		$stN5=round($row['temp_res_number_type1_conv']);
		$stN6=$row['temp_res_number_type2_conv'];
		$stN7=$row['temp_res_number_type3_conv'];
...
$result22 = "select * from borno_maxnumber_class1 where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_result_subject_id=$stN";
		...
		$pdf->Cell(23,5,$stName,1,0,"C");
        $pdf->Cell(24,5,$fssthigh,1,0,"C");
        if($studClass == 13 OR $studClass == 14 OR $studClass == 15 OR $studClass == 6 OR $studClass == 10 ){
            		$pdf->Cell(15,5,'',1,0,"C");
		$pdf->Cell(15,5,'',1,0,"C");
        }
        else{
