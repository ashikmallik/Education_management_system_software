...
function Footer()
{
    ...
    $this->Image($finalgtschoolsignature1,220,180,15,15);
...
$numbertype ="select * from borno_result_number_type where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass'";
		...
		$pdf->Cell(15,5,'Convert',1,0,"C");
		$pdf->Cell(15,5,$type4,1,0,"C");
		$pdf->Cell(15,5,$type5,1,0,"C");
		$pdf->Cell(15,5,$type6,1,0,"C");
...
$getsubjstatus="select * from borno_result_nine_ten_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borin_subject_nine_ten_id='$stN'";
...
$convert=$stN1*$con1/100+$stN2*$con2/100+$stN3*$con3/100;		
...
$pdf->Cell(10,5,'',0,0,"L");
		$pdf->Cell(190,5,"GrandTotal / GPA",1);
...
$pdf->Cell(10,5,'',0,0,"L");
$pdf->Cell(270,5,"4th Subject Name : $fsstgtsubject4th",1);
}
else
{
...
$fmerit3=$stggtstotal1['merit_class'];
        ...
        $pdf->Cell(10,5,'',0,0,"C");
		$pdf->Cell(60,5,"Merit Position in Section",1);
		$pdf->Cell(20,5,$fmerit1,1,0,"C");
		$pdf->Cell(60,5,"Merit Position in Shift",1);
		$pdf->Cell(20,5,$fmerit2,1,0,"C");
		$pdf->Cell(60,5,"Merit Position in Class",1);
		$pdf->Cell(20,5,$fmerit3,1,0,"C");
		$pdf->Cell(30,5,'',1,0,"C");
		$pdf->Ln();
...
$pdf->Cell(10,5,'',0,0,"L");					
$pdf->Cell(22,5,"Regulation",1,0,"C");	
$pdf->Cell(23,5,"Patritism",1,0,"C");
$pdf->Cell(23,5,"Honesty",1,0,"C");
$pdf->Cell(23,5,"leadership",1,0,"C");
$pdf->Cell(23,5,"Discipline",1,0,"C");
...
$getsubjstatus="select * from borno_result_six_eight_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND subject_id_six_eight='$stNbangla'";
$qgetsubjstatus=$mysqli->query($getsubjstatus);
$shgetsubjstatus=$qgetsubjstatus->fetch_assoc();
...
$convert=$stNbangla1*$con1/100+$stNbangla2*$con2/100+$stNbangla3*$con3/100; 
...
$subjectdetailsb ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$term' AND subject_id_six_eight='$stNbangla'";
	   ...
	   $pdf->Cell(20,5,$stNbangla3,1,0,"C");
		...
		if($subtypeb5!=0)
		{		
		$pdf->Cell(15,5,$stNbangla5,1,0,"C");
		}
		else
		{
		$pdf->Cell(15,5,'-',1,0,"C");
		...
		if($subtypeb6!=0)
		{		
		$pdf->Cell(15,5,$stNbangla6,1,0,"C");
		}
		else
		{
		$pdf->Cell(15,5,'-',1,0,"C");
...
$getsubjstatus="select * from borno_result_six_eight_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND subject_id_six_eight='$stNenglish'";
$qgetsubjstatus=$mysqli->query($getsubjstatus);
$shgetsubjstatus=$qgetsubjstatus->fetch_assoc();
...
$convert=$stNenglish1*$con1/100+$stNenglish2*$con2/100+$stNenglish3*$con3/100;    
...
$subjectdetailse ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$term' AND subject_id_six_eight='$stNenglish'";
		...
		if($subtypee5!=0)
		{		
		$pdf->Cell(15,5,$stNenglish5,1,0,"C");
		}
		else
		{
		$pdf->Cell(15,5,'-',1,0,"C");
		...
		if($subtypee6!=0)
		{		
		$pdf->Cell(15,5,$stNenglish6,1,0,"C");
		}
		else
		{
		$pdf->Cell(15,5,'-',1,0,"C");
...
$getsubjstatus="select * from borno_result_six_eight_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND subject_id_six_eight='$stN'";
$qgetsubjstatus=$mysqli->query($getsubjstatus);
$shgetsubjstatus=$qgetsubjstatus->fetch_assoc();
...
$gtstotal1 ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=$stN";
					$qgtstotal1=$mysqli->query($gtstotal1);
					$sqgtstotal1=$qgtstotal1->fetch_assoc();
					$stName=$sqgtstotal1['res_total_conv'];
					$stphone=$sqgtstotal1['res_gpa'];
					$stgp=$sqgtstotal1['res_lg'];
...
$fmerit3=$stggtstotal1['merit_class'];
		...
		$pdf->Ln();
		$pdf->Cell(10,5,'',0,0,"L");
		$pdf->Cell(270,5,"Opinion about Result (Filled up by Class Teacher)",1,0,"C");
		$pdf->Ln();
		$pdf->Cell(10,5,'',0,0,"L");
		$pdf->Cell(270,15,'',1);
...
$numbertype ="select * from borno_result_number_type where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass'";
		...
		$pdf->Cell(17,5,$type1,1,0,"C");
		$pdf->Cell(18,5,'Convert',1,0,"C");
		$pdf->Cell(17,5,$type2,1,0,"C");
		$pdf->Cell(17,5,$type3,1,0,"C");
		$pdf->Cell(17,5,$type4,1,0,"C");
		$pdf->Cell(17,5,$type5,1,0,"C");
		$pdf->Cell(17,5,$type6,1,0,"C");
...
$getsubjstatus="select * from borno_result_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_result_subject_id='$stN'";
$qgetsubjstatus=$mysqli->query($getsubjstatus);
$shgetsubjstatus=$qgetsubjstatus->fetch_assoc();
...
$pdf->SetFont('Arial','',12);
        ...
        $pdf->Cell(10,5,'',0,0,"L");
		$pdf->Cell(190,6,"GrandTotal / GPA",1);
...
$fmerit3=$stggtstotal1['merit_class'];
		...
		$pdf->Ln();
		$pdf->Cell(10,5,'',0,0,"L");
		$pdf->Cell(270,6,"Opinion about Result (Filled up by Class Teacher)",1,0,"C");
		$pdf->Ln();
		$pdf->Cell(10,5,'',0,0,"L");
		$pdf->Cell(270,18,'',1);
