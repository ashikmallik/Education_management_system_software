...
{
			$schexroll="select * from borno_class6_8_temp_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess'  group by borno_school_roll asc";
			$qschexroll=$mysqli->query($schexroll);
			while($shschexroll=$qschexroll->fetch_assoc()){
	  ?>
        <option value="<?php echo $shschexroll['borno_school_roll']; ?>" <?php if($shschexroll['borno_school_roll']==$_POST['roll1']) { echo "selected"; } ?>><?php echo $shschexroll['borno_school_roll']; ?></option>
...
{
			$schexroll="select * from borno_class1_temp_mark1 where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess'  group by borno_school_roll asc";
			$qschexroll=$mysqli->query($schexroll);
			while($shschexroll=$qschexroll->fetch_assoc()){
	  ?>
        <option value="<?php echo $shschexroll['borno_school_roll']; ?>" <?php if($shschexroll['borno_school_roll']==$_POST['roll1']) { echo "selected"; } ?>><?php echo $shschexroll['borno_school_roll']; ?></option>
...
// 	{
/* 
 $result = "Call `sp_temp_marks_sheet_play_five_insert` ($section,$stsess,$selTerm)";
 ...
 <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_avg_progress_report_ngghs.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&rollf=<?php echo $rollf; ?>&rollt=<?php echo $rollt; ?>" target="_blank">Avg. Progress Report Two Term</a></td>
 </tr>
 <?php }
...
?>
 ...
 <?php } elseif($schId==105) {?>
   ...
   <?php } else {?>
    ...
    <?php
                                        ...
                                        $gsterm="SELECT `term_type` FROM `borno_result_add_term` WHERE `borno_result_term_id`='$selTerm'";
                                        $qgsterm=$mysqli->query($gsterm);
                                        $shqgsterm=$qgsterm->fetch_assoc(); 
                                        $type= $shqgsterm['term_type'];
    
    
    if($type == 5 ) {?>
    <td><a href="download_progress_report05(tut).php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&rollf=<?php echo $rollf; ?>&rollt=<?php echo $rollt; ?>" target="_blank">Progress Report</a></td>
   <?php } else {?>
   <td><a href="download_progress_report05.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&rollf=<?php echo $rollf; ?>&rollt=<?php echo $rollt; ?>" target="_blank">Progress Report</a></td>
   <?php } ?>
 </tr>
 <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="download_AVG_progress_report.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&rollf=<?php echo $rollf; ?>&rollt=<?php echo $rollt; ?>" target="_blank">Avg. Progress Report </a></td>
 </tr>
 <!--    <tr>-->
 ...
 <!--   <td>&nbsp;</td>-->
 <!--   <td>&nbsp;</td>-->
 <!--   <td><a href="download_progress_report.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>&rollf=<?php echo $rollf; ?>&rollt=<?php echo $rollt; ?>" target="_blank">Test</a></td>-->
 <!--</tr>-->
 <?php } ?>
