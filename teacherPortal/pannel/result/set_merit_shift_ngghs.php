...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="set_merit_shift_ngghs.php";
...
<form name="frmcontent" id="myform" action="set_merit_do_shift_ngghs.php" method="post" enctype="multipart/form-data">
