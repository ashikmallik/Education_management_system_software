...
//	$this->Ln();
	...
	$this->Cell(190,5,"Average Merit List in Class",0,0,'C');
	$this->Ln();
...
if($studClass==1 OR $studClass==2)
{
					...
					$data="select * from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='0' AND borno_subject_nine_ten_dept='$group' AND meritno_class!=0 order by meritno_class asc";
...
$fnssection=$sqgtsection['borno_school_section_name'];		
		...
		$pdf->Cell(25,5,$fnssection,1,0,"C");
	...
	$data1="select * from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='0' AND borno_subject_nine_ten_dept='$group' AND meritno_class!=0";
...
elseif($studClass==3 OR $studClass==4 OR $studClass==5)
{
					...
					$data="select * from borno_school_68_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='0' AND meritno_class!=0 order by meritno_class asc";
					$qdata=$mysqli->query($data);
					while($showdata=$qdata->fetch_assoc()){ $sl++;
...
$fnssection=$sqgtsection['borno_school_section_name'];		
	...
	$data1="select * from borno_school_68_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='0' AND meritno_class!=0";
					$qdata1=$mysqli->query($data1);
					$meritno=mysqli_num_rows($qdata1); 
...
else
{
					...
					$data="select * from borno_school_play_5_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='0' AND meritno_class!=0 order by meritno_class asc";
					$qdata=$mysqli->query($data);
					while($showdata=$qdata->fetch_assoc()){ $sl++;
...
$data1="select * from borno_school_play_5_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='0' AND meritno_class!=0";
					$qdata1=$mysqli->query($data1);
					$meritno=mysqli_num_rows($qdata1); 
