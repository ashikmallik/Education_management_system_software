...
if($studClass1==1 OR $studClass1==2)
{
	...
	if($schId==101){$getmotsub=11;} 
	else{$getmotsub=9;}
	
	
	$delinfo="delete from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' ";
	
	$mysqli->query($delinfo);

 $gtctmarg1="select * from borno_class9_10_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1'  group by borno_student_info_id asc";
	...
	while($shgtctmarg=$qgtctmarg->fetch_assoc()){
		...
		//=============================================== 4th Subject ===================================
		$get4thsubmrk="select * from borno_class9_10_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_school_stud_group='$group1' AND borno_student_info_id='$studinfoId1' AND stu4thsub=1 AND uncountable=0";
	...
	VALUES ('$schId', '$branchId1', '$studClass1', '$shiftId1', '$section1', '$stsess1','$group1', '0', '$studinfoId', '$studRoll', '$studName', '$totalmark', '$totalmark3', '$gtFinalGPA11', '$gtFinalGPA12', '$finallg', '0', '', '0', '', '0', '', '0', '')";
...
$getpare1="select * from borno_set_subject_six_eight where borno_school_id='$schId' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1' AND six_eight_subject_pare='1'";
		
		$qgetpare1=$mysqli->query($getpare1);
		$shqgetpare1=$qgetpare1->fetch_assoc();	 
		$pare1=$shqgetpare1['six_eight_subject_pare']; 
		if($schId==51){$p1=0;}
		else
		{
		if($pare1!=""){$p1=1;}
    	...
    	$getpare2="select * from borno_set_subject_six_eight where borno_school_id='$schId' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1' AND six_eight_subject_pare='2'";
		
		$qgetpare2=$mysqli->query($getpare2);
		$shqgetpare2=$qgetpare2->fetch_assoc();	
		$pare2=$shqgetpare2['six_eight_subject_pare']; 
...
$gtctmarg1="select * from borno_class6_8_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' group by borno_student_info_id asc";
	...
	while($shgtctmarg1=$qgtctmarg1->fetch_assoc()){
		...
		$gtctmarg="select * from borno_class6_8_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId1' AND six_eight_4th_subject=0 AND uncountable=0";
	...
	while($shgtctmarg=$qgtctmarg->fetch_assoc()){
		...
		//=============================================== 4th Subject ===================================
    	$get4thsubmrk="select * from borno_class6_8_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId1' AND six_eight_4th_subject=1 AND uncountable=0";
...
if($totalmark!=0) {	
	...
	VALUES ('$schId', '$branchId1', '$studClass1', '$shiftId1', '$section1', '$stsess1', '0', '$studinfoId', '$studRoll', '$studName', '$totalmark', '$gtFinalGPA11', '$finallg', '0', '', '0', '', '0', '', '0', '')";
...
$gtctmarg1="select * from borno_play_five_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' group by borno_student_info_id asc";
	...
	while($shgtctmarg1=$qgtctmarg1->fetch_assoc()){
		...
		$gtctmarg="select * from borno_play_five_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_student_info_id='$studinfoId1' AND subst=0";
...
if($studClass1==1 OR $studClass1==2)
{
 $gtctmarg="select * from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_session='$stsess1' AND borno_result_term_id='0'  AND gpa!=0 group by gpa, grandtotal";
...
$meritno1="select * from borno_merit_no order by meritno"; 
 ...
 $qins=$mysqli->query($insfmark11);
	...
	$gtctmarg="select * from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_session='$stsess1' AND borno_result_term_id='0'  order by meritno_shift asc";
...
elseif($studClass1==3 OR $studClass1==4 OR $studClass1==5)
{
 $gtctmarg="select * from borno_school_68_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND gpa!=0 group by gpa, grandtotal";
...
{
 $gtctmarg="select * from borno_school_play_5_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND gpa!=0 group by gpa, grandtotal";
...
if($studClass1==1 OR $studClass1==2)
{
 ...
 $gtctmarg="select * from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1' AND borno_result_term_id='0'  AND gpa!=0 group by gpa, grandtotal";
...
$meritno1="select * from borno_merit_no order by meritno"; 
 ...
 $insfmark11="UPDATE borno_school_910_avg_merit SET meritno_class='$mno' where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1'  AND borno_school_session='$stsess1' AND borno_result_term_id='0'  AND gpa='$styGPA11' AND grandtotal='$studin1'";
 ...
 $qins=$mysqli->query($insfmark11);
	...
	$gtctmarg="select * from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1' AND borno_result_term_id='0'  order by meritno_class asc";
	...
	$insfmark111="UPDATE borno_school_910_avg_merit SET merit_class='$positionlist' where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1' AND borno_result_term_id='0'  AND borno_student_info_id='$studinfoId'";
...
elseif($studClass1==3 OR $studClass1==4 OR $studClass1==5)
{
 ...
 $gtctmarg="select * from borno_school_68_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND gpa!=0 group by gpa, grandtotal";
...
else
{
 ...
 $gtctmarg="select * from borno_school_play_5_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND gpa!=0 group by gpa, grandtotal";
...
if($qins) { header("location:set_avgmerit_ngghs.php?msg=1&branchId=$branchId1&studClass=$studClass1&shiftId=$shiftId1&section=$section&stsess=$stsess1");} else { header('location:set_avgmerit_ngghs.php?msg=2');}
