...
if(isset($_POST) && count($_POST)>0){
	...
	$gtnumberty6=$shassnty['borno_school_number_type6'];
         ...
         //=== Subject Details ===
	$bornosubjdet="SELECT * FROM  borno_result_nine_ten_subject_details where borno_school_id='$schoolId' AND borno_school_class_id='$studClass' AND   borno_school_session='$stsess' AND   borno_result_term_id='$selTerm' AND borin_subject_nine_ten_id='$stusubjId'";
...
elseif($studClass==3 OR $studClass==4 OR $studClass==5)
	...
	$studSetSub="SELECT * FROM `borno_set_subject_six_eight` where borno_school_id ='$schoolId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess'";
...
$assnty="select * from borno_result_number_type where borno_school_id='$schoolId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess'";
	...
	$gtnumberty6=$shassnty['borno_school_number_type6'];
  //=== Subject Details ===
  $bornosubjdet="SELECT * FROM  borno_result_six_eight_subject_details where borno_school_id='$schoolId' AND borno_school_class_id='$studClass' AND   borno_school_session='$stsess' AND   borno_result_term_id='$selTerm' AND subject_id_six_eight='$stusubjId'";
	$qbornosubjdet=$mysqli->query($bornosubjdet);
	$shbornosubjdet=$qbornosubjdet->fetch_assoc();
  ...
  //=================== End ==========================================	
	...
	{
  // ================== Subject Name=================================
 $subjectSql = "SELECT * FROM `borno_result_subject` where borno_school_id='$schoolId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' ORDER BY `borno_result_subject_id` ASC";
	$subjectQuery = $mysqli->query($subjectSql);
	while($subject = $subjectQuery->fetch_assoc()) {
...
$assnty="select * from borno_result_number_type where borno_school_id='$schoolId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess'";
	...
	$gtnumberty6=$shassnty['borno_school_number_type6'];
  //=== Subject Details ===
 $bornosubjdet="SELECT * FROM  borno_result_subject_details where borno_school_id='$schoolId' AND borno_school_class_id='$studClass' AND   borno_school_session='$stsess' AND   borno_result_term_id='$selTerm' AND borno_result_subject_id='$stusubjId'";
	$qbornosubjdet=$mysqli->query($bornosubjdet);
	$shbornosubjdet=$qbornosubjdet->fetch_assoc();
