...
$gettremtype = "SELECT `term_type` FROM `borno_result_add_term` WHERE `borno_result_term_id` = '$selTerm'";
...
$subjectFullmark = $shgetsubjstatus['borno_nine_ten_subfullmark'];
echo $pare." ";
}
...
$getsubfullmark="select * from borno_set_subject_six_eight where borno_school_id='$schId'  AND borno_school_class_id='$studClass'AND borno_school_session='$stsess' AND subject_id_six_eight='$stusubjId'";
	$qgetsubfullmark=$mysqli->query($getsubfullmark);
	$shqgetsubfullmark=$qgetsubfullmark->fetch_assoc();
$subjectFullmark = $shqgetsubfullmark['borno_nine_ten_subfullmark'];
...
for($i=0; $i<count($stuRoll); $i++){
	...
	$conv1 = $ntype1[$i]*$con1/100;
	$conv2 = $ntype2[$i]*$con2/100;
	$conv3 = $ntype3[$i]*$con3/100;
	$conv4 = $ntype4[$i]*$con4/100;
	$conv5 = $ntype5[$i]*$con5/100;
	$conv6 = $ntype6[$i]*$con6/100;
	
	
	$totalmark=$ntype1[$i]*$con1/100+$ntype2[$i]*$con2/100+$ntype3[$i]*$con3/100+$ntype4[$i]*$con4/100+$ntype5[$i]*$con5/100+$ntype6[$i]*$con6/100;
	$totalmark=number_format($totalmark);
	$totalmark=floor($totalmark);
	if($schId==60){$totalmark=number_format($totalmark);}
	 $insfmark1="UPDATE `borno_class9_10_temp_mark1` 
	    SET `temp_res_number_type1`='$ntype1[$i]',
	         `temp_res_number_type1_covn` = '$conv1',
			`temp_res_number_type2`='$ntype2[$i]',
			`temp_res_number_type2_covn` = '$conv2',
			`temp_res_number_type3`='$ntype3[$i]', 
			`temp_res_number_type3_covn` = '$conv3',
			`temp_res_number_type4`='$ntype4[$i]',
			`temp_res_number_type4_covn` = '$conv4',
			`temp_res_number_type5`='$ntype5[$i]',
			`temp_res_number_type5_covn` = '$conv5',
			`temp_res_number_type6`='$ntype6[$i]',
			`temp_res_number_type6_covn` = '$conv6',
			`stu4thsub`='$stu4th',
			`total_marks`='$totalmark',
			`subject_pare` = '$pare',
			`uncountable`='$uncountable',
			`attendence_status` = '$absentstatus[$i]',
			`updateBy` = '$userid', 
			`updateDate` = '$updatedate' where	borno_class9_10_temp_mark1_id=$tempid[$i]";
...
for($i=0; $i<count($stuRoll); $i++){
	...
	$conv1 = round($ntype1[$i]*$con1/100);
	$conv2 = round($ntype2[$i]*$con2/100);
	$conv3 = round($ntype3[$i]*$con3/100);
	$conv4 = round($ntype4[$i]*$con4/100);
	$conv5 = round($ntype5[$i]*$con5/100);
	$conv6 = round($ntype6[$i]*$con6/100);
					
	$totalmark=$conv1  + $conv2 + $conv3+ $conv4+ $conv5+ $conv6;
	$totalmark=number_format($totalmark);
	$totalmark=round($totalmark);
	if($schId==60){$totalmark=number_format($totalmark);}
	 $insfmark1="UPDATE `borno_class6_8_temp_mark1` 
	    SET `temp_res_number_type1`='$ntype1[$i]',
	         `temp_res_number_type1_covn` = '$conv1',
			`temp_res_number_type2`='$ntype2[$i]',
			`temp_res_number_type2_covn` = '$conv2',
			...
			where borno_class6_8_temp_mark1_id='$tempid[$i]'";
		$qinstm1=$mysqli->query($insfmark1);
...
$totalmark=$ntype1[$i]*$con1/100+$ntype2[$i]*$con2/100+$ntype3[$i]*$con3/100+$ntype4[$i]*$con4/100+$ntype5[$i]*$con5/100+$ntype6[$i]*$con6/100;				
	 ...
	 $insfmark1="UPDATE `borno_class1_temp_mark1` SET `temp_res_number_type1`='$ntype1[$i]',
			...
			`updateBy` = '$userid', 
			`updateDate` = '$updatedate'
			where borno_class1_temp_mark_id='$tempid[$i]'";
...
$gtsubjfm1="select * from borno_set_subject_six_eight where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND subject_id_six_eight='1' AND borno_result_term_id='$selTerm'";
$qggtsubjfm1=$mysqli->query($gtsubjfm1);
$shgtsubjfm1=$qggtsubjfm1->fetch_assoc();
$gtsubjfmark1=$shgtsubjfm1['sub_six_eight_fullmark'];

$gtsubjfm2="select * from borno_set_subject_six_eight where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND subject_id_six_eight='2' AND borno_result_term_id='$selTerm'";
...
$gtsubjfm1="select * from borno_set_subject_six_eight where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND subject_id_six_eight='3' AND borno_result_term_id='$selTerm'";
$qggtsubjfm1=$mysqli->query($gtsubjfm1);
$shgtsubjfm1=$qggtsubjfm1->fetch_assoc();
$gtsubjfmark1=$shgtsubjfm1['sub_six_eight_fullmark'];

$gtsubjfm2="select * from borno_set_subject_six_eight where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND subject_id_six_eight='4' AND borno_result_term_id='$selTerm'";
$qggtsubjfm2=$mysqli->query($gtsubjfm2);
$shgtsubjfm2=$qggtsubjfm2->fetch_assoc();
$gtsubjfmark2=$shgtsubjfm2['sub_six_eight_fullmark'];
...
{	
 $gtsdmrk="select * from borno_result_six_eight_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND subject_id_six_eight='$stusubjId'";
	...
	$gtsubjfm="select * from borno_set_subject_six_eight where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND subject_id_six_eight='$stusubjId' AND borno_result_term_id='$selTerm'";
...
if($pare==1)
{
 $gtsdmrk1="select * from borno_result_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_result_subject_id='$stusubjId' AND pare='1'";
	...
	$gtsubjfm1="select * from borno_result_subject where borno_result_subject_id='$stusubjId' AND borno_result_term_id='$selTerm'";
 ...
 $gtsdmrk2="select * from borno_result_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_result_subject_id!='$stusubjId' AND pare='1'";
	...
	$gtsubjfm2="select * from borno_result_subject where borno_result_subject_id='$stusubjId1' AND borno_result_term_id='$selTerm'";
...
else
{
 $gtsdmrk="select * from borno_result_subject_details where borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' AND borno_result_subject_id='$stusubjId'";
	...
	$gtsubjfm="select * from borno_result_subject where borno_result_subject_id='$stusubjId' AND borno_result_term_id='$selTerm'";
...
if($term_type == 5){
	    ...
	    $gttotalmrk=number_format($gttotalmrk);
            $gttotalmrk=round($gttotalmrk);
		...
		if($schId==60){$gtconvtotal=number_format($gtconvtotal);}
				if($schId==80){
		    $markinpers=(($gtconvtotal*$gtsubjfmark)/$gtsubjfmark);
		}
		else if($schId==161){
		    $markinpers=(($gtconvtotal*$gtsubjfmark)/$gtsubjfmark);
		}
	...
	$shgtctmarg1=$qgtctmarg1->fetch_assoc();
	   ...
	   $gttotalmrk1=($numbty11+$numbty12+$numbty13+$numbty14+$numbty15+$numbty16);
	   		$gttotalmrk1=number_format($gttotalmrk1);
         $gttotalmrk1=round($gttotalmrk1);
		$gtconvtotal1=($convnumbty11+$convnumbty12+$convnumbty13+$convnumbty14+$convnumbty15+$convnumbty16);
		$gtconvtotal1=number_format($gtconvtotal1);
...
//------ Bangla-2-----------------------
	...
	$shgtctmarg2=$qgtctmarg2->fetch_assoc();
	    ...
	    $gttotalmrk2=number_format($gttotalmrk2);
         $gttotalmrk2=round($gttotalmrk2);
		$gtconvtota21=($convnumbty21+$convnumbty22+$convnumbty13+$convnumbty14+$convnumbty15+$convnumbty16);
		$gtconvtota21=number_format($gtconvtota21);
...
//------ get number type from query top -----------------------	
	if($shgtctmarg1['temp_res_number_type1']!="" AND $shgtctmarg2['temp_res_number_type1']!="")
	{
		...
		$convnumbty6=$convnumbty16+$convnumbty26;
				...
				$sub1=number_format($numbty11+$numbty12+$numbty13+$numbty14+$numbty15+$numbty16);
		$sub2=number_format($numbty21+$numbty22+$numbty23+$numbty24+$numbty25+$numbty26);
...
// $gtconvtotal=round($gtconvtotal);
						...
						if($schId==60)
		{//$gtconvtotal=number_format($gtconvtotal);
		$sub1=number_format($numbty11+$numbty12+$numbty13+$numbty14+$numbty15+$numbty16);
		$sub2=number_format($numbty21+$numbty22+$numbty23+$numbty24+$numbty25+$numbty26);
        $gtconvtotal=$sub1+$sub2;
		}
		 if($schId==161){
		    $markinpers=(($gtconvtotal*$gtsubjfmark)/$gtsubjfmark);
		}
	...
	elseif($shgtctmarg1['temp_res_number_type1']!="" AND $shgtctmarg2['temp_res_number_type1']=="")
	{
		...
		$markinpers=(($gtconvtotal*100)/100);
...
$gtconvtotal=round($gtconvtotal);
    ...
    // echo $numbty1. " "; echo $numbtype1_conv. " "; echo $convnumbty1. "<br>";         
		$gtconvtotal=($convnumbty1+$convnumbty2+$convnumbty3+$convnumbty4+$convnumbty5+$convnumbty6);
		//	echo $gtconvtotal."<br>";	
            $gtconvtotal=round($gtconvtotal);
...
// 					if($gensubheightMark >100){
// 		    $gensubheightMark = 100;
// 		}
		
		$gensubheightMark=round($gensubheightMark);
...
// 		    $gensubheightMark = 100;
// 		}
		     $gensubheightMark=number_format($gensubheightMark);
...
if($quygeneralsubmark) { header("location:edit_marks.php?msg=1&branchId=$branchId&studClass=$studClass&shiftId=$shiftId&section=$section&stsess=$stsess&selTerm=$selTerm&group=$group&stusubjId=$stusubjId");} else {  header('location:edit_marks.php?msg=2'); }
	}
