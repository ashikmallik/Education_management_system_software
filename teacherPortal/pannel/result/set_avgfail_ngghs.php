...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="set_avgfail_ngghs.php";
...
<br>
<form name="frmcontent" id="myform" action="set_avgfail_ngghs_do.php" method="post" enctype="multipart/form-data">
