...
//	$this->Ln();
	...
	$this->Cell(190,5,"Merit List in Class",0,0,'C');
	$this->Ln();
	...
	$this->Cell(50,5,$GLOBALS['fnsterm'],0,0,'L');
	...
	$this->Ln();
		...
		$this->Cell(34,5,"Section",1,0,"C");
		$this->Cell(10,5,"Roll",1,0,"C");
		$this->Cell(60,5,"Name",1);
		$this->Cell(25,5,"Grand Total",1,0,"C");
		$this->Cell(14,5,"GPA",1,0,"C");
		$this->Cell(24,5,"Merit Position",1,0,"C");
	$this->Ln();
...
if($studClass==1 OR $studClass==2)
{
					...
					$data="select * from borno_school_9_10_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND meritno_class!=0 order by meritno_class asc";
...
$fnssection=$sqgtsection['borno_school_section_name'];		
		...
		$pdf->Cell(34,5,$fnssection,1,0,"C");
		$pdf->Cell(10,5,$roll,1,0,"C");
		$pdf->Cell(60,5,$techname,1);
		$pdf->Cell(25,5,$grand,1,0,"C");	
		$pdf->Cell(14,5,$gpa,1,0,"C"); //$gpa
		$pdf->Cell(24,5,$merit,1,0,"C");
		$pdf->Ln();
}
	$data1="select * from borno_school_9_10_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND meritno_class!=0";
...
elseif($studClass==3 OR $studClass==4 OR $studClass==5)
{
					...
					$data="select * from borno_school_6_8_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND meritno_class!=0 order by meritno_class asc";
					$qdata=$mysqli->query($data);
					while($showdata=$qdata->fetch_assoc()){ $sl++;
...
$fnssection=$sqgtsection['borno_school_section_name'];		
		...
		$pdf->Cell(60,5,$techname,1);
		$pdf->Cell(25,5,$grand,1,0,"C");	
	$pdf->Cell(14,5,'',1,0,"C"); //$gpa
		$pdf->Cell(24,5,$merit,1,0,"C");
		$pdf->Ln();
}
	$data1="select * from borno_school_6_8_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND meritno_class!=0";
					$qdata1=$mysqli->query($data1);
					$meritno=mysqli_num_rows($qdata1); 
...
else
{
					...
					$data="select * from borno_school_play_5_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND meritno_class!=0 order by meritno_class asc";
					$qdata=$mysqli->query($data);
					while($showdata=$qdata->fetch_assoc()){ $sl++;
...
$data1="select * from borno_school_play_5_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND meritno_class!=0";
					$qdata1=$mysqli->query($data1);
					$meritno=mysqli_num_rows($qdata1); 
