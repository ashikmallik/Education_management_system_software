...
function Header()
{
	...
	$this->Cell(190,5,"Average Fail List Shift Wise",0,0,'C');
	$this->Ln();
	...
	$this->SetFont('Arial','',10);
		...
		$this->Cell(45,5,"Name",1);
		$this->Cell(15,5,"G.Total",1,0,"C");
		$this->Cell(15,5,"Fail No",1,0,"C");
		$this->Cell(75,5,"Fail Subject",1,0,"C");
	$this->Ln();
;
}
...
{	
					...
					$data="select * from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId'  AND borno_school_session='$stsess' AND borno_result_term_id='0' AND failno!=0 order by failno asc,grandtotal desc";
		...
		$techname=substr($showdata['borno_school_student_name'],0,20);
...
$fnssection=$sqgtsection['borno_school_section_name'];
		...
		$pdf->Cell(45,5,$techname,1);
		$pdf->Cell(15,5,$grand,1,0,"C");	
		$pdf->Cell(15,5,$gpa,1,0,"C");
		$pdf->Cell(75,5,$merit,1,0,"L");
		$pdf->Ln();
}
$data1="select * from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId'  AND borno_school_session='$stsess' AND borno_result_term_id='0' AND failno!=0";
...
{	
					...
					$data="select * from borno_school_68_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId'  AND borno_school_session='$stsess' AND borno_result_term_id='0' AND failno!=0 order by failno asc,grandtotal desc";
					$qdata=$mysqli->query($data);
					while($showdata=$qdata->fetch_assoc()){ $sl++;
...
$data1="select * from borno_school_68_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId'  AND borno_school_session='$stsess' AND borno_result_term_id='0' AND failno!=0";
					$qdata1=$mysqli->query($data1);
					$meritno=mysqli_num_rows($qdata1); 
...
{	
					...
					$data="select * from borno_school_play_5_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId'  AND borno_school_session='$stsess' AND borno_result_term_id='0' AND failno!=0 order by failno asc,grandtotal desc";
					$qdata=$mysqli->query($data);
					while($showdata=$qdata->fetch_assoc()){ $sl++;
...
$data1="select * from borno_school_play_5_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId'  AND borno_school_session='$stsess' AND borno_result_term_id='0' AND failno!=0";
					$qdata1=$mysqli->query($data1);
					$meritno=mysqli_num_rows($qdata1); 
