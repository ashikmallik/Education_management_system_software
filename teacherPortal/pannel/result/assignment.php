...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="assignment.php";
...
?>
   ...
   <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="cumulative_assignment_report.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">Cumulative Assesment</a></td>
   </tr>
 <!--<tr>-->
 ...
 <!--   <td>&nbsp;</td>-->
 <!--   <td>&nbsp;</td>-->
 <!--   <td><a href="download_avgtabulation_sheet1_ngghs.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">Avg. Tabulation Sheet-1</a></td>-->
 <!--</tr>-->
 <!-- <tr>-->
 ...
 <!--   <td>&nbsp;</td>-->
 <!--   <td>&nbsp;</td>-->
 <!--   <td><a href="download_avgtabulation_sheet2_ngghs.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">Avg. Tabulation Sheet-2</a></td>-->
 <!--</tr>-->
 ...
 <!--   <td>&nbsp;</td>-->
 <!--   <td>&nbsp;</td>-->
 <!--   <td><a href="download_avgtabulation_sheet3_ngghs.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>&group=<?php echo $group; ?>" target="_blank">Avg. Tabulation Sheet-3</a></td>-->
 <!--</tr>-->
   <?php } else {?>  
 <!--   <tr>-->
 ...
 <!--   <td>&nbsp;</td>-->
 <!--   <td><a href="download_avgtabulation_sheet_ngghs.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>" target="_blank">Avg. Tabulation Sheet-1</a></td>-->
 <!--</tr>-->
 <!--<tr>-->
 ...
 <!--   <td>&nbsp;</td>-->
 <!--   <td><a href="download_avgtabulation3_sheet_ngghs.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>" target="_blank">Avg. Tabulation Sheet-2</a></td>-->
 <!--</tr>-->
 <?php } ?>   
</table>
