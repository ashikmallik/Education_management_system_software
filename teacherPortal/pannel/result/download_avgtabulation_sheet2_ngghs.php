...
$sl2=0;
 ...
 $resulttotal1avg ="select * from borno_class9_10_average_mark1 where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='0'  AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND borno_subject_nine_ten_id='$subida'";
					$qresulttotal1avg=$mysqli->query($resulttotal1avg);
					$rowqresulttotal1avg=$qresulttotal1avg->fetch_assoc();					
					$subjectidavg1=$rowqresulttotal1avg['borno_subject_nine_ten_id'];
					$numa1=$rowqresulttotal1avg['temp_res_number_type1'];
					$numa2=$rowqresulttotal1avg['temp_res_number_type2'];
					$numa3=$rowqresulttotal1avg['temp_res_number_type3'];
					$numa4=$rowqresulttotal1avg['temp_res_number_type4'];
					$numa5=$rowqresulttotal1avg['temp_res_number_type5'];
					$numa6=$rowqresulttotal1avg['temp_res_number_type6'];
...
///-----------For Motijheel Boys-------------
if ($schId==33 AND $studClass==3){
 $sid10=$sid7;   
}
///-----------For Motijheel Boys-------------
///-----------For Donovan-------------
elseif ($schId==6 AND $studClass==4){
 $sid10=$sid9;   
}
elseif ($schId==6 AND $studClass==5){
 $sid10=$sid9;   
}
else{
  $sid10=$sid10;   
