...
function callpage()
{
 document.frmcontent.action="add_subject05.php";
...
<option value=" <?php echo $shqgstterm['borno_result_term_id']; ?>" <?php if($shqgstterm['borno_result_term_id']==$_REQUEST['term']) { echo "selected"; }  ?>> <?php echo $shqgstterm['borno_result_term_name']; ?></option>
      ...
      ?>
                        ...
                        <form name="frmcontent1" action="add_subject_do.php" method="post" enctype="multipart/form-data">
                            <table width="400" style="border: 1px solid #005067;">
                              ...
                              <tr>
                                <td align="center"><input name="subjectName[]" type="text" id="subjectName[]" size="30">
                                ...
                                <td align="center"><input name="subjectMarks[]" type="text" id="subjectMarks[]" size="5">
