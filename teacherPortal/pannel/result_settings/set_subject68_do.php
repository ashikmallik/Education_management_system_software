 ...
 require_once '../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	$pare= $_POST['pare'];
		...
		if(empty($term1)){
		 ...
		 $gsess="select * from borno_set_subject_six_eight where borno_school_id='$schId' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1' AND borno_result_term_id = '$term1'";
	...
	if($gtermsess!="") { header('location:set_subject68.php?msg=3'); } else {
									...
									for($i=0; $i<count($perc); $i++){
										...
										if($perc[$i]!=""){
										$insmk="INSERT INTO `borno_set_subject_six_eight` (`borno_school_id`,`borno_school_class_id`,`borno_school_session`,`borno_result_term_id`, `subject_id_six_eight`,`sub_six_eight_fullmark`, `six_eight_subject_pare`,`six_eight_4th_subject`,`uncountable`)
											
											 VALUES ('$schId','$studClass1','$stsess1','$term1', '$subid[$i]', '$perc[$i]','$pare[$i]','$sub4th[$i]','$uncountable[$i]')";
