<?php
 ...
 require_once '../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	$addsub= $_POST['addsub'];
		...
		$gsess="select * from borno_result_subject where borno_school_id='$schId' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1' AND 	borno_result_term_id = '$term1'";
	...
	if($gtermsess!="") { header('location:add_subject05.php?msg=3'); } else {
									...
									for($i=0; $i<count($subjectMarks); $i++){
										...
										if($subjectMarks[$i]!=""){
											$insmk="INSERT INTO `borno_result_subject` (`borno_school_id`,`borno_school_class_id`,`borno_school_session`,`borno_result_term_id`, `borno_school_subject_name`,`borno_subject_name_short`, `borno_school_subject_fullmark`,`subst`)
											
											 VALUES ('$schId','$studClass1','$stsess1','$term1', '$subjectName[$i]','', '$subjectMarks[$i]','$addsub[$i]')";
