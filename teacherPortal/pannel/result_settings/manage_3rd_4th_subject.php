  ...
  <tr>
    ...
    <td><select name="dept" id="dept" onchange="callpage();">
      ...
      <option value="2" <?php if($_REQUEST['dept']==2) { echo "selected"; } ?>> Business Studies </option>
					...
					//	echo $section." "; echo $stsess." "; echo $dept."<br>"; 
						
			$getstudinfo="select * from borno_student_info where borno_school_section_id='$section' AND borno_school_session=trim('$stsess') AND borno_school_stud_group='$dept' order by borno_school_roll asc";
			$sl=0;
...
//	 echo $shterm['borno_student_info_id']."<br>";
   ?>
