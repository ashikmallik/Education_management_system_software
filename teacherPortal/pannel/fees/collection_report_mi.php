...
<div class="wrapper">
    ...
    <div class="ot_main_content">
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                ...
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="download_collection_receipt.php" method="post" enctype="multipart/form-data" target="_blank">
                        <?php
			$msg=$_GET['msg'];
 ...
 ?>
   ...
   <tr>
<td colspan="2" align="center"><input type="text" readonly name="button" id="button" value="Download" onClick="return contalt_valid()"></td>
  </tr>
