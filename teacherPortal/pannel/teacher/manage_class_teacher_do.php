...
$fnsclass=$sqgtclass['clorder'];
		     ...
		     $bornoschBranch="UPDATE `borno_set_class_teacher` SET `borno_school_class_id`='$studclass1',`borno_school_section_id`='$section1',`borno_class_order`='$fnsclass' where `borno_school_teacher_id`='$teacherid1' AND `borno_school_session`='$stsess1' ";
