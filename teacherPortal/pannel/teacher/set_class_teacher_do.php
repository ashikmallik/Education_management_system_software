...
// 			{
		...
		$gtclass="SELECT * FROM borno_school_class where borno_school_class_id=$studclass1";
					$qgtclass=$mysqli->query($gtclass);
					$sqgtclass=$qgtclass->fetch_assoc();
$fnsclass=$sqgtclass['clorder'];

   $bornoschBranch="INSERT INTO `borno_set_class_teacher` (`borno_school_id`,`borno_school_branch_id`,`borno_school_shift_id`,`borno_school_teacher_id`,`borno_school_session`,`borno_school_class_id`, `borno_school_section_id`, `borno_class_order`)
											
															VALUES ('$schId','$addBranchf','$shiftId1','$teacherid1', '$stsess1','$studclass1','$section1','$fnsclass')";
