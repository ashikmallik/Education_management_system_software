...
$pdf->AddPage();
 ...
 $pdf->SetFont('Arial','',10);
					...
					$data="SELECT * FROM borno_set_class_teacher where  borno_school_branch_id=$branchId AND borno_school_shift_id=$shiftId order by 	borno_set_class_teacher_id asc";
