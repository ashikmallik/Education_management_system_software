...
<div class="wrapper">
    ...
    <div class="ot_main_content">
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                ...
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="#" method="post" enctype="multipart/form-data" target="_blank">
                        <?php
			$msg=$_GET['msg'];
 ...
 ?>
		...
		?>
                <tr>
            <td class="text_table">Old Password *</td>
    <td><input type="text" name="oldpass" placeholder="Type Old Password"></td>
  </tr>                    
     <tr>
            <td class="text_table">New Password *</td>
    <td><input type="password" name="newPass" placeholder="Type New Password"></td>
  </tr>                                   
