    ...
    <li><a href="marks_entry.php"><i class="fa fa-user" aria-hidden="true"></i> Marks Entry </a></li>
   ...
   <li><a href="set_merit9_10.php"><i class="fa fa-cog" aria-hidden="true"></i> Process  Result  </a></li>   
   <li><a href="set_merit.php"><i class="fa fa-cog" aria-hidden="true"></i> Set Merit </a></li>
