...
function callpage()
{
 document.frmcontent.action="seat_card.php";
...
<div class="wrapper">
    ...
    <div class="ot_main_content">
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                ...
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="download_seat_card.php" method="post" enctype="multipart/form-data">
                        <?php
			$msg=$_GET['msg'];
 ...
 ?>
    ...
    <td><select name="stsess" id="stsess" onchange="callpage();">
      ...
      <option value="2017-18" <?php if($_POST['stsess']=='2017-18') { echo "selected"; } ?>> 2017-18 </option>      
  ...
  <tr>
    <td class="text_table">Exam Year *</strong></td>
    <td><select name="styear" id="styear" onchange="callpage();">
<option value="2018" <?php if($_POST['styear']==2018) { echo "selected"; } ?> > 2018 </option>
...
?>
    <td>&nbsp;</td>
    <td><a href="download_seat_card.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&dept=<?php echo $dept; ?>&sctermId=<?php echo $selTerm; ?>&styear=<?php echo $styear; ?>" target="_blank">Show Seat Card</a></td>
 </tr>          
                        </table>
