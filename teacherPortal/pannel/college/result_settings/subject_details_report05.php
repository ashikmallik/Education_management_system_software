...
?>
    <td>&nbsp;</td>
    <td><a href="download_subject_details05.php?schoolId=<?php echo $schId; ?>&classId=<?php echo $studClass; ?>&scsess=<?php echo $stsess; ?>&dept=<?php echo $dept; ?>&sctermId=<?php echo $selTerm; ?>" target="_blank">Show List</a></td>
 </tr>     
                        </table>
