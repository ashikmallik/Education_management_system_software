	...
	$ttmmrk;
					  ...
					  if($ttmmrk<100) { header('location:term_assign.php?msg=1'); }
									...
									for($i=0; $i<count($perc); $i++){
										...
										if($perc[$i]!=""){
											$insmk="INSERT INTO `borno_result_add_term` (`borno_school_id`,`borno_school_class_id`,`borno_school_session`, `borno_result_term_name`, `borno_result_term_percent`,`term_type`)
