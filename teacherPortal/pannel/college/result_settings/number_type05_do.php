<?php
 ...
 require_once '../../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	if (!function_exists('clean_html')) {
		...
		$gsess="select * from borno_result_number_type where borno_school_id='$schId' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1'";
	...
	if($gtermsess!="") { header('location:add_number_type05.php?msg=1'); } else {
											...
											$insmk="INSERT INTO `borno_result_number_type` (`borno_school_id`,`borno_school_class_id`,`borno_school_session`, `borno_school_number_type1`, `borno_school_number_type2`,`borno_school_number_type3`,`borno_school_number_type4`,`borno_school_number_type5`,`borno_school_number_type6`)
