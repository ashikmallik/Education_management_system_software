...
<div class="wrapper">
 ...
 ?>
    ...
    <td><select name="stsess" id="stsess" onchange="callpage();">
      ...
      <option value="2025" <?php if($_POST['stsess']=="2025") { echo "selected"; } ?>> 2025 </option>
    </select></td>
  </tr>
                          <tr>
  ...
  ?>
<tr>
  <td class="text_table">Select Group *</td>
  ...
  <tr>
    ...
    <td><select name="nstsess" id="nstsess">
      ...
      <option value="2025" <?php if($_POST['nstsess']==2025) { echo "selected"; } ?>> 2025 </option>
      <option value="2026" <?php if($_POST['nstsess']==2026) { echo "selected"; } ?>> 2026 </option>
    ...
    <?php
											...
											$stsess1=$_POST['nstsess'];	
												
                                                $gstsection="select * from borno_school_section where borno_school_class_id='$studClass' AND borno_school_branch_id='$gtfbranchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND `year` ='$stsess1'";
                                                $qgstsection=$mysqli->query($gstsection);
                                                while($shggstsection=$qgstsection->fetch_assoc()){ $sl++;
...
<tr>
  <td class="text_table">Select Group *</td>
    <td><select name="ngroup" id="ngroup" onchange="callpage();">
      <option value="">--Select--</option>
      <option value="1" <?php if($_POST['ngroup']==1) { echo "selected"; } ?> > Science </option>
      <option value="2" <?php if($_POST['ngroup']==2) { echo "selected"; } ?>> Business </option>
      <option value="3" <?php if($_POST['ngroup']==3) { echo "selected"; } ?>> Humanities </option>
  ...
  ?>
	...
	while($shgtctmarg=$qgtctmarg->fetch_assoc()){
		?>
               ...
               <td width="60" align="center"><?php echo $shgtctmarg['borno_student_info_id']; ?></td>
               <td width="260"><?php echo $shgtctmarg['borno_school_student_name']; ?></td>
               <td width="100" align="center"><input type="text" name="newroll[]" id="newroll[]" size="10"></td> </tr>
                                <?php } ?>
                               <tr>
                              
                                 <td colspan="4" align="center"><input type="submit" name="button" id="button" value="Submit" onClick="return contalt_valid()"></td>
                               </tr>
                              </tr>
                            </table>
