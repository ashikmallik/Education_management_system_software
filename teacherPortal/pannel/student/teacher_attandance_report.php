...
function callpage()
{
	 document.frmcontent.action="teacher_attandance_report.php";
...
<form name="frmcontent" action="download_teacher_attandance.php" method="post" enctype="multipart/form-data">
...
<table width="400" border="0" cellspacing="0" cellpadding="0" align="center" class="projectlist">
  ...
  <td><strong>Select Date *</strong></td>
    ...
    <td align="center"><input name="date" type="date" id="date" value="<?php echo $smsdate; ?>"/></td>
  </tr>
