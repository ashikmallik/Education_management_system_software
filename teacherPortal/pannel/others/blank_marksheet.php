...
?>
    <td>&nbsp;</td>
    <td><a href="download_blank_marksheet.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&group=<?php echo $group; ?>&sctermId=<?php echo $selTerm; ?>" target="_blank">Show List 1</a></td>
 </tr>  
 <tr>

    <td>&nbsp;</td>
    <td><a href="download_blank_marksheet1.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&group=<?php echo $group; ?>&sctermId=<?php echo $selTerm; ?>" target="_blank">Show List 2</a></td>
 </tr>       
