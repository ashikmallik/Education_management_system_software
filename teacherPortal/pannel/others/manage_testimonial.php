  ...
  <?php
   ...
   <tr>
    ...
    <td><select name="passyear" id="passyear" onchange="callpage();">
      ...
      <option value="2021" <?php if($_POST['passyear']=='2021') { echo "selected"; } ?>> 2021 </option>
       </select></td>
  </tr>	          
...
$group=$_POST['group'];
  ...
  $stdinfo ="select * from borno_school_testimonial where borno_school_class_id='$studClass' AND borno_school_branch_id='$gtfbranchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_passing_year='$passyear' AND borno_school_group='$group' AND borno_school_exam='$exam' order by borno_school_roll asc";
