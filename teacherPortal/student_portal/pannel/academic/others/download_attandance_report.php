...
$bannar="Student Attandance $monthname-$stsess";
...
$pdf->SetFont('Arial','',9);
		...
		$data="select * from borno_student_info where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' order by borno_school_roll asc";
