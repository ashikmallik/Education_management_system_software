...
{
  $stdinfo ="select * from borno_class6_8_final_result  where borno_school_class_id='$studClass' AND borno_school_id='$schId'  AND borno_school_session='$stsess' AND borno_result_term_id='$term'  AND borno_student_info_id='$stdId' GROUP BY borno_student_info_id";
...
{
 $stdinfo ="select * from borno_class1_final_result where borno_school_class_id='$studClass' AND borno_school_id='$schId'  AND borno_school_session='$stsess' AND borno_result_term_id='$term'  AND borno_student_info_id='$stdId' GROUP BY borno_student_info_id";
...
function Header()
{
    ...
    $this->Image($borderfnl,5,1,200,294);
	
	$finalSchoolLogo1=$GLOBALS['finalSchoolLogo'];
  
    $this->Image($finalSchoolLogo1,9,8,25,25);
...
function Footer()
{
   ...
   // $this->Image($finalgtschoolsignature1,148,272,30,10);
...
$this->Cell(60,5,"Class Teacher's Signature",0,0,"C");

	
	$this->Cell(5,5,"",0,0,"L");
	$this->Cell(35,5,$GLOBALS['fnshead'],0,0,"R");
	$this->Cell(355,5,"Signature",0,0,"L"); 
...
$pdf->Image($stphotofina,40,18,20,20);


if($studClass==1 OR $studClass==2)
{
  $result23 ="select * from borno_school_9_10_merit where borno_school_class_id='$studClass'  AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND borno_school_roll='$roll'";
...
$pdf->Cell(50,2,'',0,0,"C");
$pdf->Cell(80,2,'Progress Report',0,0,"C"); 
...
$pdf->Ln();
$pdf->SetFont('Arial','U',12);
$pdf->Cell(130,5,"Progress Report of : $fstname",0,0,"L");
...
$pdf->Cell(30,5,$fnsclass,0,0,"L");
$pdf->SetFont('Arial','',10);
$pdf->Cell(20,5,"Roll :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->Cell(20,5,$gtstotal111,0,0,"L");
$pdf->SetFont('Arial','',10);

$pdf->Cell(20,5,"Shift :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->Cell(25,5,$fnsshift,0,0,"L");

$pdf->Ln();
$pdf->SetFont('Arial','',10);
$pdf->Cell(15,5,"Section :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->Cell(20,5,$fnssection,0,0,"L");
$pdf->SetFont('Arial','',10);
$pdf->Cell(30,5,"Exam Type :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->Cell(30,5,$fnsterm,0,0,"L");
$pdf->SetFont('Arial','',10);
$pdf->Cell(30,5,"Exam Year :",0,0,"L");
$pdf->SetFont('Arial','I',10);
$pdf->Cell(15,5,$stsess,0,0,"L");
...
$numbertype ="select * from borno_result_number_type where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass'";
		...
		$pdf->Cell(18,5,"Full Marks",1,0,"C");
		
		
		$pdf->Cell(13,5,$type1,1,0,"C");
		$pdf->Cell(13,5,$type2,1,0,"C");
		$pdf->Cell(13,5,$type3,1,0,"C");
		$pdf->Cell(15,5,$type4,1,0,"C");
		$pdf->Cell(25,5,"Total",1,0,"C");
		$pdf->Cell(23,5,"Highest Mark",1,0,"C");
...
if($stN==1 OR $stN==2)
{					
$gtstotal1 ="select * from borno_class9_10_final_result where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND pare=1";
...
{
$gtstotal ="select * from borno_class9_10_final_result where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND borno_subject_nine_ten_id=$stN";
					$qgtstotal=$mysqli->query($gtstotal);
					$sqgtstotal=$qgtstotal->fetch_assoc();
...
$result22 = "select * from borno_height_mark_class9_10 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND borno_subject_nine_ten_id=$stN";
		...
		$pdf->Cell(23,5,$fssthigh,1,0,"C");	
		$pdf->Cell(10,10,$stphone,1,0,"C");
		$pdf->Cell(10,10,$stgp,1,0,"C");
		$pdf->Cell(15,5,'',2,0,"C");
		}
		elseif($stN==2)
		{
...
$pdf->SetFont('Arial','',12);
		...
		$pdf->Cell(122,6,"GrandTotal / GPA With 4th Subject",1);
$gtstotal ="select * from borno_school_9_10_merit where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term AND borno_school_stud_group='$group' AND borno_school_roll=$gtstotal111";
					$qgtstotal=$mysqli->query($gtstotal);
...
$pdf->Ln();
$pdf->Cell(122,6,"GrandTotal / GPA Without 4th Subject",1);
$pdf->Cell(25,6,$fstotal13,1,0,"C");
$pdf->Cell(23,6,'',1);
$pdf->Cell(20,6,$fstotal114,1,0,"C");
$pdf->Ln();	
$gt4th="select * from borno_class9_10_final_result where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND 	stu4thsub=1";
...
$pdf->Cell(190,6,"4th Subject Name : $fsstgtsubject4th",1);
}
else
{
				
$pdf->Cell(190,6,"4th Subject Name : ",1);
}
$pdf->Ln();	
$pdf->Cell(110,1,'',0,5,"C"); 
$pdf->Ln();

$pdf->SetFont('Arial','',10);
$resultun = "select * from borno_class9_10_final_result where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND borno_school_roll='$gtstotal111' AND uncountable=1 order by borno_subject_nine_ten_id asc";
$s11l=0;
...
$result22un = "select * from borno_height_mark_class9_10 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_stud_group='$group' AND borno_subject_nine_ten_id=$stNun";
...
$subjectdetailsun ="select * from borno_result_nine_ten_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$term' AND borin_subject_nine_ten_id='$stNun'";
		...
		$pdf->Cell(50,5,$fsstgtsubjectun,1);
		$pdf->Cell(18,5,$fsstgtsubject1un,1,0,"C");
		if($subtypeun1!=0)
		{		
		$pdf->Cell(13,5,$stNun1,1,0,"C");
		}
		else
		{
		$pdf->Cell(13,5,'-',1,0,"C");
		...
		$pdf->Cell(23,5,$fssthighun,1,0,"C");	
		$pdf->Cell(10,5,$stgpa,1,0,"C");
		$pdf->Cell(10,5,$stlg,1,0,"C");
 $pdf->Ln();       
}
...
$gtstotal1 ="select * from borno_school_9_10_merit where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term AND borno_school_stud_group='$group' AND borno_school_roll=$gtstotal111";
					$qgtstotal1=$mysqli->query($gtstotal1);
...
$failno=$stggtstotal1['failno'];
	...
	if ($failno!="0"){
		...
		$pdf->SetTextColor(0,0,0);
		$pdf->Cell(40,6,"Total Fail Subject",1,0,"C");
		if ($failno!="0"){
		   $pdf->SetTextColor(255,0,0); 
		  $pdf->Cell(10,6,$failno,1,0,"C"); 
		}
		else{
		    $pdf->SetTextColor(0,0,0);
		    $pdf->Cell(10,6,"-",1,0,"C");
		...
		$pdf->Ln();
		$pdf->Ln();
		$pdf->Cell(190,6,"Opinion about Result (Filled up by Class Teacher)",1,0,"C");
		$pdf->Ln();
		$pdf->Cell(190,18,'',1);
...
$gtstotal1123 ="select * from borno_school_9_10_merit where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term AND borno_school_stud_group='$group'";
	                $qgtstotal1123=$mysqli->query($gtstotal1123);
					$totalstudent=mysqli_num_rows($qgtstotal1123); 
					
$gtsattend ="select * from borno_school_attendence where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term AND borno_school_roll='$gtstotal111'";
...
$pdf->Cell(20,5,$totalstudent,1,0,"C");					
$pdf->Cell(30,5,"Schooling Day",1);
$pdf->Cell(20,5,$schoolingday,1,0,"C");;
$pdf->Cell(25,5,"Presence",1);
$pdf->Cell(20,5,$presence,1,0,"C");
$pdf->Cell(25,5,"Absence",1);
$pdf->Cell(20,5,$absence,1,0,"C");
$pdf->Cell(5,5,'',0);
$pdf->Ln();	
$pdf->Ln();	
...
$pdf->Cell(15,5,'',1);
$pdf->Cell(30,5,"Very Good",1);
$pdf->Cell(15,5,'',1);
$pdf->Cell(30,5,"Good",1);
$pdf->Cell(15,5,'',1);
$pdf->Cell(40,5,"Need To Improve",1);
$pdf->Cell(15,5,'',1);
$pdf->Ln();
$pdf->Ln();
...
$gtsattend1 ="select * from borno_school_assesment where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term AND borno_school_roll='$gtstotal111'";
...
$pdf->Cell(15,5,"Regulation",1,0,"C");	
$pdf->Cell(15,5,"Patritism",1,0,"C");
$pdf->Cell(15,5,"Honesty",1,0,"C");
$pdf->Cell(15,5,"leadership",1,0,"C");
$pdf->Cell(15,5,"Discipline",1,0,"C");
$pdf->Cell(20,5,"Cooperation",1,0,"C");
$pdf->Cell(25,5,"Active Participation",1,0,"C");
$pdf->Cell(15,5,"Sympathy",1,0,"C");
$pdf->Cell(15,5,"Awareness",1,0,"C");
$pdf->Cell(15,5,"Punctuality",1,0,"C");
...
{
$result23 ="select * from borno_class6_8_final_result where borno_school_class_id='$studClass'  AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_roll='$roll'";
...
$gtstname ="select * from borno_student_info where borno_student_info_id='$gtstuid'";
...
$numbertype ="select * from borno_result_number_type where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass'";
 ...
 $gtstotalban ="select * from borno_class6_8_temp_mark1 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=18";
...
if($stNbangla!=""){
 ...
 $gtstotalban1 ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=18";
  ...
  $gtstotalban1h ="select * from borno_height_mark_class6_8 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND subject_id_six_eight=18";
...
$gtsubjectb ="select * from borno_subject_six_eight where subject_id_six_eight=$stNbangla";
		...
		$pdf->Cell(50,5,$fsstgtsubjectb,1);
 ...
 $fsstgtsubject1b=$stgtsubject1b['sub_six_eight_fullmark'];
        $pdf->Cell(18,5,$fsstgtsubject1b,1,0,"C");
...
$subjectdetailsb ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$term' AND subject_id_six_eight='$stNbangla'";
        ...
        if($subtypeb1!=0)
		{		
		 $pdf->Cell(13,5,$stNbangla1,1,0,"C");
		}
		else
		{
		$pdf->Cell(13,5,'-',1,0,"C");
		...
		if($subtypeb2!=0)
		{		
		$pdf->Cell(13,5,$stNbangla2,1,0,"C");
		}
		else
		{
		$pdf->Cell(13,5,'-',1,0,"C");
		...
		if($subtypeb3!=0)
		{		
	   $pdf->Cell(13,5,$stNbangla3,1,0,"C");
		}
		else
		{
		$pdf->Cell(13,5,'-',1,0,"C");
		...
		if($subtypeb4!=0)
		{		
		$pdf->Cell(15,5,$stNbangla4,1,0,"C");
		}
		else
		{
		$pdf->Cell(15,5,'-',1,0,"C");
        ...
        $pdf->Cell(25,5,$stNbanglatotal,1,0,"C");	
		$pdf->Cell(23,5,$stNamebanh,1,0,"C");	
		$pdf->Cell(10,5,$stphoneban,1,0,"C");
		$pdf->Cell(10,5,$stgpban,1,0,"C");	

$pdf->Ln();    
}

 $gtstotaleng ="select * from borno_class6_8_temp_mark1 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=19";
...
if($stNenglish!=""){
  ...
  $gtstotaleng1 ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=19";
 ...
 $gtstotaleng1h ="select * from borno_height_mark_class6_8 where borno_school_class_id=$studClass AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND subject_id_six_eight=19";
...
$gtsubjecte ="select * from borno_subject_six_eight where subject_id_six_eight=$stNenglish";
		...
		$pdf->Cell(50,5,$fsstgtsubjecte,1);
 ...
 $fsstgtsubject1e=$stgtsubject1e['sub_six_eight_fullmark'];
        $pdf->Cell(18,5,$fsstgtsubject1e,1,0,"C");
...
$subjectdetailse ="select * from borno_result_six_eight_subject_details where borno_school_session='$stsess' AND borno_school_id='$schId' AND borno_school_class_id='$studClass' AND borno_result_term_id='$term' AND subject_id_six_eight='$stNenglish'";
		...
		if($subtypee1!=0)
		{		
		$pdf->Cell(13,5,$stNenglish1,1,0,"C");
		}
		else
		{
		$pdf->Cell(13,5,'-',1,0,"C");
		...
		if($subtypee2!=0)
		{		
		$pdf->Cell(13,5,$stNenglish2,1,0,"C");
		}
		else
		{
		$pdf->Cell(13,5,'-',1,0,"C");
		...
		if($subtypee3!=0)
		{		
		$pdf->Cell(13,5,$stNenglish3,1,0,"C");
		}
		else
		{
		$pdf->Cell(13,5,'-',1,0,"C");
		...
		if($subtypee4!=0)
		{		
		$pdf->Cell(15,5,$stNenglish4,1,0,"C");
		}
		else
		{
		$pdf->Cell(15,5,'-',1,0,"C");
        ...
        $pdf->Cell(25,5,$stNenglishtotal,1,0,"C");	
		$pdf->Cell(23,5,$stNameengh,1,0,"C");	
		$pdf->Cell(10,5,$stphoneeng,1,0,"C");
		$pdf->Cell(10,5,$stgpeng,1,0,"C");	

	$pdf->Ln();    
}

 $result = "select * from borno_class6_8_temp_mark1 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight!=18 AND subject_id_six_eight!=19 order by subject_id_six_eight asc";
$sl=0;
...
if($stN==1 OR $stN==2 OR $stN==3 OR $stN==4)
{
$gtstotal ="select * from borno_class6_8_temp_mark1 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=$stN";
					$qgtstotal=$mysqli->query($gtstotal);
					$sqgtstotal=$qgtstotal->fetch_assoc();	
...
if($stN==1 OR $stN==2)
{					
$gtstotal1 ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND pare=1";
					$qgtstotal1=$mysqli->query($gtstotal1);
					$sqgtstotal1=$qgtstotal1->fetch_assoc();
					$stName1=$sqgtstotal1['res_total_conv'];
					$stphone=$sqgtstotal1['res_gpa'];
...
elseif($stN==3 OR $stN==4)
{					
$gtstotal1 ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND pare=2";
					$qgtstotal1=$mysqli->query($gtstotal1);
					$sqgtstotal1=$qgtstotal1->fetch_assoc();
					$stName1=$sqgtstotal1['res_total_conv'];
					$stphone=$sqgtstotal1['res_gpa'];
...
{
$gtstotal ="select * from borno_class6_8_final_result where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND subject_id_six_eight=$stN";
					$qgtstotal=$mysqli->query($gtstotal);
					$sqgtstotal=$qgtstotal->fetch_assoc();
					$stName=$sqgtstotal['res_total_conv'];
					$stphone=$sqgtstotal['res_gpa'];
...
$result22 = "select * from borno_height_mark_class6_8 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND subject_id_six_eight=$stN";
					$qresult22=$mysqli->query($result22);
					$row22=$qresult22->fetch_assoc();
				$fssthigh=$row22['getmaxmark'];	
...
$pdf->SetFont('Arial','',12);
		...
		$pdf->Cell(122,6,"GrandTotal / GPA",1);
$gtstotal ="select * from borno_school_6_8_merit where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term AND borno_school_roll=$gtstotal111";
					$qgtstotal=$mysqli->query($gtstotal);
					$stggtstotal=$qgtstotal->fetch_assoc();
$pdf->SetFont('Arial','',12);
$fstotal=$stggtstotal['grandtotal'];
...
$pdf->Ln();
$pdf->SetFont('Arial','',12);
$pdf->Cell(190,1,'',0,5,"C"); 
$pdf->Ln();
$pdf->SetFont('Arial','',10);
 $resultun = "select * from borno_class6_8_final_result where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND uncountable=1 order by subject_id_six_eight asc";
$s11l=0;
...
$result22un = "select * from borno_height_mark_class6_8 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND subject_id_six_eight=$stNun";
					$qresult22un=$mysqli->query($result22un);
					$row22un=$qresult22un->fetch_assoc();
				$fssthighun=$row22un['getmaxmark'];	        
...
$gtstotal1 ="select * from borno_school_6_8_merit where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term AND borno_school_roll=$gtstotal111";
					$qgtstotal1=$mysqli->query($gtstotal1);
					$stggtstotal1=$qgtstotal1->fetch_assoc();
$pdf->SetFont('Arial','',12);
$fmerit1=$stggtstotal1['merit_section'];
...
$gtstotal1123 ="select * from borno_school_6_8_merit where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term";
	                $qgtstotal1123=$mysqli->query($gtstotal1123);
					$totalstudent=mysqli_num_rows($qgtstotal1123); 
...
{
$result23 ="select * from borno_class1_final_result where borno_school_class_id='$studClass'  AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term'  AND borno_school_roll='$roll'";
					$qgresult23=$mysqli->query($result23);
...
$result = "select * from borno_class1_temp_mark1 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' order by borno_result_subject_id asc";
$sl=0;
...
$result22 = "select * from borno_maxnumber_class1 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_result_subject_id=$stN";
					$qresult22=$mysqli->query($result22);
					$row22=$qresult22->fetch_assoc();
					$fssthigh=$row22['getmaxmark'];	
		...
		$gtsgpa ="select * from borno_class1_final_result where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND pare='1'";
...
$pdf->SetFont('Arial','',12);
		...
		$pdf->Cell(110,6,"GrandTotal / GPA",1);
 $gtstotal ="select * from borno_school_play_5_merit where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term AND borno_school_roll=$gtstotal111";
					$qgtstotal=$mysqli->query($gtstotal);
					$stggtstotal=$qgtstotal->fetch_assoc();
$pdf->SetFont('Arial','',12);
$fstotal=$stggtstotal['grandtotal'];
...
$pdf->Ln();
$pdf->SetFont('Arial','',10);
 $resultun = "select * from borno_class1_final_result where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND subst=1 order by borno_result_subject_id asc";
$s11l=0;
...
$result22un = "select * from borno_maxnumber_class1 where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id='$term' AND borno_result_subject_id=$stNun";
					$qresult22un=$mysqli->query($result22un);
					$row22un=$qresult22un->fetch_assoc();
				$fssthighun=$row22un['getmaxmark'];	        
...
$gtstotal1 ="select * from borno_school_play_5_merit where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term AND borno_school_roll=$gtstotal111";
					$qgtstotal1=$mysqli->query($gtstotal1);
					$stggtstotal1=$qgtstotal1->fetch_assoc();
$pdf->SetFont('Arial','',12);
$fmerit1=$stggtstotal1['merit_section'];
...
$gtstotal1123 ="select * from borno_school_play_5_merit where borno_school_class_id=$studClass  AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term";
	                $qgtstotal1123=$mysqli->query($gtstotal1123);
					$totalstudent=mysqli_num_rows($qgtstotal1123);
