...
<div class="wrapper">
    ...
    <div class="ot_main_body" style="margin-top:5px; margin-left:5px;">
        ...
        $data1="select * from borno_student_info where borno_student_info_id='$stdid' ";
...
$ClassId=$showdata1['borno_school_class_id'];
                                      
  $curclass="select * from borno_school_class where borno_school_class_id='$ClassId'";
 $qgcurclass=$mysqli->query($curclass);
  $shgcurclass=$qgcurclass->fetch_assoc();
  $classname=$shgcurclass['borno_school_class_name'];
  

        ?>     
  <h2> Progress Report  [Current Class : <?php echo $classname; ?>] </h2></div>
                <div class="form">
