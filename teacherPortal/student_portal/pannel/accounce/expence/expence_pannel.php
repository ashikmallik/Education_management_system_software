...
$schId=$shget_schoolName['borno_school_id'];
	...
	$sql = "Select receipt.borno_school_sub_fund_id, subFund.sub_fund_name, receipt.borno_school_fee, receipt.borno_school_memo from borno_school_receipt receipt Left Join borno_school_sub_fund subFund On receipt.borno_school_sub_fund_id=subFund.borno_school_sub_fund_id where receipt.borno_school_id='$schId' AND receipt.borno_student_info_id='$stdid' AND receipt.borno_school_session='$session' AND receipt.borno_school_fund_id=2 Group By receipt.borno_school_sub_fund_id,receipt.borno_school_memo Asc";
