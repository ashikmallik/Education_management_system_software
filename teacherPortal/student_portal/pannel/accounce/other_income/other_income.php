...
<option value="December"<?php if($_POST['month']==December) { echo "selected"; } ?>> December </option>
  ...
  <tr>
    ...
    <td>
    <select name="exhead" id="exhead" onchange="callpage();">
    <option value=""> Select </option>
               <?php
					$data1="select * from borno_school_other_income where borno_school_id='$schId' group by borno_school_income_head asc";
					$qdata1=$mysqli->query($data1);
					while($showdata1=$qdata1->fetch_assoc()){ 
				
	 ?>
    <option value=" <?php echo $showdata1['borno_school_income_head']; ?>" <?php if($showdata1['borno_school_income_head']==$_POST['exhead']) { echo "selected"; }  ?>> <?php echo $showdata1['borno_school_income_head']; ?></option>
     <?php } ?>
                              </select>
    </td>
    <td><input name="exhead1" type="text" id="exhead1" size="30"/></td>
  </tr>                      
    <tr>
    <td class="text_table">Income Name *</td>
    
    <td>
    <select name="exname" id="exname" onchange="callpage();">
    <option value=""> Select </option>
              <?php
					$data2="select * from borno_school_other_income where borno_school_id='$schId' group by borno_school_income_name asc";
					$qdata2=$mysqli->query($data2);
					while($showdata2=$qdata2->fetch_assoc()){ 
				
	 ?>
    <option value=" <?php echo $showdata2['borno_school_income_name']; ?>" <?php if($showdata2['borno_school_income_name']==$_POST['exname']) { echo "selected"; }  ?>> <?php echo $showdata2['borno_school_income_name']; ?></option>
      <?php } ?>
                              </select>
    </td>
    <td><input name="exname1" type="text" id="exname1" size="30"/></td>
  </tr>     
    <tr>
    <td class="text_table">Narration *</td>
    
    <td>
   <input type="text" name="narr" id="narr" size="30"/>
    </td>
      </tr>  
     <tr>
 <td class="text_table">Amount *</td>
 <td><input name="amount" type="text" id="amount" size="30"/></td>
  </tr>
   <tr>
