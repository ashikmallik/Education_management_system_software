...
$stdsession= trim($_POST['stsess']);
 ...
 $sql ="select * from borno_school_balance where borno_student_info_id='$stdid' and borno_school_session='$stdsession' group by borno_school_class_id,borno_school_section_id,borno_school_shift_id ";
...
$pdf->Cell(190,5,"Due History",0,0,"C");
$pdf->Ln();
...
$pdf->Cell(130,5,"Fund Name",1,0,"L");
$pdf->Cell(20,5,":",1,0,"C");
$pdf->Cell(40,5,"Amount",1,0,"R");
...
$pdf->Cell(130,5,"$fundname $subfundname",1,0,"L");	
$pdf->SetFont('Arial','B',10);	
$pdf->Cell(20,5,":",1,0,"C");
$pdf->SetFont('Arial','',10);	
$pdf->Cell(40,5,"$fees",1,0,"R");
$pdf->Ln();
					}
$totalamount=0;		
$total = array();		
 $result2 ="select * from borno_school_balance where borno_student_info_id='$stdid' and borno_school_session='$stdsession' order by borno_school_fund_id,borno_school_sub_fund_id asc";
	...
	$pdf->SetFont('Arial','B',10);
$pdf->Cell(130,5,"Total Due Ammount",1,0,"L");
$pdf->SetFont('Arial','B',10);	
$pdf->Cell(20,5,":",1,0,"C");
if($totalamount==0)
{
$pdf->Cell(40,5,"Paid",1,0,"R");    
}
else
{
$pdf->Cell(40,5,"$totalamount/-",1,0,"R");					
}			
