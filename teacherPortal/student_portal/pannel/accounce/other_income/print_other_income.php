...
<script language="javascript">
	...
	function callpage()
	{
	 document.frmcontent.action="print_other_income.php";
...
<div class="wrapper">
    ...
    <div class="ot_main_body" style="margin-top:5px; margin-left:5px;">
            <div class="ot_body_fixed">
                ...
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="download_receipt3.php" method="post" enctype="multipart/form-data" target="">
...
<table  border="" cellspacing="0" cellpadding="0" style="color:#000; margin-left:50px; margin-top:-35px" > 
  <tr>
    ...
    <option value="">--Session--</option>
      <?php
					$data1="select borno_school_session from borno_school_balance where borno_student_info_id='$stdid' group by borno_school_session asc";
...
<td >  <?php echo $fundname; ?> &nbsp;  <?php echo $subfundname; ?>    </td>       
  <td align="center" > : </td>     
   <td align="right">  <?php echo $fees; ?>    </td>       
          ...
          <?php } ?>
     		...
     		<tr>
        	<td> <b>Total Due Ammount</b></td>
            <td align="center"><b>: </b></td>
             <?php
         $SQL = "SELECT SUM(borno_school_fee) As Ammount from borno_school_balance where borno_student_info_id='$stdid' and borno_school_session='$stdsession' order by borno_school_fund_id,borno_school_sub_fund_id asc";
...
<table  border="" cellspacing="0" cellpadding="0" style="color:#000; margin-left:50px;" > 
   ...
   <tr>
<td colspan="2" align="center"><input type="submit" name="button" id="button" value="Download Due Report" onClick="return contalt_valid()" formtarget="_blank"></td>
  </tr>
