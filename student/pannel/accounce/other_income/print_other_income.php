...
<div class="wrapper">
    ...
    <div class="ot_main_content">
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                ...
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="download_receipt3.php" method="post" enctype="multipart/form-data" target="_blank">
                        <?php
			$msg=$_GET['msg'];
 ...
 ?>
   ...
   <tr>
<td colspan="2" align="center"><input type="submit" name="button" id="button" value="Due Report" onClick="return contalt_valid()"></td>
  </tr>
