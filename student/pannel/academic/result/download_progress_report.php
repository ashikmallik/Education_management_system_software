...
{
  $stdinfo ="select * from borno_class9_10_final_result  where borno_school_class_id='$studClass' AND borno_school_id='$schId'  AND borno_school_session='$stsess' AND borno_result_term_id='$term'  AND borno_student_info_id='$stdId' GROUP BY borno_student_info_id";
  
  					$qstdinfo=$mysqli->query($stdinfo);
					$shqstdinfo=$qstdinfo->fetch_assoc();
  
    $branchId=$shqstdinfo['borno_school_branch_id'];
...
$fnsterm=$sqgtterm['borno_result_term_name'];
 ...
 $gtstotalday ="select * from borno_school_schooling_day where borno_school_class_id=$studClass AND borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id=$shiftId AND borno_school_section_id=$section AND borno_school_session=$stsess AND borno_result_term_id=$term";
		...
		$finalSchoolLogo="logo_sc.png";	
		
		$finalgtschoolsignature="mgbhs_hm.jpg";
...
{
    // Logo
    //$this->Image('$finalSchoolLogo',10,6,30);
    // Arial bold 15
 ...
 //$this->Image(logo_sc.png,12,5,25,25);
...
{
$result23 ="select * from borno_class1_final_result where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term'  AND borno_school_roll='$roll'";
