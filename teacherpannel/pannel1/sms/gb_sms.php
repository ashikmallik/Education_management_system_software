...
<head>
    ...
    <script language="javascript">
		function callpage()
		{
		 document.frmart.action="gb_sms.php";
	...
	<div class="left_fixed">
		<div class="logo_top">
		  <a href="index.php"><img src="images/indiv/sms.jpg" height="80px" width="120px"></a>
			<a href=""><img src="../../images/sms/in13.jpg" height="80px" width="120px"></a>
		</div>
	...
	<div class="main_content_ind">
		<div class="sm_main_part">
			<div class="in_form">
                ...
                <br><br>				
                <form name="myForm" action="gb_sms_do.php" method="post" enctype="multipart/form-data">
