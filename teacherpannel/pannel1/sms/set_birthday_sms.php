...
<head>
    ...
    <script language="javascript">
		function callpage()
		{
		 document.frmart.action="set_birthday_sms.php";
	...
	<div class="left_fixed">
		<div class="logo_top">
		  <a href="index.php"><img src="images/indiv/sms.jpg" height="80px" width="120px"></a>
			<a href=""><img src="../../images/sms/in08.jpg" height="80px" width="120px"></a>
		</div>
	...
	<div class="main_content_ind">
		<div class="sm_main_part">
			<div class="in_form">
                ...
                <form name="myForm" action="set_birthday_sms_do.php" method="post" enctype="multipart/form-data">
                        ...
                        ?>
							<tr>
								...
								<td>
                                     ...
                                     <textarea name="message" cols="45" rows="3" id="message" onKeyDown="textCounter(document.myForm.message,document.myForm.remLen1,160)" onKeyUp="textCounter(document.myForm.message,document.myForm.remLen1,160)"><?php echo trim($smsfound['msg_details']);?></textarea>
						...
						<tbody>
							<tr>
								...
								<td>
                                     ...
                                     <textarea name="message" cols="45" rows="3" id="message" onKeyDown="textCounter(document.myForm.message,document.myForm.remLen1,70)" onKeyUp="textCounter(document.myForm.message,document.myForm.remLen1,70)"><?php echo trim($smsfound['msg_details']);?></textarea>
