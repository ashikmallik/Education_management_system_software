...
<head>
    ...
    <script language="javascript">
		function callpage()
		{
		 document.frmart.action="sms_own_number.php";
	...
	<div class="left_fixed">
		<div class="logo_top">
		  <a href="index.php"><img src="images/indiv/sms.jpg" height="80px" width="120px"></a>
			<a href=""><img src="images/sms/own.jpg" height="80px" width="120px"></a>
		</div>
	...
	<div class="main_content_ind">
		<div class="sm_main_part">
			<div class="in_form">
                ...
                <form name="myForm" action="own_sms_do.php" method="post" enctype="multipart/form-data">
						...
						<tbody>
							<tr>
								...
								<td>
                                     ...
                                     <textarea name="message" cols="45" rows="3" id="message" onKeyDown="textCounter(document.myForm.message,document.myForm.remLen1,134)" onKeyUp="textCounter(document.myForm.message,document.myForm.remLen1,134)"></textarea>

                <br>

<input readonly type="text" name="remLen1" size="3" maxlength="3" value="134">
