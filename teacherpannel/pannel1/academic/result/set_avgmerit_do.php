...
$gtctmarg1="select * from borno_class9_10_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_school_stud_group='$group1' group by borno_student_info_id asc";
	...
	while($shgtctmarg1=$qgtctmarg1->fetch_assoc()){
		...
		$gtctmarg="select * from borno_class9_10_avg_result where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_school_stud_group='$group1' AND borno_student_info_id='$studinfoId1' AND stu4thsub=0 AND uncountable=0";
...
if($studClass1==1 OR $studClass1==2)
{
 $gtctmarg="select * from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_subject_nine_ten_dept='$group1' AND gpa!=0 group by gpa, grandtotal";
...
if($studClass1==1 OR $studClass1==2)
{
 $gtctmarg="select * from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_subject_nine_ten_dept='$group1' AND gpa!=0 group by gpa, grandtotal";
...
if($studClass1==1 OR $studClass1==2)
{
 ...
 $gtctmarg="select * from borno_school_910_avg_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_session='$stsess1' AND borno_result_term_id='0' AND borno_subject_nine_ten_dept='$group1' AND gpa!=0 group by gpa, grandtotal";
...
if($qins) { header("location:set_avgmerit.php?msg=1&branchId=$branchId1&studClass=$studClass1&shiftId=$shiftId1&section=$section&stsess=$stsess1");} else { header('location:set_avgmerit.php?msg=2');}
