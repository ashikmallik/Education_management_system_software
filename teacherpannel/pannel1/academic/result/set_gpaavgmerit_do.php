...
$gtctmarg1="select * from borno_school_9_10_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_school_stud_group='$group1' group by borno_student_info_id asc";
	...
	while($shgtctmarg1=$qgtctmarg1->fetch_assoc()){
		...
		$gtctmarg="select * from borno_school_9_10_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_school_stud_group='$group1' AND borno_student_info_id='$studinfoId1'";
	...
	while($shgtctmarg=$qgtctmarg->fetch_assoc()){
	   ...
	   $totalmark3=$totalmark2/$totalterm;
	   ...
	   $gttotalgpa3=$totalgpa2/$totalterm;
	    ...
	    if($totalmark!=0)
{
	...
	VALUES ('$schId', '$branchId1', '$studClass1', '$shiftId1', '$section1', '$stsess1', '$group1', '0', '$studinfoId', '$studRoll', '$studName', '$totalmark','$totalmark3', '$gtFinalGPA','$gtFinalGPA1', '$finallg', '0', '', '0', '', '0','', '0', '')";
...
$gtctmarg1="select * from borno_school_6_8_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id=$studClass1 AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' group by borno_student_info_id asc";
	...
	while($shgtctmarg1=$qgtctmarg1->fetch_assoc()){
		...
		$gtctmarg="select * from borno_school_6_8_merit where borno_school_id='$schId' AND borno_school_branch_id='$branchId1' AND borno_school_class_id='$studClass1' AND borno_school_shift_id='$shiftId1' AND borno_school_section_id='$section1' AND borno_school_session='$stsess1' AND borno_student_info_id='$studinfoId1'";
	    ...
	    if($totalmark!=0)
{
	...
	VALUES ('$schId', '$branchId1', '$studClass1', '$shiftId1', '$section1', '$stsess1', '0', '$studinfoId', '$studRoll', '$studName', '$totalmark', '$gtFinalGPA', '$finallg', '0', '', '0', '', '0', '', '0', '')";
...
if($qins) { header('location:set_gpaavgmerit.php?msg=1');} else { header('location:set_gpaavgmerit.php?msg=2');}
