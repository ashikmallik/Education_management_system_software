...
function Header()
{
	...
	if($GLOBALS['s1l']==1)
	{
	$this->Cell(44,5,$GLOBALS['subname1'],1,0,'L');
	}
	if($GLOBALS['s1l']==2)
	{
	$this->Cell(44,5,$GLOBALS['subname1'],1,0,'L');
	$this->Cell(44,5,$GLOBALS['subname2'],1,0,'L');	
	}
	if($GLOBALS['s1l']==3)
	{
	$this->Cell(44,5,$GLOBALS['subname1'],1,0,'L');
	$this->Cell(44,5,$GLOBALS['subname2'],1,0,'L');	
	$this->Cell(44,5,$GLOBALS['subname3'],1,0,'L');	
	}
	if($GLOBALS['s1l']==4)
	{
	$this->Cell(44,5,$GLOBALS['subname1'],1,0,'L');
	$this->Cell(44,5,$GLOBALS['subname2'],1,0,'L');	
	$this->Cell(44,5,$GLOBALS['subname3'],1,0,'L');	
	$this->Cell(44,5,$GLOBALS['subname4'],1,0,'L');	
	}
	if($GLOBALS['s1l']==5)
	{
	$this->Cell(44,5,$GLOBALS['subname1'],1,0,'L');
	...
	$this->Cell(44,5,$GLOBALS['subname3'],1,0,'L');	
	$this->Cell(44,5,$GLOBALS['subname4'],1,0,'L');	
	$this->Cell(44,5,$GLOBALS['subname5'],1,0,'L');	
	}
	if($GLOBALS['s1l']>=6)
	{
	$this->Cell(44,5,$GLOBALS['subname1'],1,0,'L');
	...
	$this->Cell(44,5,$GLOBALS['subname4'],1,0,'L');	
	$this->Cell(44,5,$GLOBALS['subname5'],1,0,'L');	
	$this->Cell(44,5,$GLOBALS['subname6'],1,0,'L');	
	}
...
$resulname ="select * from borno_student_info where borno_student_info_id='$gtstdid'";
	...
	elseif($subid7==""){$subidend=$subid6;}	
	elseif($subid8==""){$subidend=$subid6;}
	elseif($subid9==""){$subidend=$subid6;}
	else{$subidend=$subid6;}
