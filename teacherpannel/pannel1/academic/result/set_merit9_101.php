...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="set_merit9_101.php";
...
<form name="frmcontent" id="myform" action="set_merit9101_do.php" method="post" enctype="multipart/form-data">
