...
function Header()
{
	...
	if($GLOBALS['s1l']==7)
	{	
	$this->Cell(44,5,$GLOBALS['subname7'],1,0,'L');
	}
	if($GLOBALS['s1l']==8)
	{
	$this->Cell(44,5,$GLOBALS['subname7'],1,0,'L');
	$this->Cell(44,5,$GLOBALS['subname8'],1,0,'L');
	}
	if($GLOBALS['s1l']==9)
	{
	$this->Cell(44,5,$GLOBALS['subname7'],1,0,'L');
	$this->Cell(44,5,$GLOBALS['subname8'],1,0,'L');
	$this->Cell(44,5,$GLOBALS['subname9'],1,0,'L');	
	}
	if($GLOBALS['s1l']==10)
	{
	$this->Cell(44,5,$GLOBALS['subname7'],1,0,'L');
	$this->Cell(44,5,$GLOBALS['subname8'],1,0,'L');
	$this->Cell(44,5,$GLOBALS['subname9'],1,0,'L');	
	$this->Cell(44,5,$GLOBALS['subname10'],1,0,'L');
	}	
	if($GLOBALS['s1l']==11)
	{
	$this->Cell(44,5,$GLOBALS['subname7'],1,0,'L');
	...
	$this->Cell(44,5,$GLOBALS['subname9'],1,0,'L');	
	$this->Cell(44,5,$GLOBALS['subname10'],1,0,'L');
	$this->Cell(44,5,$GLOBALS['subname11'],1,0,'L');
	}	
	if($GLOBALS['s1l']>=12)
	{
	$this->Cell(44,5,$GLOBALS['subname7'],1,0,'L');
	...
	$this->Cell(44,5,$GLOBALS['subname10'],1,0,'L');
	$this->Cell(44,5,$GLOBALS['subname11'],1,0,'L');
	$this->Cell(44,5,$GLOBALS['subname12'],1,0,'L');
	}	
	...
	if($GLOBALS['s1l']==7)
	{
	$this->Cell(11,5,$GLOBALS['numbertype1'],1,0,'C');
	$this->Cell(11,5,$GLOBALS['numbertype2'],1,0,'C');
...
$resulname ="select * from borno_student_info where borno_student_info_id='$gtstdid'";
	...
	if($subid7=="" AND $subid8=="" AND $subid9=="" AND $subid10=="" AND $subid11=="" AND $subid12==""){$subidend=$subid7;}	
	elseif($subid8=="" AND $subid9=="" AND $subid10=="" AND $subid11=="" AND $subid12==""){$subidend=$subid7;}
	elseif($subid9=="" AND $subid10=="" AND $subid11=="" AND $subid12==""){$subidend=$subid8;}
	elseif($subid10=="" AND $subid11=="" AND $subid12==""){$subidend=$subid9;}
	elseif($subid11=="" AND $subid12==""){$subidend=$subid10;}
	elseif($subid12==""){$subidend=$subid11;}
	else{$subidend=$subid12;}			
 $resultsub ="select * from borno_class1_temp_mark1 where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_school_roll='$gtstotal111' AND borno_result_subject_id!='$subid1' AND borno_result_subject_id!='$subid2' AND borno_result_subject_id!='$subid3' AND borno_result_subject_id!='$subid4' AND borno_result_subject_id!='$subid5' AND borno_result_subject_id!='$subid6'  AND borno_result_subject_id between '$subid7' AND '$subidend' order by borno_result_subject_id asc";
$sl2=0;
...
$resultlg ="select * from borno_class1_final_result where borno_school_class_id='$studClass' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$term' AND borno_result_subject_id='$subid' AND borno_school_roll='$gtstotal111'";
					...
					$pdf->Cell(11,5,$num1,1,0,'C');
					$pdf->Cell(11,5,$num2,1,0,'C');
