...
<br>
     ...
     $data="select * from borno_set_class_teacher where borno_school_teacher_id='$techId'";
            	...
            	$schId=trim($showdata['borno_school_id']);
                $brid=trim($showdata['borno_school_branch_id']);
                $studClass=trim($showdata['borno_school_class_id']);
                $getfshiftId=trim($showdata['borno_school_shift_id']);
                $getfsection=trim($showdata['borno_school_section_id']); 
				$clSess=trim($showdata['borno_school_session']);	
