...
<head>
	...
	function callpage()
	{
	 document.frmcontent.action="set_merit9_1002.php";
...
<form name="frmcontent" id="myform" action="set_merit9_10012_do.php" method="post" enctype="multipart/form-data">
<table width="650" border="0" cellspacing="0" cellpadding="0" class="projectlist" align="center">
  ...
  <tr>
    ...
    <td><select name="studClass" id="studClass" onchange="callpage();">
      ...
      <option value="2" <?php if($_REQUEST['studClass']==2) { echo "selected";} ?>> Nine </option>
      <option value="1" <?php if($_REQUEST['studClass']==1) { echo "selected";} ?>> Ten </option>
