<?php
 ...
 require_once '../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	if (!function_exists('clean_html')) {
		...
		$studClass21 = trim(strip_tags($_POST['studClass1']));
		
		$stsess2 = clean_html($_POST['stsess1']);
		$stsess21 = trim(strip_tags($_POST['stsess1']));
	...
	if($studClass1!=$studClass21 OR $stsess1!=$stsess21)
	{
	 	$branch="select * from `borno_grading_chart` where `borno_school_id`='$schId' AND `borno_school_class_id`='$studClass21' AND `borno_school_session`='$stsess21'";
	...
	$smsbranch=$rsQuery1->fetch_assoc();
	 ...
	 $bornoschBranch="INSERT INTO `borno_grading_chart` (`borno_school_id`, `borno_school_class_id`,`borno_school_session`,`marks_from1`,`marks_to1`, `letter_grade1`, `grade_point1`,`marks_from2`,`marks_to2`, `letter_grade2`, `grade_point2`,`marks_from3`,`marks_to3`, `letter_grade3`, `grade_point3`,`marks_from4`,`marks_to4`, `letter_grade4`, `grade_point4`,`marks_from5`,`marks_to5`, `letter_grade5`, `grade_point5`,`marks_from6`,`marks_to6`, `letter_grade6`, `grade_point6`,`marks_from7`,`marks_to7`, `letter_grade7`, `grade_point7`)
															...
															VALUES ('$schId','$studClass21', '$stsess21','$mrkfrom11','$mrkto11','$lg11','$gpa11','$mrkfrom21','$mrkto21','$lg21','$gpa21','$mrkfrom31','$mrkto31','$lg31','$gpa31','$mrkfrom41','$mrkto41','$lg41','$gpa41','$mrkfrom51','$mrkto51','$lg51','$gpa51','$mrkfrom61','$mrkto61','$lg61','$gpa61','$mrkfrom71','$mrkto71','$lg71','$gpa71')";
															
													
				$qbornoschBranch = $mysqli->prepare($bornoschBranch);
				$qbornoschBranch->execute();
			
				if($qbornoschBranch) { header('location:manage_grading.php?msg=4'); } else { header('location:manage_grading.php?msg=5'); }				
