  ...
  <tr>
    ...
    <option value="">--Select--</option>
	  ...
	  $studClass=$_REQUEST['studClass'];
					...
					$data1="select borno_school_session from borno_result_add_term where borno_school_id='$schId' and borno_school_class_id='$studClass' group by borno_school_session asc";
