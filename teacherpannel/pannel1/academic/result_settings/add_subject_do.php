 ...
 require_once '../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	if($gtermsess!="") { header('location:add_subject05.php?msg=3'); } else {
									...
									for($i=0; $i<count($perc); $i++){
										...
										if($perc[$i]!=""){
											$insmk="INSERT INTO `borno_result_subject` (`borno_school_id`,`borno_school_class_id`,`borno_school_session`, `borno_school_subject_name`, `borno_school_subject_fullmark`,`subst`)
