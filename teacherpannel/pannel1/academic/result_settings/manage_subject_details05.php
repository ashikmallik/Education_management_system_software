 ...
 ?>
    ...
    <option value="">--Select--</option>
	  ...
	  $studClass=$_REQUEST['studClass'];
					...
					$data1="select borno_school_session from borno_result_subject_details where borno_school_id='$schId' and borno_school_class_id='$studClass' group by borno_school_session asc";
...
<option value=" <?php echo $shqgstterm['borno_result_term_id']; ?>" <?php if($shqgstterm['borno_result_term_id']==$_REQUEST['term']) { echo "selected"; }  ?>> <?php echo $shqgstterm['borno_result_term_name']; ?></option>
      <?php } ?>
				...
				?>
					...
					$gsubdetails="select * from borno_result_subject_details where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' order by borno_result_subject_details_id asc";
					...
					$gsubject="select * from borno_result_subject where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_subject_id='$subjectname' order by borno_result_subject_id Asc";
          ...
          <input type="hidden" name="subdetailid[]" id="subdetailid[]" value="<?php echo $shqgsubdetails['borno_result_subject_details_id']; ?>" /></td>
