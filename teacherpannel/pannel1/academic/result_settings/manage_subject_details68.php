...
function callpage()
{
 document.frmcontent.action="manage_subject_details68.php";
...
-->        </div>
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2>Manage Subject Details Six to Eight</h2></div>
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="manage_subject_details68_do.php" method="post" enctype="multipart/form-data">
                        <?php
	$msg=$_GET['msg'];
 ...
 ?>
    ...
    <option value="">--Select--</option>
	  ...
	  $studClass=trim($_REQUEST['studClass']);
					...
					$data1="select borno_school_session from borno_result_six_eight_subject_details where borno_school_id='$schId' and borno_school_class_id='$studClass' group by borno_school_session asc";
 ...
 <?php
				...
				?>
<option value=" <?php echo $shqgstterm['borno_result_term_id']; ?>" <?php if($shqgstterm['borno_result_term_id']==trim($_REQUEST['term'])) { echo "selected"; }  ?>> <?php echo $shqgstterm['borno_result_term_name']; ?></option>
      <?php } ?>
    </select></td>
...
<option value=" <?php echo $shqgstterm['borno_result_term_id']; ?>" <?php if($shqgstterm['borno_result_term_id']==$_REQUEST['term']) { echo "selected"; }  ?>> <?php echo $shqgstterm['borno_result_term_name']; ?></option>
      <?php } ?>
				...
				?>
					...
					$gsubdetails="select * from borno_result_six_eight_subject_details where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id='$term' order by borin_subject_six_eight_id asc";
					$qgsubdetails=$mysqli->query($gsubdetails);
					while($shqgsubdetails=$qgsubdetails->fetch_assoc()){$s++;
				
					$subjectname=$shqgsubdetails['subject_id_six_eight'];

					$gsubject="select * from borno_subject_six_eight where  subject_id_six_eight='$subjectname'";
					$qgsubject=$mysqli->query($gsubject);
					$shqgsubject=$qgsubject->fetch_assoc();
				
					$gfullmark="select * from borno_set_subject_six_eight where  borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND  subject_id_six_eight='$subjectname'";
					$qgfullmark=$mysqli->query($gfullmark);
					$shqgfullmark=$qgfullmark->fetch_assoc();
				?>
                              <tr>
          <td align="center"><input name="subname[]" type="text" id="subname[]" value="<?php echo $shqgsubject['six_eight_subject_name']; ?>" size="15" readonly="readonly">
          <input type="hidden" name="subid[]" id="subid[]" value="<?php echo $shqgsubdetails['subject_id_six_eight']; ?>" /></td>
          <input type="hidden" name="subdetailid[]" id="subdetailid[]" value="<?php echo $shqgsubdetails['borin_subject_six_eight_id']; ?>" /></td>
         <td align="center"><input name="Full[]" type="text" id="Full[]" value="<?php echo $shqgfullmark['sub_six_eight_fullmark']; ?>" size="2" readonly="readonly"></td>         
...
<option value="0"<?php if($shqgsubdetails['six_eight_4th_subject']=='0') { echo "selected"; } ?>> Main </option>
<option value="1"<?php if($shqgsubdetails['six_eight_4th_subject']=='1') { echo "selected"; } ?>> 4th Subject </option>

                        
                            </select>
                                 </td> 
                                 <td align="center"><input name="type1[]" type="text" id="type1[]" size="2" value="<?php echo $shqgsubdetails['type1']; ?>"></td> 
                                 <td align="center"><input name="type2[]" type="text" id="type2[]" size="2" value="<?php echo $shqgsubdetails['type2']; ?>"></td> 
                                 <td align="center"><input name="type3[]" type="text" id="type3[]" size="2" value="<?php echo $shqgsubdetails['type3']; ?>"></td> 
                                 <td align="center"><input name="pass[]" type="text" id="pass[]" size="2" value="<?php echo $shqgsubdetails['pass']; ?>"></td>                               </tr>
                               <?php } ?>
                               <tr>
                                <td colspan="18" align="center"><input type="submit" name="button" id="button" value="Submit"></td>
                              </tr>
                            </table>
