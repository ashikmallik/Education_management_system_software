...
<div class="wrapper">
    ...
    <td><select name="mgtType" id="mgtType" onchange="callpage();">
      ...
      <option value="Office Staff" <?php if($_POST['mgtType']=='Office Staff') { echo "selected"; } ?> > Office Staff </option>
      <option value="Staff" <?php if($_POST['mgtType']=='Staff') { echo "selected"; } ?>> Staff </option>
      <option value="Guard" <?php if($_POST['mgtType']=='Guard') { echo "selected"; } ?>> Guard </option>
    </select></td>
  </tr>
                        </table>
                    </form>
  ...
  <tr>
    <td class="text_table" align="right"><a href="download_staff_info_pdf.php?branchId=<?php echo $_POST['branchId']; ?>&schoolId=<?php echo $schId; ?>&type=<?php echo $_POST['mgtType']; ?>" target="_blank">Download as PDF</a></td>
  </tr>
</table>
...
<table   width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="projectlist">
  ...
  <?php
	...
	$techinfo="select * from borno_mgt_staff_info where borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_mgt_staf_desig='$mgtType'";
  ...
  <tr>
    ...
    <td> <?php echo substr($shtechinfo['borno_staff_phone'],2,11); ?> </td>
