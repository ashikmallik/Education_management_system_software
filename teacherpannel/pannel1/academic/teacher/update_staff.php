<?php
 ...
 require_once '../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	$bornoschBranch="Update `borno_mgt_staff_info` SET `borno_school_id`='$schId', `borno_school_branch_id`='$addBranchf', `borno_mgt_staff_type`='$mgtType1', `borno_mgt_staf_name`='$teacher1', `borno_mgt_staf_address`= '$address1', `borno_mgt_staf_desig`='$stfdesig1', `borno_mgt_staf_phone`='$phone1' where borno_mgt_staff_info_id='$techId' ";
