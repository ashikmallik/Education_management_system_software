<?php
 ...
 require_once '../../../lib/htmlpurifier/library/HTMLPurifier.auto.php';
	...
	if (!function_exists('clean_html')) {
		...
		$branch1="select * from `borno_teacher_info` where `borno_school_branch_id`='$addBranchf' order by 	borno_teacher_info_id asc";
   ...
   $bornoschBranch="INSERT INTO `borno_teacher_login` (`borno_teacher_info_id`,`borno_teacher_password`, `borno_create_date`, `borno_modify_date`, `borno_teacher_status`)
															...
															VALUES ('$teacherid1', '1231230','$date','$date','1')";
