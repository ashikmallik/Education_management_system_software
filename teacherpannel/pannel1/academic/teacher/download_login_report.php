...
$pdf->AddPage();
					...
					$data="SELECT * FROM borno_teacher_info where borno_school_branch_id=$branchId AND borno_school_id=$schId AND borno_school_shift_id='$shiftId' order by borno_teacher_info_id asc";
