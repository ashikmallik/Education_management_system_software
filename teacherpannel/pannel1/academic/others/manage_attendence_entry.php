...
function callpage()
{
 document.frmcontent.action="manage_attendence_entry.php";
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2>Manage Attendence Entry</h2></div>
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="manage_attendence_entry_do.php" method="post" enctype="multipart/form-data">
                        <?php
	$msg=$_GET['msg'];
...
<option value="Absence" <?php if($_POST['attnd']==Absence) { echo "selected"; } ?>> Absence </option>
			   ...
			   if($attnd=="Presence") { ?>
               <td width="100" align="center">Presence</td> </tr>
                   <?php }  elseif($attnd=="Absence") {?>             
                  <td width="100" align="center">Absence</td> </tr>
                  <?php } ?>   
                               <tr>
                  <?php       
			...
			$selTerm=$_POST['term'];
							 ...
							 $gtctmarg="select * from borno_school_attendence where borno_school_id='$schId' AND borno_school_branch_id='$gtfbranchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_result_term_id='$selTerm' order by borno_school_roll asc";
               ...
               <td width="40" align="center"><?php echo $shgtctmarg['borno_school_roll']; ?>
                <input type="hidden" name="roll[]" id="roll[]" value="<?php echo $shgtctmarg['borno_school_roll']; ?>" />
                 <input type="hidden" name="stdid[]" id="stdid[]" value="<?php echo $shgtctmarg['borno_student_info_id']; ?>" />
                  ...
                  <input type="hidden" name="asttdid[]" id="asttdid[]" value="<?php echo $shgtctmarg['borno_school_attendence_id']; ?>" />
               </td>
               <td width="260"><?php echo $shgtctmarg['borno_school_student_name']; ?></td>
                       <?php 
			   		   
			   if($attnd=="Presence") { ?>
               <td width="100"><input type="text" name="attend[]" id="attend[]" size="10" value="<?php echo $shgtctmarg['borno_school_presence']; ?>"></td> 
                <?php }  elseif($attnd=="Absence") {?> 
             <td width="100"><input type="text" name="attend[]" id="attend[]" size="10" value="<?php echo $shgtctmarg['borno_school_absence']; ?>"></td> 
               <?php } ?>   
               </tr>
                                <?php } ?>
                               <tr>
