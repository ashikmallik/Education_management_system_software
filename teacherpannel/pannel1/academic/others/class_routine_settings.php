...
$gstclass="select * from borno_school_set_class where borno_school_id='$schId' and borno_school_branch_id='$gtfbranchId' order by class_order asc";
    ...
    <td align="center" >
        ...
        <?php
					...
					$gstsection="select * from borno_school_section where borno_school_class_id='$studClass1' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId'";
    ...
    <td align="center" >
      ...
      <?php 
	   ...
	   ?>
        <option value="<?php echo $shgetsubjnamesixeight['subject_id_six_eight']; ?>"<?php if($shgetsubjnamesixeight['subject_id_six_eight']==$_POST['sub1']) { echo "selected"; } ?>> <?php echo $shgetsubjnamesixeight['six_eight_subject_name']; ?></option>
	...
	elseif($studClass1=='1' OR  $studClass1=='2' ){					
		...
		?>
      <option value="<?php echo $shgsubjNamesixeight['borno_subject_nine_ten_id']; ?>"<?php if($shgsubjNamesixeight['borno_subject_nine_ten_id']==$_POST['sub1']) { echo "selected"; } ?>> <?php echo $shgsubjNamesixeight['borno_subject_nine_ten_name']; ?></option>
      <?php 
	  	}
			}
...
$gstclass1="select * from borno_school_set_class where borno_school_id='$schId' and borno_school_branch_id='$gtfbranchId' order by class_order asc";
    ...
    <select style="width:100px; height:25px;" name="studSection2" id="studSection2" onchange="callpage();">      
        ...
        <?php
					...
					$gstsection1="select * from borno_school_section where borno_school_class_id='$studClass2' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId'";
	...
	if($studClass2=='20' OR  $studClass2=='19' OR  $studClass2=='18' OR  $studClass2=='15' OR  $studClass2=='14' OR  $studClass2=='13' OR  $studClass2=='10' OR  $studClass2=='6'){					
					
					
			$gsubjNamesixeight1="select * from borno_result_subject where borno_school_class_id='$studClass2' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
	...
	elseif($studClass2=='3' OR  $studClass2=='4' OR  $studClass2=='5' ){		
					
			$gsubjNamesixeight1="select * from borno_set_subject_six_eight where borno_school_class_id='$studClass2' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
			$qgsubjNamesixeight1=$mysqli->query($gsubjNamesixeight1);
			while($shgsubjNamesixeight1=$qgsubjNamesixeight1->fetch_assoc()){
				
				$subjidsixeight1=$shgsubjNamesixeight1['subject_id_six_eight'];
				
				$getsubjnamesixeight1="select * from borno_subject_six_eight where subject_id_six_eight='$subjidsixeight1'";
				$qgetsubjnamesixeight1=$mysqli->query($getsubjnamesixeight1);
				$shgetsubjnamesixeight1=$qgetsubjnamesixeight1->fetch_assoc();			
				
				
		?>
      <option value="<?php echo $shgetsubjnamesixeight1['subject_id_six_eight']; ?>"<?php if($shgetsubjnamesixeight1['subject_id_six_eight']==$_POST['sub2']) { echo "selected"; } ?>> <?php echo $shgetsubjnamesixeight1['six_eight_subject_name']; ?></option>
      <?php } }
	  
	  
	  	elseif($studClass2=='1' OR  $studClass2=='2' ){					
					
					
			$gsubjNamesixeight1="select * from borno_subject_nine_ten   ";
			$qgsubjNamesixeight1=$mysqli->query($gsubjNamesixeight1);
			while($shgsubjNamesixeight1=$qgsubjNamesixeight1->fetch_assoc()){	
							
		?>
      <option value="<?php echo $shgsubjNamesixeight1['borno_subject_nine_ten_id']; ?>"<?php if($shgsubjNamesixeight1['borno_subject_nine_ten_id']==$_POST['sub2']) { echo "selected"; } ?>> <?php echo $shgsubjNamesixeight1['borno_subject_nine_ten_name']; ?></option>
      <?php 
	  	}
			}
...
$gstclass2="select * from borno_school_set_class where borno_school_id='$schId' and borno_school_branch_id='$gtfbranchId' order by class_order asc";
    ...
    <select style="width:100px; height:25px;" name="studSection3" id="studSection3" onchange="callpage();">      
        ...
        <?php
					...
					$gstsection2="select * from borno_school_section where borno_school_class_id='$studClass3' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId'";
    ...
    <select style="width:100px; height:25px;" name="sub3" id="sub3" onchange="callpage();">
		...
		if($studClass3=='20' OR  $studClass3=='19' OR  $studClass3=='18' OR  $studClass3=='15' OR  $studClass3=='14' OR  $studClass3=='13' OR  $studClass3=='10' OR  $studClass3=='6'){					
					
					
			$gsubjNamesixeight2="select * from borno_result_subject where borno_school_class_id='$studClass3' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
	...
	elseif($studClass3=='3' OR  $studClass3=='4' OR  $studClass3=='5' ){	
					
					
			$gsubjNamesixeight2="select * from borno_set_subject_six_eight where borno_school_class_id='$studClass3' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
			$qgsubjNamesixeight2=$mysqli->query($gsubjNamesixeight2);
			while($shgsubjNamesixeight2=$qgsubjNamesixeight2->fetch_assoc()){
				
				$subjidsixeight2=$shgsubjNamesixeight2['subject_id_six_eight'];
				
				$getsubjnamesixeight2="select * from borno_subject_six_eight where subject_id_six_eight='$subjidsixeight2'";
				$qgetsubjnamesixeight2=$mysqli->query($getsubjnamesixeight2);
				$shgetsubjnamesixeight2=$qgetsubjnamesixeight2->fetch_assoc();			
				
				
		?>
      <option value="<?php echo $shgetsubjnamesixeight2['subject_id_six_eight']; ?>"<?php if($shgetsubjnamesixeight2['subject_id_six_eight']==$_POST['sub3']) { echo "selected"; } ?>> <?php echo $shgetsubjnamesixeight2['six_eight_subject_name']; ?></option>
      <?php }
				}
	  	  	elseif($studClass3=='1' OR  $studClass3=='2' ){					
					
					
			$gsubjNamesixeight2="select * from borno_subject_nine_ten   ";
			$qgsubjNamesixeight2=$mysqli->query($gsubjNamesixeight2);
			while($shgsubjNamesixeight2=$qgsubjNamesixeight2->fetch_assoc()){	
							
		?>
      <option value="<?php echo $shgsubjNamesixeight2['borno_subject_nine_ten_id']; ?>"<?php if($shgsubjNamesixeight2['borno_subject_nine_ten_id']==$_POST['sub3']) { echo "selected"; } ?>> <?php echo $shgsubjNamesixeight2['borno_subject_nine_ten_name']; ?></option>
      <?php 
	  	}
			}
	   ?>
...
$gstclass3="select * from borno_school_set_class where borno_school_id='$schId' and borno_school_branch_id='$gtfbranchId' order by class_order asc";
    ...
    <select style="width:100px; height:25px;" name="studSection4" id="studSection4" onchange="callpage();">      
        ...
        <?php
					...
					$gstsection3="select * from borno_school_section where borno_school_class_id='$studClass4' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId'";
	...
	if($studClass4=='20' OR  $studClass4=='19' OR  $studClass4=='18' OR  $studClass4=='15' OR  $studClass4=='14' OR  $studClass4=='13' OR  $studClass4=='10' OR  $studClass4=='6'){					
					
					
			$gsubjNamesixeight3="select * from borno_result_subject where borno_school_class_id='$studClass4' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
	...
	elseif($studClass4=='3' OR  $studClass4=='4' OR  $studClass4=='5' ){	
					
					
					
			$gsubjNamesixeight3="select * from borno_set_subject_six_eight where borno_school_class_id='$studClass4' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
			$qgsubjNamesixeight3=$mysqli->query($gsubjNamesixeight3);
			while($shgsubjNamesixeight3=$qgsubjNamesixeight3->fetch_assoc()){
				
				$subjidsixeight3=$shgsubjNamesixeight3['subject_id_six_eight'];
				
				$getsubjnamesixeight3="select * from borno_subject_six_eight where subject_id_six_eight='$subjidsixeight3'";
				$qgetsubjnamesixeight3=$mysqli->query($getsubjnamesixeight3);
				$shgetsubjnamesixeight3=$qgetsubjnamesixeight3->fetch_assoc();	
				
		?>
      <option value="<?php echo $shgetsubjnamesixeight3['subject_id_six_eight']; ?>"<?php if($shgetsubjnamesixeight3['subject_id_six_eight']==$_POST['sub4']) { echo "selected"; } ?>> <?php echo $shgetsubjnamesixeight3['six_eight_subject_name']; ?></option>
      <?php } 
	         }
	  	 elseif($studClass4=='1' OR  $studClass4=='2' ){					
					
					
			$gsubjNamesixeight3="select * from borno_subject_nine_ten   ";
			$qgsubjNamesixeight3=$mysqli->query($gsubjNamesixeight3);
			while($shgsubjNamesixeight3=$qgsubjNamesixeight3->fetch_assoc()){	
							
		?>
      <option value="<?php echo $shgsubjNamesixeight3['borno_subject_nine_ten_id']; ?>"<?php if($shgsubjNamesixeight3['borno_subject_nine_ten_id']==$_POST['sub4']) { echo "selected"; } ?>> <?php echo $shgsubjNamesixeight3['borno_subject_nine_ten_name']; ?></option>
      <?php 
	  	}
			}
...
$gstclass4="select * from borno_school_set_class where borno_school_id='$schId' and borno_school_branch_id='$gtfbranchId' order by class_order asc";
    ...
    <select style="width:100px; height:25px;" name="studSection5" id="studSection5" onchange="callpage();">      
        ...
        <?php
					...
					$gstsection4="select * from borno_school_section where borno_school_class_id='$studClass5' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId'";
    ...
    <select style="width:100px; height:25px;" name="sub5" id="sub5" onchange="callpage();">
        ...
        <?php
					...
					if($studClass5=='20' OR  $studClass5=='19' OR  $studClass5=='18' OR  $studClass5=='15' OR  $studClass5=='14' OR  $studClass5=='13' OR  $studClass5=='10' OR  $studClass5=='6'){					
					
					
			$gsubjNamesixeight4="select * from borno_result_subject where borno_school_class_id='$studClass5' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
	...
	elseif($studClass5=='3' OR  $studClass5=='4' OR  $studClass5=='5' ){	
					
					
					
			$gsubjNamesixeight4="select * from borno_set_subject_six_eight where borno_school_class_id='$studClass5' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
			$qgsubjNamesixeight4=$mysqli->query($gsubjNamesixeight4);
			while($shgsubjNamesixeight4=$qgsubjNamesixeight4->fetch_assoc()){
				
				$subjidsixeight4=$shgsubjNamesixeight4['subject_id_six_eight'];
				
				$getsubjnamesixeight4="select * from borno_subject_six_eight where subject_id_six_eight='$subjidsixeight4'";
				$qgetsubjnamesixeight4=$mysqli->query($getsubjnamesixeight4);
				$shgetsubjnamesixeight4=$qgetsubjnamesixeight4->fetch_assoc();	
				
		?>
      <option value="<?php echo $shgetsubjnamesixeight4['subject_id_six_eight']; ?>"<?php if($shgetsubjnamesixeight4['subject_id_six_eight']==$_POST['sub5']) { echo "selected"; } ?>> <?php echo $shgetsubjnamesixeight4['six_eight_subject_name']; ?></option>
      <?php } 
	         }

	   elseif($studClass5=='1' OR  $studClass5=='2' ){					
					
					
			$gsubjNamesixeight4="select * from borno_subject_nine_ten   ";
			$qgsubjNamesixeight4=$mysqli->query($gsubjNamesixeight4);
			while($shgsubjNamesixeight4=$qgsubjNamesixeight4->fetch_assoc()){	
							
		?>
      <option value="<?php echo $shgsubjNamesixeight4['borno_subject_nine_ten_id']; ?>"<?php if($shgsubjNamesixeight4['borno_subject_nine_ten_id']==$_POST['sub5']) { echo "selected"; } ?>> <?php echo $shgsubjNamesixeight4['borno_subject_nine_ten_name']; ?></option>
      <?php 
	  	}
			}
...
$gstclass5="select * from borno_school_set_class where borno_school_id='$schId' and borno_school_branch_id='$gtfbranchId' order by class_order asc";
    ...
    <select style="width:100px; height:25px;" name="studSection6" id="studSection6" onchange="callpage();">      
        ...
        <?php
					...
					$gstsection5="select * from borno_school_section where borno_school_class_id='$studClass6' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId'";
	...
	if($studClass6=='20' OR  $studClass6=='19' OR  $studClass6=='18' OR  $studClass6=='15' OR  $studClass6=='14' OR  $studClass6=='13' OR  $studClass6=='10' OR  $studClass6=='6'){					
					
					
			$gsubjNamesixeight5="select * from borno_result_subject where borno_school_class_id='$studClass6' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
	...
	elseif($studClass6=='3' OR  $studClass6=='4' OR  $studClass6=='5' ){	
					
					
			$gsubjNamesixeight5="select * from borno_set_subject_six_eight where borno_school_class_id='$studClass6' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
			$qgsubjNamesixeight5=$mysqli->query($gsubjNamesixeight5);
			while($shgsubjNamesixeight5=$qgsubjNamesixeight5->fetch_assoc()){
				
				$subjidsixeight5=$shgsubjNamesixeight5['subject_id_six_eight'];
				
				$getsubjnamesixeight5="select * from borno_subject_six_eight where subject_id_six_eight='$subjidsixeight5'";
				$qgetsubjnamesixeight5=$mysqli->query($getsubjnamesixeight5);
				$shgetsubjnamesixeight5=$qgetsubjnamesixeight5->fetch_assoc();			
				
				
		?>
      <option value="<?php echo $shgetsubjnamesixeight5['subject_id_six_eight']; ?>"<?php if($shgetsubjnamesixeight5['subject_id_six_eight']==$_POST['sub6']) { echo "selected"; } ?>> <?php echo $shgetsubjnamesixeight5['six_eight_subject_name']; ?></option>
      <?php } 
	  		}
	    elseif($studClass6=='1' OR  $studClass6=='2' ){					
					
					
			$gsubjNamesixeight5="select * from borno_subject_nine_ten   ";
			$qgsubjNamesixeight5=$mysqli->query($gsubjNamesixeight5);
			while($shgsubjNamesixeight5=$qgsubjNamesixeight5->fetch_assoc()){	
							
		?>
      <option value="<?php echo $shgsubjNamesixeight5['borno_subject_nine_ten_id']; ?>"<?php if($shgsubjNamesixeight5['borno_subject_nine_ten_id']==$_POST['sub6']) { echo "selected"; } ?>> <?php echo $shgsubjNamesixeight5['borno_subject_nine_ten_name']; ?></option>
      <?php 
	  	}
			}
...
$gstclass6="select * from borno_school_set_class where borno_school_id='$schId' and borno_school_branch_id='$gtfbranchId' order by class_order asc";
    ...
    <select style="width:100px; height:25px;" name="studSection7" id="studSection7" onchange="callpage();">      
        ...
        <?php
					...
					$gstsection6="select * from borno_school_section where borno_school_class_id='$studClass7' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId'";
	...
	if($studClass7=='20' OR  $studClass7=='19' OR  $studClass7=='18' OR  $studClass7=='15' OR  $studClass7=='14' OR  $studClass7=='13' OR  $studClass7=='10' OR  $studClass7=='6'){					
					
					
			$gsubjNamesixeight6="select * from borno_result_subject where borno_school_class_id='$studClass7' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
	...
	elseif($studClass7=='3' OR  $studClass7=='4' OR  $studClass7=='5' ){	
					
					
			$gsubjNamesixeight6="select * from borno_set_subject_six_eight where borno_school_class_id='$studClass7' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
			$qgsubjNamesixeight6=$mysqli->query($gsubjNamesixeight6);
			while($shgsubjNamesixeight6=$qgsubjNamesixeight6->fetch_assoc()){
				
				$subjidsixeight6=$shgsubjNamesixeight6['subject_id_six_eight'];
				
				$getsubjnamesixeight6="select * from borno_subject_six_eight where subject_id_six_eight='$subjidsixeight6'";
				$qgetsubjnamesixeight6=$mysqli->query($getsubjnamesixeight6);
				$shgetsubjnamesixeight6=$qgetsubjnamesixeight6->fetch_assoc();					
				
		?>
      <option value="<?php echo $shgetsubjnamesixeight6['subject_id_six_eight']; ?>"<?php if($shgetsubjnamesixeight6['subject_id_six_eight']==$_POST['sub7']) { echo "selected"; } ?>> <?php echo $shgetsubjnamesixeight6['six_eight_subject_name']; ?></option>
      <?php }
			}
			
		  elseif($studClass7=='1' OR  $studClass7=='2' ){					
			$gsubjNamesixeight6="select * from borno_subject_nine_ten   ";
			$qgsubjNamesixeight6=$mysqli->query($gsubjNamesixeight6);
			while($shgsubjNamesixeight6=$qgsubjNamesixeight6->fetch_assoc()){	
							
		?>
      <option value="<?php echo $shgsubjNamesixeight6['borno_subject_nine_ten_id']; ?>"<?php if($shgsubjNamesixeight6['borno_subject_nine_ten_id']==$_POST['sub7']) { echo "selected"; } ?>> <?php echo $shgsubjNamesixeight6['borno_subject_nine_ten_name']; ?></option>
      <?php 
	  	}
			}
...
$gstclass7="select * from borno_school_set_class where borno_school_id='$schId' and borno_school_branch_id='$gtfbranchId' order by class_order asc";
    ...
    <select style="width:100px; height:25px;" name="studSection8" id="studSection8" onchange="callpage();">      
        ...
        <?php
					...
					$gstsection7="select * from borno_school_section where borno_school_class_id='$studClass8' AND borno_school_branch_id='$branchId' AND borno_school_id='$schId' AND borno_school_shift_id='$shiftId'";
	...
	if($studClass8=='20' OR  $studClass8=='19' OR  $studClass8=='18' OR  $studClass8=='15' OR  $studClass8=='14' OR  $studClass8=='13' OR  $studClass8=='10' OR  $studClass8=='6'){					
					
					
		$gsubjNamesixeight7="select * from borno_result_subject where borno_school_class_id='$studClass8' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
	...
	elseif($studClass8=='3' OR  $studClass8=='4' OR  $studClass8=='5' ){	
					
					
			$gsubjNamesixeight7="select * from borno_set_subject_six_eight where borno_school_class_id='$studClass8' AND borno_school_session='$stsess' AND borno_school_id='$schId'";
			$qgsubjNamesixeight7=$mysqli->query($gsubjNamesixeight7);
			while($shgsubjNamesixeight7=$qgsubjNamesixeight7->fetch_assoc()){
				
				$subjidsixeight7=$shgsubjNamesixeight7['subject_id_six_eight'];
				
				$getsubjnamesixeight7="select * from borno_subject_six_eight where subject_id_six_eight='$subjidsixeight7'";
				$qgetsubjnamesixeight7=$mysqli->query($getsubjnamesixeight7);
				$shgetsubjnamesixeight7=$qgetsubjnamesixeight7->fetch_assoc();			
				
				
		?>
      <option value="<?php echo $shgetsubjnamesixeight7['subject_id_six_eight']; ?>"<?php if($shgetsubjnamesixeight7['subject_id_six_eight']==$_POST['sub8']) { echo "selected"; } ?>> <?php echo $shgetsubjnamesixeight7['six_eight_subject_name']; ?></option>
      <?php }
	       }
	  	
		  elseif($studClass8=='1' OR  $studClass8=='2' ){					
			$gsubjNamesixeight7="select * from borno_subject_nine_ten   ";
			$qgsubjNamesixeight7=$mysqli->query($gsubjNamesixeight7);
			while($shgsubjNamesixeight7=$qgsubjNamesixeight7->fetch_assoc()){	
							
		?>
      <option value="<?php echo $shgsubjNamesixeight7['borno_subject_nine_ten_id']; ?>"<?php if($shgsubjNamesixeight7['borno_subject_nine_ten_id']==$_POST['sub8']) { echo "selected"; } ?>> <?php echo $shgsubjNamesixeight7['borno_subject_nine_ten_name']; ?></option>
      <?php 
	  	}
			}
