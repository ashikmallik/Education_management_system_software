...
$pdf->AddPage(L);
				...
				$data="select * from borno_school_testimonial where borno_school_id='$schId'  AND borno_school_exam='$exam' AND borno_school_passing_year='$passyear' AND borno_school_group= '$group' order by borno_school_roll asc";
...
$datainfo="select * from borno_student_info where borno_student_info_id='$stdntid'  ";
					...
					$pdf->Cell(10,5,'',0,0,"L");
					$pdf->SetFont('Arial','',14);
					$pdf->Cell(125,5,"passed  the  $fnsexname  ",0,0,"L");
