...
function callpage()
{
 document.frmcontent.action="assesment_entry.php";
        ...
        <div class="ot_main_body">
            <div class="ot_body_fixed">
                <div class="default_heading">
                  <h2>Assesment Entry</h2></div>
                <div class="form">
                    <center>
                    	<form name="frmcontent" action="assesment_entry_do.php" method="post" enctype="multipart/form-data">
                        <?php
	$msg=$_GET['msg'];
...
<option value=" <?php echo $shqgstterm['borno_result_term_id']; ?>" <?php if($shqgstterm['borno_result_term_id']==$_REQUEST['term']) { echo "selected"; }  ?>> <?php echo $shqgstterm['borno_result_term_name']; ?></option>
	...
	while($shgtctmarg=$qgtctmarg->fetch_assoc()){
		?>
               ...
               <td width="100"><input type="text" name="regulation[]" id="regulation[]" size="10"></td> 
               <td width="100"><input type="text" name="patritism[]" id="patritism[]" size="10"></td> 
               <td width="100"><input type="text" name="honesty[]" id="honesty[]" size="10"></td> 
               <td width="100"><input type="text" name="leadership[]" id="leadership[]" size="10"></td> 
               <td width="100"><input type="text" name="discipline[]" id="discipline[]" size="10"></td> 
               <td width="100"><input type="text" name="cooperation[]" id="cooperation[]" size="10"></td> 
               <td width="100"><input type="text" name="participation[]" id="participation[]" size="10"></td> 
               <td width="100"><input type="text" name="sympathy[]" id="sympathy[]" size="10"></td> 
               <td width="100"><input type="text" name="awareness[]" id="awareness[]" size="10"></td> 
               <td width="100"><input type="text" name="punctuality[]" id="punctuality[]" size="10"></td> </tr>
                                <?php } ?>
                               <tr>
