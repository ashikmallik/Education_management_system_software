...
<table width="450" border="0" cellspacing="0" cellpadding="0" align="center" class="projectlist">
  <tr>
    <td width="343" align="Center">
    	<a href="show_routine_teacher.php?schId=<?php echo $schId; ?>&gtfbranchId=<?php echo $branchId; ?>&shiftId=<?php echo $shiftId; ?>&teacherid=<?php echo $teacherid=$_REQUEST['teacherid']; ?>" target="_blank">Show Teacher</a>
