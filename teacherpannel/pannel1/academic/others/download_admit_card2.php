...
$gtbranchclass="SELECT * FROM borno_school_section where borno_school_id=$schId AND borno_school_class_id=$studClass order by borno_school_section_id asc";
					$qgtbranchclass=$mysqli->query($gtbranchclass);
					while($sqgtbranchclass=$qgtbranchclass->fetch_assoc()){
                    $section=$sqgtbranchclass['borno_school_section_id'];
$pdf->Ln();
...
$minroll=$sqgtminroll['borno_school_roll'];
				...
				$data="select * from borno_student_info where borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_school_roll between '$minroll' AND '$maxroll' order by borno_school_roll asc";
...
if ($stroll<=$maxroll)
{
$result2 ="select * from borno_student_info where borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_school_roll='$stroll'";
...
if ($stroll1<=$maxroll)
{
$result1 ="select * from borno_student_info where borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_school_roll='$stroll1'";
