...
$gtschoolLogo=$sqgtschoolName['borno_school_logo'];
	...
	$finalSchoolLogo="../infosett/school-logo/$gtschoolLogo";
		...
		$finalSchoolLogo="../infosett/school-logo/nologo.png";
					...
					$gtschoolday="SELECT * FROM borno_school_schooling_day where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND 	borno_result_term_id='$gttermId'";
					$qgtschoolday=$mysqli->query($gtschoolday);
					$sqgtschoolday=$qgtschoolday->fetch_assoc();


$fnschday=$sqgtschoolday['borno_school_schooling_day'];
...
$pdf->Image($finalgtschoolsignature,246,171,13,5);	
$pdf->Image($finalgtschoolsignature,102,171,13,5);	
$pdf->Image($finalgtschoolsignature,246,76,13,5);	
$pdf->Image($finalgtschoolsignature,102,76,13,5);	
$pdf->Image($finalSchoolLogo,12,12,20,20);
$pdf->Image($finalSchoolLogo,156,12,20,20);
$pdf->Image($finalSchoolLogo,12,106,20,20);
$pdf->Image($finalSchoolLogo,156,106,20,20);
...
$result2 ="select * from borno_student_info where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND borno_school_roll='$stroll'";
   	...
   	$stdid=$row2['borno_student_info_id']; 
...
$stdid1=$row1['borno_student_info_id'];
...
$pdf->Ln();	
		$pdf->Cell(280,2,'',0,5,"C");
        $pdf->Cell(8,5,"",0);
	  	$pdf->Cell(40,5,"Schooling Days :",0);
	 	$pdf->Cell(105,5,$fnschday,0,0,"L");	
	  	$pdf->Cell(40,5,"Schooling Days :",0);
	 	$pdf->Cell(67,5,$fnschday,0,0,"L");		

$gtpresentday="SELECT * FROM borno_school_attendence where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND 	borno_result_term_id='$gttermId' AND borno_student_info_id='$stdid'";
					$qgtpresentday=$mysqli->query($gtpresentday);
					$sqgtpresentday=$qgtpresentday->fetch_assoc();
                    $prsday=$sqgtpresentday['borno_school_presence'];

$gtpresentday1="SELECT * FROM borno_school_attendence where borno_school_id='$schId' AND borno_school_branch_id='$branchId' AND borno_school_class_id='$studClass' AND borno_school_shift_id='$shiftId' AND borno_school_section_id='$section' AND borno_school_session='$stsess' AND 	borno_result_term_id='$gttermId' AND borno_student_info_id='$stdid1'";
					$qgtpresentday1=$mysqli->query($gtpresentday1);
					$sqgtpresentday1=$qgtpresentday1->fetch_assoc();
                    $prsday1=$sqgtpresentday1['borno_school_presence'];
$pdf->Ln();	
		$pdf->Cell(280,2,'',0,5,"C");
		if($studClass==3)
		{
        $pdf->Cell(8,5,"",0);
	  	$pdf->Cell(35,5,"Present Days :",0);
	 	$pdf->Cell(10,5,$prsday,0);
	 	$pdf->SetFont('Arial','',10);
	 $pdf->Cell(100,5,"",0,0,"L");
	    $pdf->SetFont('Arial','',14);
	  	$pdf->Cell(35,5,"Present Days :",0);
	 	$pdf->Cell(10,5,$prsday1,0);
	 	$pdf->SetFont('Arial','',10);
	 	$pdf->Cell(100,5,"",0,0,"L");
		}
	 	else
        ...
        $pdf->Cell(8,5,"",0);
	  	$pdf->Cell(35,5,"Present Days :",0);
	 	$pdf->Cell(110,5,$prsday,0);	
	  	$pdf->Cell(35,5,"Present Days :",0);
	 	$pdf->Cell(115,5,$prsday1,0);
		}
		$pdf->SetFont('Arial','',14);
