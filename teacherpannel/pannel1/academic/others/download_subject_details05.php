...
{
				$data="select * from borno_result_nine_ten_subject_details where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id= '$gttermId' order by borin_subject_nine_ten_id asc";
$sl=0;
					$qdata=$mysqli->query($data);
					while($showdata=$qdata->fetch_assoc()){ $sl++;
					
		             $subjectid=$showdata['borin_subject_nine_ten_id'];
		             $full=$showdata['borno_nine_ten_subfullmark'];	
			    	...
			    	$data1="select * from borno_subject_nine_ten where  	borno_subject_nine_ten_id='$subjectid' ";
					$qdata1=$mysqli->query($data1);
					$shoqdata1=$qdata1->fetch_assoc();
					$stName=$shoqdata1['borno_subject_nine_ten_name'];				 
...
{
				$data="select * from borno_result_subject_details where borno_school_id='$schId'  AND borno_school_class_id='$studClass' AND borno_school_session='$stsess' AND borno_result_term_id= '$gttermId' order by borno_result_subject_id asc";
$sl=0;
					$qdata=$mysqli->query($data);
					while($showdata=$qdata->fetch_assoc()){ $sl++;
					
		             $subjectid=$showdata['borno_result_subject_id'];
		             $type1=$showdata['number_type1_marks'];
					 $type2=$showdata['number_type2_marks'];
					 $type3=$showdata['number_type3_marks'];
					 $type4=$showdata['number_type4_marks'];
				...
				$data1="select * from borno_result_subject where borno_result_subject_id='$subjectid' ";

					$qdata1=$mysqli->query($data1);
					$shoqdata1=$qdata1->fetch_assoc();
		            $stName=$shoqdata1['borno_school_subject_name'];	
					$full=$shoqdata1['borno_school_subject_fullmark'];					 
