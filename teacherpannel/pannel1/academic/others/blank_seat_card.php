...
function callpage()
{
 document.frmcontent.action="blank_seat_card.php";
...
?>
    <td>&nbsp;</td>
    <td><a href="download_blank_seat_card.php?schoolId=<?php echo $schId; ?>&stbranch=<?php echo $gtfbranchId; ?>&classId=<?php echo $studClass; ?>&shiftId=<?php echo $shiftId; ?>&sectionId=<?php echo $section; ?>&scsess=<?php echo $stsess; ?>&sctermId=<?php echo $selTerm; ?>" target="_blank">Show Seat Card</a></td>
 </tr>          
                        </table>
